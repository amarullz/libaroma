...
# 27 "../../../src/aroma/controls/ctl_scroll.c" 2
...
# 28 "../../../src/aroma/controls/ctl_scroll.c" 2
...
# 67 "../../../src/aroma/controls/ctl_scroll.c"
...
struct __LIBAROMA_CTL_SCROLL{
  ...
  omp_nest_lock_t fmutex;
  omp_nest_lock_t blitmutex;
...
dword _libaroma_ctl_scroll_client_msg(
  ...
  if (ctl->handler!=&_libaroma_ctl_scroll_handler){ return 0; } _LIBAROMA_CTL_SCROLLP me = (_LIBAROMA_CTL_SCROLLP) ctl->internal
...
byte _libaroma_ctl_scroll_updatecache(LIBAROMA_CONTROLP ctl, int move_sz){
  ...
  if (ctl->handler!=&_libaroma_ctl_scroll_handler){ return 0; } _LIBAROMA_CTL_SCROLLP me = (_LIBAROMA_CTL_SCROLLP) ctl->internal
   ...
   ;
  if (me->client_canvas==((void *)0)){
    return 0;
  }

  omp_set_nest_lock(&(me->fmutex));
  int move_value=0;
  ...
  if ((me->cache_state==10)||(me->cache_state==11)){
    ...
    if (me->client.handler->draw!=((void *)0)){
  ...
  if (move_value!=0){
    ...
    if (top_h>0){
      ...
      libaroma_canvas_free_ex1(&(redraw_canvas), 0);
    }
...
# 389 "../../../src/aroma/controls/ctl_scroll.c"
static void * _libaroma_ctl_scroll_calc_thread(void * cookie){
  ...
  if (ctl->handler!=&_libaroma_ctl_scroll_handler){ return 0; } _LIBAROMA_CTL_SCROLLP me = (_LIBAROMA_CTL_SCROLLP) ctl->internal
   ...
   ;
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "Start scroll calculation thread"); fprintf(libaroma_debug_output(), "\n");;
  byte need_drawing = 0;
  while (me->active){
    ...
    if (me->client.handler){
      ...
      if (me->client.handler->thread!=((void *)0)){
  ...
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "End scroll calculation thread"); fprintf(libaroma_debug_output(), "\n");;
  return ((void *)0);
}
...
# 465 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp parallel sections
# 465 "../../../src/aroma/controls/ctl_scroll.c"

      {
                
# 467 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 467 "../../../src/aroma/controls/ctl_scroll.c"

        {
          ...
          if (me->ovs_ustart>1){
            float nowstate=
              libaroma_duration_state(me->ovs_ustart,me->ovs_bounce==2?1000:400)
                                           ;
            if (nowstate<1){
            ...
            float nowstate=
              libaroma_duration_state(me->ovs_start,(me->ovs_bounce==1)?800:1600);
            if (nowstate<1){
...
# 512 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 512 "../../../src/aroma/controls/ctl_scroll.c"
            ...
            if ((abs(me->velocity)<256)||(me->touched)) {
              ...
              if (scroll_y>=me->max_scroll_y){
                ...
                if (me->scroll_y!=scroll_y){
                  me->bounce_velocity=(((-libaroma_dp(3840))>((((libaroma_dp(3840))<((me->velocity*153)>>8))?(libaroma_dp(3840)):((me->velocity*153)>>8))))?(-libaroma_dp(3840)):((((libaroma_dp(3840))<((me->velocity*153)>>8))?(libaroma_dp(3840)):((me->velocity*153)>>8))))
                                                                 ;
                  me->ovs_bounce=1;
                  me->ovs_state=0;
                  me->ovs_y=0;
                  me->ovs_y=(((ctl->w*0.4)<(me->bounce_velocity>>4))?(ctl->w*0.4):(me->bounce_velocity>>4));
                  me->ovs_ustate=0;
                  me->ovs_ustart=1;
              ...
              if (scroll_y<=0){
                ...
                if (me->scroll_y!=scroll_y){
                  ...
                  me->ovs_state=0;
                  me->ovs_y=0;
                  me->ovs_y=(((0-ctl->w*0.4)>(me->bounce_velocity>>4))?(0-ctl->w*0.4):(me->bounce_velocity>>4));
                  me->ovs_ustate=0;
                  me->ovs_ustart=1;
                  me->ovs_start=libaroma_tick()-16;
                }
...
# 586 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 586 "../../../src/aroma/controls/ctl_scroll.c"
...
# 600 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 600 "../../../src/aroma/controls/ctl_scroll.c"
          ...
          if (me->scroll_tick!=0){
            ...
            if (!(me->flags&0x01)){
              ...
              if ((diff>1000)&&(me->scroll_state>0)){
                int nowstate=round(256.0*(1.0-libaroma_duration_state(me->scroll_tick+1000,400)
                                           ));
                ...
                int nowstate=round(256.0*
                  libaroma_duration_state(me->scroll_handle_time,400));
                if (nowstate!=me->scroll_state){
                  me->scroll_state=nowstate;
                  need_drawing=1;
                }
...
void _libaroma_ctl_scroll_draw(
  ...
  if (ctl->handler!=&_libaroma_ctl_scroll_handler){ return ; } _LIBAROMA_CTL_SCROLLP me = (_LIBAROMA_CTL_SCROLLP) ctl->internal
    ...
    if (me->client_canvas!=((void *)0)){
      ...
      if (me->client_canvas->h<=ctl->h){
        ...
        if ((me->minscroll_cb)&&(me->minscroll_y)){
          LIBAROMA_CANVASP mscv=libaroma_canvas_new_ex(c->w,me->minscroll_y,0,0,((void *)0));
          if (mscv){
            libaroma_draw_ex2(mscv,me->client_canvas,0,0,0,0,me->client_canvas->w,me->client_canvas->h,0,0xff,0,0);
            me->minscroll_cb(ctl, mscv, me->scroll_y);
            libaroma_canvas_free_ex1(&(mscv), 0);
          }
        }
        libaroma_canvas_setcolor(c,me->color_bg,0xff);
        libaroma_draw_ex2(c,me->client_canvas,0,0,0,me->minscroll_y,me->client_canvas->w,me->client_canvas->h-me->minscroll_y,0,0xff,0,0)
        ...
        if ((me->minscroll_cb)&&(me->minscroll_y)){
          ...
          LIBAROMA_CANVASP mscv=libaroma_canvas_new_ex(c->w,me->minscroll_y,0,0,((void *)0));
          if (mscv){
            libaroma_draw_ex2(mscv,me->client_canvas,0,0,0,draw_yv,mscv->w,mscv->h,0,0xff,0,0)
        ...
        if (bvel!=0){
          ...
          c=libaroma_canvas_new_ex(tc->w,tc->h,0,0,((void *)0));
        }
        if (draw_y<0){
...
# 762 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp parallel sections
# 762 "../../../src/aroma/controls/ctl_scroll.c"

          {
                    
# 764 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 764 "../../../src/aroma/controls/ctl_scroll.c"

            {
              ...
              if (top_h>0){
                if (!libaroma_draw_ex2(c,me->client_canvas,0,0,0,draw_y,c->w,top_h,0,0xff,0,0)
...
# 780 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 780 "../../../src/aroma/controls/ctl_scroll.c"

            {
              ...
              if (bottom_h>0){
                if (!libaroma_draw_ex2(c,me->client_canvas,0,top_h,0,bottom_y,c->w,bottom_h,0,0xff,0,0)
          ...
          if (!libaroma_draw_ex2(c,me->client_canvas,0,0,0,draw_y,c->w,draw_h,0,0xff,0,0)
        ...
        if (bvel!=0){
          int y_i = (int) bvel>>8;
          libaroma_draw_ex2(tc,c,0,0,0,y_i,tc->w,tc->h,0,0xff,0,0);
...
# 824 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp parallel sections
# 824 "../../../src/aroma/controls/ctl_scroll.c"

      {
                
# 826 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 826 "../../../src/aroma/controls/ctl_scroll.c"
          ...
          if (me->active){
            if ((!(me->flags&0x01))&&
              ...
              if ((me->scroll_state>0)||(me->handle_touched)){
                ...
                word indicator_color = is_dark?libaroma_rgb_to16(0xcccccc):libaroma_rgb_to16(0x666666);
                ...
                if (me->flags&0x04){
                  ...
                  if (me->handle_touched){
                    handle_opa=0xff;
                    indicator_color=libaroma_colorget(ctl,((void *)0))->primary;
                  }
                  else{
                    handle_opa=220;
                  }
                ...
                int hdl_h = (((hdl_ch)>(libaroma_dp(36)))?(hdl_ch):(libaroma_dp(36)));
                hdl_ch = hdl_h-hdl_ch;
...
# 890 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 890 "../../../src/aroma/controls/ctl_scroll.c"

        {
          ...
          if (me->flags&0x80){
            if (me->max_scroll_y>me->minscroll_y){
              word divcolor = libaroma_color_isdark(me->color_bg)?libaroma_rgb_to16(0xcccccc):libaroma_rgb_to16(0x666666);
...
# 924 "../../../src/aroma/controls/ctl_scroll.c"
#pragma omp section
# 924 "../../../src/aroma/controls/ctl_scroll.c"
      ...
      if ((me->max_scroll_y>me->minscroll_y)&&(me->ovs_state>0)&&(me->ovs_state<1)){
        int max_ovsz = (((c->h/4)<(libaroma_dp(100)))?(c->h/4):(libaroma_dp(100)));
        int overshoot_sz = (((abs(me->ovs_y)/3)<(max_ovsz))?(abs(me->ovs_y)/3):(max_ovsz));
        if (overshoot_sz>0){
          float opa = 0;
          if (me->ovs_state<0.25){
            opa = libaroma_cubic_bezier(0.42,0,1,1,me->ovs_state*4);
          }
          else{
            opa = 1;
          }
          if (me->ovs_ustate>0){
            opa*=1-libaroma_cubic_bezier(0.4027,0,0.2256,1,me->ovs_ustate);
          }
          opa = (((0)>((((1)<(opa))?(1):(opa))))?(0):((((1)<(opa))?(1):(opa))));
          if (me->ovs_ustate>0){
            overshoot_sz = overshoot_sz * opa;
          }
          else{
            overshoot_sz = overshoot_sz * (((1)<(opa*2))?(1):(opa*2));
          }
          float opacity=((float) overshoot_sz) / max_ovsz;
          overshoot_sz = ((((((overshoot_sz)<(c->h/5))?(overshoot_sz):(c->h/5)))<(libaroma_dp(80)))?((((overshoot_sz)<(c->h/5))?(overshoot_sz):(c->h/5))):(libaroma_dp(80)));
          if (overshoot_sz>1){
            LIBAROMA_CANVASP ovshot = libaroma_canvas_new_ex(c->w,overshoot_sz,1,0,((void *)0))
                                    ;
            libaroma_canvas_setcolor(ovshot,
              libaroma_colorget(ctl,((void *)0))->primary,0);
            int vw = c->w>>2;
            if (me->ovs_x<0){
              me->ovs_x=0;
            }
            ...
            if (me->ovs_y<0){
              ...
              libaroma_draw_ex2(c,ovshot,0,0,0,0,ovshot->w,ovshot->h,1,0xff,0,0);
            }
            else{
              ...
              libaroma_path_draw(ovshot, path, 0, 0x60*opacity, 1, 0.33);
              libaroma_path_free(path);
              libaroma_draw_ex2(c,ovshot,0,c->h-overshoot_sz,0,0,ovshot->w,ovshot->h,1,0xff,0,0);
            }
            libaroma_canvas_free_ex1(&(ovshot), 0);
          }
        }
      }
    }
    ...
    case (0x80|0x1):
      {
        ...
        me->client_touched=0;
        me->synced_y = -1;
# 1317 "../../../src/aroma/controls/ctl_scroll.c"
        pthread_create(&me->calc_thread,((void *)0),_libaroma_ctl_scroll_calc_thread,(voidp) ctl)
    ...
    case (0x80|0x2):
      {
        ...
        omp_set_nest_lock(&(me->mutex));
        pthread_join(me->calc_thread,((void *)0));
...
void _libaroma_ctl_scroll_destroy(
  ...
  if (me->client.handler->destroy!=((void *)0)){
    me->client.handler->destroy(ctl,&me->client);
  }
  if (me->client_canvas!=((void *)0)){
    libaroma_canvas_free_ex1(&(me->client_canvas), 0);
    me->client_canvas=((void *)0);
  }
  libaroma_cond_free(&me->ccond, &me->cmutex);
  omp_destroy_nest_lock(&(me->blitmutex));
  omp_destroy_nest_lock(&(me->fmutex));
...
LIBAROMA_CONTROLP libaroma_ctl_scroll(
  ...
  omp_init_nest_lock(&(me->blitmutex));
  omp_init_nest_lock(&(me->fmutex));
...
byte libaroma_ctl_scroll_set_height(LIBAROMA_CONTROLP ctl, int h){
  ...
  omp_set_nest_lock(&(me->blitmutex));
  omp_set_nest_lock(&(me->fmutex));
  ...
  if (h<1){
    ...
    if (me->client_canvas){
      ...
      omp_set_nest_lock(&(me->mutex));
      c = libaroma_canvas_new_ex(ctl->w,valid_height,0,0,((void *)0));
      libaroma_canvas_setcolor(c,me->color_bg,0xff);
      me->client_canvas = c;
      omp_unset_nest_lock(&(me->mutex));
      me->client_h = h;
  ...
  me->synced_y=-1;
  omp_unset_nest_lock(&(me->fmutex));
  omp_unset_nest_lock(&(me->blitmutex));
...
LIBAROMA_CTL_SCROLL_CLIENTP libaroma_ctl_scroll_get_client(
    LIBAROMA_CONTROLP ctl){
  if (ctl->handler!=&_libaroma_ctl_scroll_handler){ return ((void *)0); } _LIBAROMA_CTL_SCROLLP me = (_LIBAROMA_CTL_SCROLLP) ctl->internal
...
byte libaroma_ctl_scroll_blit(
  ...
  if ((bottom>draw_t)&&(y<draw_b)){
    ...
    libaroma_draw_ex2(me->client_canvas,canvas,x,dy,0,0,w,h,1,0xff,0,0)
     ...
     ;
    if (is_split){
      libaroma_draw_ex2(me->client_canvas,canvas,x,0,0,h-split_h,w,split_h,1,0xff,0,0)
