...
# 27 "../../../src/aroma/graph/draw/filters.c" 2
...
word libaroma_draw_filter_saturation(
  ...
  r = (((0)>((((0xff)<(P + (r - P) * ch))?(0xff):(P + (r - P) * ch))))?(0):((((0xff)<(P + (r - P) * ch))?(0xff):(P + (r - P) * ch))));
  g = (((0)>((((0xff)<(P + (g - P) * ch))?(0xff):(P + (g - P) * ch))))?(0):((((0xff)<(P + (g - P) * ch))?(0xff):(P + (g - P) * ch))));
  b = (((0)>((((0xff)<(P + (b - P) * ch))?(0xff):(P + (b - P) * ch))))?(0):((((0xff)<(P + (b - P) * ch))?(0xff):(P + (b - P) * ch))));
...
byte libaroma_draw_zshadow(
  ...
  if (cc){
    ...
    libaroma_draw_ex2(dst,cc,dx,dy,sx,sy,sw,sh,1,cast_a,0,0)
  ...
  if (ac){
    ...
    libaroma_draw_ex2(dst,ac,dx,dy,sx,sy,sw,sh,1,amb_a,0,0)
