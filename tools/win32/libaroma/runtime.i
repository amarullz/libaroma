...
# 27 "../../../src/aroma/utils/runtime.c" 2
...
# 31 "../../../src/aroma/utils/runtime.c" 2
...
void libaroma_runtime_activate_cores(int num_cores){
  ...
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "Processor Activated : %i Core(s)",_libaroma_runtime.core_num); fprintf(libaroma_debug_output(), "\n");;
...
void libaroma_runtime_init() {
  ...
  _libaroma_runtime.parent = getppid();
  _libaroma_runtime.monitor = getpid();
  _libaroma_runtime.me = fork();

  if (_libaroma_runtime.me == 0) {
    _libaroma_runtime.me = getpid();
    fprintf(libaroma_debug_output(), "N/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "RUNTIME: Application @%i",_libaroma_runtime.me); fprintf(libaroma_debug_output(), "\n");;
    return;
  }
  else if (_libaroma_runtime.me < 0) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "RUNTIME: Cannot Start Application Instance..."); fprintf(libaroma_debug_output(), "%s\n","");;
   
                                 ;
    libaroma_runtime_continue_parent();
    fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "RUNTIME: Halting..."); fprintf(libaroma_debug_output(), "\n");;
    _exit(-1);
  }

  fprintf(libaroma_debug_output(), "N/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "RUNTIME: MONITORING(R:%i, M:%i, A:%i)", _libaroma_runtime.parent, _libaroma_runtime.monitor, _libaroma_runtime.me); fprintf(libaroma_debug_output(), "\n");
  ...
  waitpid(_libaroma_runtime.me, &status, 0);
                               ...
                               ;
  libaroma_runtime_continue_parent();
  fprintf(libaroma_debug_output(), "N/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "RUNTIME: Exit Status (%i)", status); fprintf(libaroma_debug_output(), "\n");;
  _exit(0);
