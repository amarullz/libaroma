...
# 27 "../../../src/aroma/hid/hid.c" 2

byte libaroma_hid_driver_init(
    LIBAROMA_HIDP);
...
static LIBAROMA_HIDP _libaroma_hid=((void *)0);
static LIBAROMA_HID_INITIALIZER _libaroma_hid_initializer=((void *)0);
...
byte libaroma_hid_set_initializer(LIBAROMA_HID_INITIALIZER cb){
  if (_libaroma_hid != ((void *)0)) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_hid_set_initializer hid already initialized"); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }
...
byte libaroma_hid_init() {
  ...
  if (_libaroma_hid != ((void *)0)) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "hid instance already initialized"); fprintf(libaroma_debug_output(), "%s\n","");;
    goto return_error;
  }
  ...
  if (!_libaroma_hid) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "unable to allocating hid instance"); fprintf(libaroma_debug_output(), "%s\n","");;
    goto return_error_clean;
  }


  if (libaroma_fb() == ((void *)0)) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "framebuffer instance not initialized yet!"); fprintf(libaroma_debug_output(), "%s\n","");;
    goto return_error_clean;
  }
  ...
  if (_libaroma_hid_initializer){
    ...
    if (!_libaroma_hid_initializer(_libaroma_hid)) {
      fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "init hid driver failed"); fprintf(libaroma_debug_output(), "%s\n","");;
      goto return_error_clean;
    }
  }
  else{
    ;
    if (!libaroma_hid_driver_init(_libaroma_hid)) {
      fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "init hid driver failed"); fprintf(libaroma_debug_output(), "%s\n","");;
      goto return_error_clean;
    }
  }
  ...
  if ((_libaroma_hid->release == ((void *)0)) ||
      (_libaroma_hid->getinput == ((void *)0))){
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "hid driver callback invalid"); fprintf(libaroma_debug_output(), "%s\n","");;
    goto return_error_clean;
  }
...
void libaroma_hid_release() {
  ...
  if (_libaroma_hid == ((void *)0)) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "hid instance uninitialized"); fprintf(libaroma_debug_output(), "%s\n","");;
    return;
  }
...
byte libaroma_hid_touch_pressed() {
  return libaroma_hid_get_keypress((0x200 -1));
}
  ...
  while (_libaroma_hid != ((void *)0)) {
    ...
    switch (ret) {
      ...
      case 0xdd:
        ...
        memset(e, 0, sizeof(LIBAROMA_HID_EVENT));
        fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_hid_get got LIBAROMA_HID_EV_RET_ERROR"); fprintf(libaroma_debug_output(), "%s\n","");;
        return ret;
        break;
      case 0x06: {
          ...
          if (e->state == 0x02) {
            ...
            if ((_libaroma_hid->touch_last_x!=e->x)||
              ...
              libaroma_hid_set_keypress((0x200 -1), e->state);
...
byte libaroma_hid_config(
  ...
  if (_libaroma_hid->config == ((void *)0)) {
