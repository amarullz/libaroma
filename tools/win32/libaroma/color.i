...
# 27 "../../../src/aroma/graph/engine/color.c" 2
...
word libaroma_rgb_from_string(const char * c) {
  ...
  out[8] = 0;
  return libaroma_rgb_to16(strtoul(out, ((void *)0), 0));
}


byte libaroma_color_luminance(word rgb){
  return (byte) (((0xff)<((((0)>((( libaroma_color_r(rgb)*306+ libaroma_color_g(rgb)*602+ libaroma_color_b(rgb)*116 )>>10)))?(0):((( libaroma_color_r(rgb)*306+ libaroma_color_g(rgb)*602+ libaroma_color_b(rgb)*116 )>>10)))))?(0xff):((((0)>((( libaroma_color_r(rgb)*306+ libaroma_color_g(rgb)*602+ libaroma_color_b(rgb)*116 )>>10)))?(0):((( libaroma_color_r(rgb)*306+ libaroma_color_g(rgb)*602+ libaroma_color_b(rgb)*116 )>>10)))))
...
word libaroma_color_hsv(int h, int s, int v){
  ...
  if(sat<=0.0){
    byte lv = (((((((int) round(lum*255))>(0))?((int) round(lum*255)):(0)))<(255))?(((((int) round(lum*255))>(0))?((int) round(lum*255)):(0))):(255));
  ...
  byte lr = (((((((int) round(o_r*255))>(0))?((int) round(o_r*255)):(0)))<(255))?(((((int) round(o_r*255))>(0))?((int) round(o_r*255)):(0))):(255));
  byte lg = (((((((int) round(o_g*255))>(0))?((int) round(o_g*255)):(0)))<(255))?(((((int) round(o_g*255))>(0))?((int) round(o_g*255)):(0))):(255));
  byte lb = (((((((int) round(o_b*255))>(0))?((int) round(o_b*255)):(0)))<(255))?(((((int) round(o_b*255))>(0))?((int) round(o_b*255)):(0))):(255));
...
int libaroma_color_hue(word color, int * saturation, int * luminance){
  ...
  green/=255;
  blue/=255;
  float mn = ((((((red)<(green))?(red):(green)))<(blue))?((((red)<(green))?(red):(green))):(blue));
  float mx = ((((((red)<(green))?(red):(green)))<(blue))?((((red)<(green))?(red):(green))):(blue));
...
dword libaroma_rgb_to_rgba(word rgb, byte alpha) {
# 202 "../../../src/aroma/graph/engine/color.c"
return libaroma_rgba(
    libaroma_color_r(rgb),
    libaroma_color_g(rgb),
    libaroma_color_b(rgb),
...
# 235 "../../../src/aroma/graph/engine/color.c"
void libaroma_color_set32(dwordp dst, dword color, int n) {
...
# 315 "../../../src/aroma/graph/engine/color.c"
void libaroma_color_24to16(wordp dst, bytep src, int n) {
  int x, z;
