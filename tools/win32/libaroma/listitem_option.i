# 1 "../../../src/aroma/controls/listitem/listitem_option.c"
# 1 "<command-line>"
# 1 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "../../../src/aroma/controls/listitem/listitem_option.c"
# 26 "../../../src/aroma/controls/listitem/listitem_option.c"
...
# 27 "../../../src/aroma/controls/listitem/listitem_option.c" 2
...
# 28 "../../../src/aroma/controls/listitem/listitem_option.c" 2
...
void _libaroma_listitem_option_draw(
  ...
  if (!(state&0x10)){
    ...
    if (state&0x1){
      word selcolor = is_dark?libaroma_rgb_to16(0x335577):libaroma_rgb_to16(0xaaacad);
      libaroma_draw_rect(
        cv,
        0,0,
        cv->w,
  ...
  if (!(state&0x4)){
# 306 "../../../src/aroma/controls/listitem/listitem_option.c"
    ...
    if (is_switch){
      ...
      word h_color_active = libaroma_rgb_to16(0x009385);
      word b_color_rest = libaroma_rgb_to16(0xB2B2B2);
      word b_color_active = libaroma_rgb_to16(0xB2DFDB);
      ...
      if ((mi->selected)||(item->state!=((void *)0))){
        ...
        if (new_cache){
          ...
          libaroma_gradient_ex1(checkcache,
            0,0,rsz,rsz,libaroma_rgb_to16(0x009587),libaroma_rgb_to16(0x009587),libaroma_dp(2),0x1111,
            0xff,0xff,2);
      ...
      if (relstate<1){
        ...
        if (hal_sz>0){
          libaroma_gradient_ex1(cv,
            ...
            hal_sz,
            hal_sz,
            libaroma_rgb_to16(0xcccccc),libaroma_rgb_to16(0xcccccc),
