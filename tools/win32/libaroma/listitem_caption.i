# 1 "../../../src/aroma/controls/listitem/listitem_caption.c"
# 1 "<command-line>"
# 1 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "../../../src/aroma/controls/listitem/listitem_caption.c"
# 26 "../../../src/aroma/controls/listitem/listitem_caption.c"
...
# 27 "../../../src/aroma/controls/listitem/listitem_caption.c" 2
...
# 29 "../../../src/aroma/controls/listitem/listitem_caption.c" 2
...
LIBAROMA_CTL_LIST_ITEMP libaroma_listitem_caption_color(
  ...
  mi->text=(text?(__extension__ (__builtin_constant_p (text) && ((size_t)(const void *)((text) + 1) - (size_t)(const void *)(text) == 1) ? (((const char *) (text))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (text) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, text, __len); __retval; })) : __strdup (text))):((void *)0));
  ...
  h = (((h)>(th))?(h):(th))+libaroma_dp(vpad*2);
  mi->h=h;
...
LIBAROMA_CTL_LIST_ITEMP libaroma_listitem_caption(
  ...
  return libaroma_listitem_caption_color(ctl,id,text,
    libaroma_colorget(ctl,((void *)0))->accent,at_index);
}
