...
static FILE * _libaroma_debug_fp=((void *)0);
...
void _libaroma_config_default() {
  ...
  _libaroma_config.multicore_init_num = 8;
  _libaroma_config.snapshoot_fb = 0;
  _libaroma_config.runtime_monitor = 0x0;
...
byte libaroma_start() {
  ...
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "%s Version %s", libaroma_info(0x0), libaroma_info(0x6)); fprintf(libaroma_debug_output(), "\n");



   ;
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "  %s", libaroma_info(0x7)); fprintf(libaroma_debug_output(), "\n");;
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), " "); fprintf(libaroma_debug_output(), "\n");;
# 166 "../../../src/aroma/aroma.c"
  if (libaroma_config()->runtime_monitor) {
    libaroma_runtime_init();
  }
# 178 "../../../src/aroma/aroma.c"
  if (libaroma_config()->runtime_monitor == 0x2) {
  ...
  if (!libaroma_fb_init()) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start framebuffer..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }
  if (!libaroma_font_init()) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start font engine..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  if (!libaroma_hid_init()) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start hid engine..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  if (!libaroma_msg_init()) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start message queue..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  if (!libaroma_lang_init()) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start language engine..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  if (!libaroma_timer_init()) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start timer engine..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  if (!libaroma_wm_init()){
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_start cannot start window manager..."); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "___________________________________________________"); fprintf(libaroma_debug_output(), "\n");;
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), " "); fprintf(libaroma_debug_output(), "\n");;
