...
# 27 "../../../src/aroma/graph/draw/commondraw.c" 2
...
byte libaroma_draw_ex2(
  ...
  byte useAlpha = (draw_flags&0x1)?1:0;
  byte noDither = (draw_flags&0x2)?1:0;
  byte toBlack = (draw_flags&0x4)?1:0;
...
# 164 "../../../src/aroma/graph/draw/commondraw.c"
...
# 194 "../../../src/aroma/graph/draw/commondraw.c"
#pragma omp parallel for
# 194 "../../../src/aroma/graph/draw/commondraw.c"
...
# 209 "../../../src/aroma/graph/draw/commondraw.c"
#pragma omp parallel for
# 209 "../../../src/aroma/graph/draw/commondraw.c"
...
# 257 "../../../src/aroma/graph/draw/commondraw.c"
#pragma omp parallel for
# 257 "../../../src/aroma/graph/draw/commondraw.c"
...
# 336 "../../../src/aroma/graph/draw/commondraw.c"
  }
  else {

            
# 339 "../../../src/aroma/graph/draw/commondraw.c"
#pragma omp parallel for
# 339 "../../../src/aroma/graph/draw/commondraw.c"
...
byte libaroma_draw_line(
  ...
  byte alpha,
  byte is_mask){
# 436 "../../../src/aroma/graph/draw/commondraw.c"
  if (!dest){
    dest=libaroma_fb()->canvas;
  }
  ...
  for (wd = (wd+1)/2; ; ) {
    if ((x0>=0)&&(y0>=0)){
      if (is_mask==1){ if (!libaroma_draw_alphapixel( dest, x0, y0, (((alpha)<((((0)>(alpha * (1-(abs(err-dx+dy)/ed-wd+1))))?(0):(alpha * (1-(abs(err-dx+dy)/ed-wd+1))))))?(alpha):((((0)>(alpha * (1-(abs(err-dx+dy)/ed-wd+1))))?(0):(alpha * (1-(abs(err-dx+dy)/ed-wd+1)))))) )) { break; } } else if (is_mask==2){ if (!libaroma_draw_alphapixel( dest, x0, y0, (((0xff)<((((0)>(255 * (abs(err-dx+dy)/ed-wd+1)))?(0):(255 * (abs(err-dx+dy)/ed-wd+1)))))?(0xff):((((0)>(255 * (abs(err-dx+dy)/ed-wd+1)))?(0):(255 * (abs(err-dx+dy)/ed-wd+1))))) )) { break; } } else{ if (!libaroma_draw_pixel( dest, x0, y0, color, (((0xff)<((((0)>(alpha * (1-(abs(err-dx+dy)/ed-wd+1))))?(0):(alpha * (1-(abs(err-dx+dy)/ed-wd+1))))))?(0xff):((((0)>(alpha * (1-(abs(err-dx+dy)/ed-wd+1))))?(0):(alpha * (1-(abs(err-dx+dy)/ed-wd+1)))))) )) { break; } }
    ...
    if (2*e2 >= -dx) {
      for (e2 += dy, y2 = y0; e2 < ed*wd && (y1 != y2 || dx > dy); e2 += dx){
        if ((x0>=0)&&(y2>=0)){
          if (is_mask==1){ if (!libaroma_draw_alphapixel( dest, x0, y2+=sy, (((alpha)<((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1))))))?(alpha):((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1)))))) )) { break; } } else if (is_mask==2){ if (!libaroma_draw_alphapixel( dest, x0, y2+=sy, (((0xff)<((((0)>(255 * (abs(e2)/ed-wd+1)))?(0):(255 * (abs(e2)/ed-wd+1)))))?(0xff):((((0)>(255 * (abs(e2)/ed-wd+1)))?(0):(255 * (abs(e2)/ed-wd+1))))) )) { break; } } else{ if (!libaroma_draw_pixel( dest, x0, y2+=sy, color, (((0xff)<((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1))))))?(0xff):((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1)))))) )) { break; } }
    ...
    if (2*e2 <= dy){
      for (e2 = dx-e2; e2 < ed*wd && (x1 != x2 || dx < dy); e2 += dy){
        if ((x2>=0)&&(y0>=0)){
          if (is_mask==1){ if (!libaroma_draw_alphapixel( dest, x2 += sx, y0, (((alpha)<((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1))))))?(alpha):((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1)))))) )) { break; } } else if (is_mask==2){ if (!libaroma_draw_alphapixel( dest, x2 += sx, y0, (((0xff)<((((0)>(255 * (abs(e2)/ed-wd+1)))?(0):(255 * (abs(e2)/ed-wd+1)))))?(0xff):((((0)>(255 * (abs(e2)/ed-wd+1)))?(0):(255 * (abs(e2)/ed-wd+1))))) )) { break; } } else{ if (!libaroma_draw_pixel( dest, x2 += sx, y0, color, (((0xff)<((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1))))))?(0xff):((((0)>(alpha * (1-(abs(e2)/ed-wd+1))))?(0):(alpha * (1-(abs(e2)/ed-wd+1)))))) )) { break; } }
    ...
    if ((y>=0)&&(y<dest->h)){
      ...
      for (x=floor(dx-ht);x<=ceil(dx+ht);x++){
        if ((x>=0)&&(x<dest->w)){
          ...
          int alp = (((0xff)<(((((1-(px+py)) * 0xff)>(0))?((1-(px+py)) * 0xff):(0))))?(0xff):(((((1-(px+py)) * 0xff)>(0))?((1-(px+py)) * 0xff):(0))));
...
# 547 "../../../src/aroma/graph/draw/commondraw.c"
#pragma omp parallel for
# 547 "../../../src/aroma/graph/draw/commondraw.c"
...
# 610 "../../../src/aroma/graph/draw/commondraw.c"
#pragma omp parallel for
# 610 "../../../src/aroma/graph/draw/commondraw.c"
...
# 768 "../../../src/aroma/graph/draw/commondraw.c"
  if (start_angle>end_angle){
  ...
  double start_radian = start_angle* 3.14159265359 / 180.0;
  double end_radian = end_angle * 3.14159265359 / 180.0;
