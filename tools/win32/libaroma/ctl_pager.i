...
# 27 "../../../src/aroma/controls/ctl_pager.c" 2
...
# 28 "../../../src/aroma/controls/ctl_pager.c" 2
...
# 61 "../../../src/aroma/controls/ctl_pager.c"
...
byte _libaroma_ctl_pager_direct_canvas(LIBAROMA_CONTROLP ctl, byte state){
  if (ctl->handler!=&_libaroma_ctl_pager_handler){ return 0; } _LIBAROMA_CTL_PAGERP me = (_LIBAROMA_CTL_PAGERP) ctl->internal
  ...
  if (state){
    ...
    if (me->on_direct_canvas){
      ...
      if (ccv) {
        ...
        libaroma_draw_ex2(me->win->dc,ccv,xt,0,0,0,ccv->w,ccv->h,0,0xff,0,0);
...
byte _libaroma_ctl_pager_window_invalidate(LIBAROMA_WINDOWP win, byte sync){
  ...
  if ((me->win->dc)&&(me->win->bg)){
    libaroma_draw_ex2(me->win->dc,me->win->bg,0,0,0,0,me->win->bg->w,me->win->bg->h,0,0xff,0,0);

    int i;

          
# 166 "../../../src/aroma/controls/ctl_pager.c"
...
LIBAROMA_CANVASP _libaroma_ctl_pager_window_control_draw_begin(
  ...
  LIBAROMA_CONTROLP ctl=(LIBAROMA_CONTROLP) win->client_data;
  if (ctl->handler!=&_libaroma_ctl_pager_handler){ return ((void *)0); } _LIBAROMA_CTL_PAGERP me = (_LIBAROMA_CTL_PAGERP) ctl->internal
...
void _libaroma_ctl_pager_draw(
  ...
  if (ctl->handler!=&_libaroma_ctl_pager_handler){ return ; } _LIBAROMA_CTL_PAGERP me = (_LIBAROMA_CTL_PAGERP) ctl->internal
  ...
  if (!me->on_direct_canvas){
    if (me->win->dc){
      libaroma_draw_ex2(c,me->win->dc,0,0,me->scroll_x,0,c->w,c->h,0,0xff,0,0)
                       ;
    }
    else{
...
# 372 "../../../src/aroma/controls/ctl_pager.c"
#pragma omp parallel sections
# 372 "../../../src/aroma/controls/ctl_pager.c"

    {
              
# 374 "../../../src/aroma/controls/ctl_pager.c"
#pragma omp section
# 374 "../../../src/aroma/controls/ctl_pager.c"

      {
        ...
        if ((me->client_touch_start!=0)&&
          ...
          if (me->pretouched!=((void *)0)){
            me->win->touched=me->pretouched;
            me->pretouched=((void *)0);
        ...
        if (me->scroll_target_start>0){
          ...
          float state = libaroma_duration_state(me->scroll_target_start,(((100)>(me->scroll_duration))?(100):(me->scroll_duration)))
...
# 499 "../../../src/aroma/controls/ctl_pager.c"
#pragma omp section
# 499 "../../../src/aroma/controls/ctl_pager.c"
...
# 504 "../../../src/aroma/controls/ctl_pager.c"
#pragma omp parallel for
# 504 "../../../src/aroma/controls/ctl_pager.c"
...
byte libaroma_ctl_pager_set_active_page(
  ...
  if (dx!=0) {
    ...
    float distanceRatio = (((1.0)<(1.0 * abs(dx) / width))?(1.0):(1.0 * abs(dx) / width));
    distanceRatio -= 0.5;
    distanceRatio *= 0.3;
    ...
    duration = (((100)>((((duration)<(600))?(duration):(600))))?(100):((((duration)<(600))?(duration):(600))));
    _libaroma_ctl_pager_direct_canvas(ctl, 0);
...
int libaroma_ctl_pager_get_active_page(LIBAROMA_CONTROLP ctl){
  if (ctl->handler!=&_libaroma_ctl_pager_handler){ return -1; } _LIBAROMA_CTL_PAGERP me = (_LIBAROMA_CTL_PAGERP) ctl->internal
...
# 976 "../../../src/aroma/controls/ctl_pager.c"
LIBAROMA_CONTROLP libaroma_ctl_pager(
    LIBAROMA_WINDOWP win,
    word id, int pager_number,
    int x, int y, int w, int h
