...
# 27 "../../../src/aroma/graph/jpeg.c" 2
# 1 "../../../libs/jpeg/jinclude.h" 1
# 20 "../../../libs/jpeg/jinclude.h"
# 1 "../../../libs/jpeg/jconfig.h" 1
# 21 "../../../libs/jpeg/jinclude.h" 2
# 35 "../../../libs/jpeg/jinclude.h"
# 1 "d:\\devtools\\linaro\\lib\\gcc\\arm-linux-gnueabihf\\4.8.3\\include\\stddef.h" 1 3 4
# 147 "d:\\devtools\\linaro\\lib\\gcc\\arm-linux-gnueabihf\\4.8.3\\include\\stddef.h" 3 4
typedef int ptrdiff_t;
# 36 "../../../libs/jpeg/jinclude.h" 2
# 28 "../../../src/aroma/graph/jpeg.c" 2
# 1 "../../../libs/jpeg/jpeglib.h" 1
# 26 "../../../libs/jpeg/jpeglib.h"
# 1 "../../../libs/jpeg/jmorecfg.h" 1
# 86 "../../../libs/jpeg/jmorecfg.h"
typedef uint8_t JSAMPLE;
# 126 "../../../libs/jpeg/jmorecfg.h"
typedef int16_t JCOEF;
# 137 "../../../libs/jpeg/jmorecfg.h"
typedef uint8_t JOCTET;
# 162 "../../../libs/jpeg/jmorecfg.h"
typedef uint8_t UINT8;
# 174 "../../../libs/jpeg/jmorecfg.h"
...
# 198 "../../../libs/jpeg/jmorecfg.h"
typedef unsigned int JDIMENSION;
# 254 "../../../libs/jpeg/jmorecfg.h"
typedef int boolean;
# 27 "../../../libs/jpeg/jpeglib.h" 2
# 66 "../../../libs/jpeg/jpeglib.h"
...
# 236 "../../../libs/jpeg/jpeglib.h"
typedef enum {
 JDITHER_NONE,
 JDITHER_ORDERED,
 JDITHER_FS
} J_DITHER_MODE;
# 257 "../../../libs/jpeg/jpeglib.h"
...
# 367 "../../../libs/jpeg/jpeglib.h"
  boolean progressive_mode;
  int max_h_samp_factor;
  int max_v_samp_factor;

  JDIMENSION total_iMCU_rows;
# 382 "../../../libs/jpeg/jpeglib.h"
  int comps_in_scan;
...
# 485 "../../../libs/jpeg/jpeglib.h"
  int actual_number_of_colors;
  JSAMPARRAY colormap;
# 496 "../../../libs/jpeg/jpeglib.h"
...
# 518 "../../../libs/jpeg/jpeglib.h"
  int (*coef_bits)[64];
# 529 "../../../libs/jpeg/jpeglib.h"
  JQUANT_TBL * quant_tbl_ptrs[4];
...
struct jpeg_source_mgr {
  ...
  boolean (*seek_input_data) (j_decompress_ptr cinfo, long byte_offset);
};
# 816 "../../../libs/jpeg/jpeglib.h"
...
# 948 "../../../libs/jpeg/jpeglib.h"
extern struct jpeg_error_mgr * jpeg_std_error
 (struct jpeg_error_mgr * err);
# 964 "../../../libs/jpeg/jpeglib.h"
...
extern int jpeg_read_header (j_decompress_ptr cinfo, boolean require_image)
                             ;
# 1039 "../../../libs/jpeg/jpeglib.h"
extern boolean jpeg_start_decompress (j_decompress_ptr cinfo);
extern boolean jpeg_start_tile_decompress (j_decompress_ptr cinfo);
extern JDIMENSION jpeg_read_scanlines (j_decompress_ptr cinfo, JSAMPARRAY scanlines, JDIMENSION max_lines)

                               ;
extern JDIMENSION jpeg_read_scanlines_from (j_decompress_ptr cinfo, JSAMPARRAY scanlines, int line_offset, JDIMENSION max_lines)


                               ;
extern JDIMENSION jpeg_read_tile_scanline (j_decompress_ptr cinfo, huffman_index *index, JSAMPARRAY scanlines)

                                              ;
extern void jpeg_init_read_tile_scanline (j_decompress_ptr cinfo, huffman_index *index, int *start_x, int *start_y, int *width, int *height)
...
extern boolean jpeg_build_huffman_index
    (j_decompress_ptr cinfo, huffman_index *index);
...
# 29 "../../../src/aroma/graph/jpeg.c" 2
# 1 "../../../libs/jpeg/jerror.h" 1
# 33 "../../../libs/jpeg/jerror.h"
typedef enum {
...
# 31 "../../../src/aroma/graph/jpeg.c" 2
# 39 "../../../src/aroma/graph/jpeg.c"
  ...
  if (cinfo->src == ((void *)0)) {
    cinfo->src = (struct jpeg_source_mgr *)
                 (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 0,
                     ((size_t) sizeof(_LIBAROMA_JPEG_MEM_MGR)));
  }
...
LIBAROMA_CANVASP libaroma_jpeg_ex(
  ...
  volatile LIBAROMA_CANVASP cv = ((void *)0);
  ...
  cv = libaroma_canvas_new_ex(pcv_w,pcv_h,0,hicolor,((void *)0))
...
byte libaroma_jpeg_draw(
  ...
  if ((cinfo.output_width==vdw)&&(cinfo.output_height==vdh)){
    ...
    int pcv_h = cinfo.output_height;
    int pcv_c = cinfo.output_components;
    LIBAROMA_CANVASP cvt = libaroma_canvas_new_ex(pcv_w,pcv_h,0,0,((void *)0));
    if(!cvt) {
      jpeg_finish_decompress(&cinfo);
      jpeg_destroy_decompress(&cinfo);
      goto exit;
    ...
    libaroma_canvas_free_ex1(&(cvt), 0);
    retval=1;
  }
  jpeg_finish_decompress(&cinfo);
  jpeg_destroy_decompress(&cinfo);
