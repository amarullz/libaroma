...
# 27 "../../../src/aroma/graph/fb.c" 2

byte libaroma_fb_driver_init(
    LIBAROMA_FBP);
...
static LIBAROMA_FBP _libaroma_fb=((void *)0);
static LIBAROMA_FB_INITIALIZER _libaroma_fb_initializer=((void *)0);
static omp_nest_lock_t _libaroma_fb_onpost_mutex;
...
byte libaroma_fb_set_initializer(LIBAROMA_FB_INITIALIZER cb){
  if (_libaroma_fb != ((void *)0)) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_fb_set_initializer framebuffer already initialized"); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }
...
byte libaroma_fb_init() {
  if (_libaroma_fb != ((void *)0)) {
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_fb_init framebuffer already initialized"); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }
  ...
  if (!_libaroma_fb){
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_fb_init allocating framebuffer instance failed"); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }

  if (_libaroma_fb_initializer!=((void *)0)){
    ;
    if (_libaroma_fb_initializer(_libaroma_fb) == 0){
      free(_libaroma_fb);
      _libaroma_fb = ((void *)0);
      fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_fb_init driver error"); fprintf(libaroma_debug_output(), "%s\n","");;
      return 0;
    }
  }
  else{
  ...
  if (
    (_libaroma_fb->release == ((void *)0)) ||
    (_libaroma_fb->start_post == ((void *)0)) ||
    (_libaroma_fb->end_post == ((void *)0)) ||
    (_libaroma_fb->post == ((void *)0))
  ) {
    free(_libaroma_fb);
    _libaroma_fb = ((void *)0);
    fprintf(libaroma_debug_output(), "E/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "libaroma_fb_init driver doesn't set the callbacks"); fprintf(libaroma_debug_output(), "%s\n","");;
    return 0;
  }
  ...
  if ((_libaroma_fb->dpi < 160)||(_libaroma_fb->dpi > 960)) {
    ...
    _libaroma_fb->dpi = floor((((_libaroma_fb->w)<(_libaroma_fb->h))?(_libaroma_fb->w):(_libaroma_fb->h))/160) * 80;
  ...
  int dpMinWH = (((libaroma_width_dp())<(libaroma_height_dp()))?(libaroma_width_dp()):(libaroma_height_dp()));
  ...
  if ((!_libaroma_fb->internal_canvas)||(!_libaroma_fb->canvas)){
    ...
    _libaroma_fb->canvas =
      libaroma_canvas_new_ex(_libaroma_fb->w,_libaroma_fb->h,0,0,(libaroma_config()->fb_shm_name[0]!=0)? libaroma_config()->fb_shm_name:((void *)0))
  ...
  fprintf(libaroma_debug_output(), "I/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "Framebuffer Initialized (%ix%ipx - %i dpi - %s)", _libaroma_fb->w, _libaroma_fb->h, _libaroma_fb->dpi, _libaroma_fb->double_buffer?"Double Buffer":"Single Buffer"); fprintf(libaroma_debug_output(), "\n");
  ...
  if (libaroma_config()->snapshoot_fb){
    if (_libaroma_fb->snapshoot!=((void *)0)){
      ;
  ...
  omp_init_nest_lock(&(_libaroma_fb_onpost_mutex));
  return 1;
}
...
byte libaroma_fb_start_post(){
  ...
  omp_set_nest_lock(&(_libaroma_fb_onpost_mutex));
  if (_libaroma_fb->start_post(_libaroma_fb)){
   _libaroma_fb->onpost=1;
    return 1;
  }
  omp_unset_nest_lock(&(_libaroma_fb_onpost_mutex));
  return 0;
}
...
byte libaroma_fb_release() {
  ...
  if (!_libaroma_fb->internal_canvas){
    ;
    libaroma_canvas_free_ex1(&(_libaroma_fb->canvas), 1);
  }
  ...
  fprintf(libaroma_debug_output(), "N/%s: ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "Framebuffer Released"); fprintf(libaroma_debug_output(), "\n");;
  ...
  _libaroma_fb->onpost=0;
  omp_destroy_nest_lock(&(_libaroma_fb_onpost_mutex));
...
LIBAROMA_CANVASP libaroma_fb_snapshoot_canvas() {
  ...
  LIBAROMA_CANVASP new_canvas = libaroma_canvas_new_ex(_libaroma_fb->w,_libaroma_fb->h,0,0,((void *)0))
                                     ;
  if (!new_canvas) {
    ;
    return ((void *)0);
  ...
  libaroma_canvas_free_ex1(&(new_canvas), 0);
  ;
  return ((void *)0);
}
