...
# 27 "../../../src/aroma/ui/color_manager.c" 2
...
# 28 "../../../src/aroma/ui/color_manager.c" 2
...
byte libaroma_colorset(LIBAROMA_COLORSETP colorset, byte type){
  ...
  colorset->primary=libaroma_rgb_to16(0x2196F3);
  colorset->primary_text=libaroma_rgb_to16(0xFFFFFF);
  colorset->primary_icon=libaroma_rgb_to16(0xFFFFFF);
  colorset->primary_light=libaroma_rgb_to16(0xBBDEFB);
  colorset->accent=libaroma_rgb_to16(0x2E7D32);
  colorset->window_bg=libaroma_rgb_to16(0xE0E0E0);
  colorset->window_text=libaroma_rgb_to16(0x212121);
  colorset->control_bg=libaroma_rgb_to16(0xFFFFFF);
  colorset->control_primary_text=libaroma_rgb_to16(0x212121);
  colorset->control_secondary_text=libaroma_rgb_to16(0x727272);
  colorset->divider=libaroma_rgb_to16(0xB6B6B6);


  colorset->dialog_bg=libaroma_rgb_to16(0xFFFFFF);
  colorset->dialog_primary_text=libaroma_rgb_to16(0x212121);
  colorset->dialog_secondary_text=libaroma_rgb_to16(0x727272);
