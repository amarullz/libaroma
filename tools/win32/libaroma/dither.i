...
# 27 "../../../src/aroma/graph/engine/dither.c" 2
...
word libaroma_dither_rgb(int x, int y, byte sr, byte sg, byte sb) {
  ...
  byte r = libaroma_color_close_r((((sr + libaroma_dither_tresshold_r[dither_xy])<(0xff))?(sr + libaroma_dither_tresshold_r[dither_xy]):(0xff))
                                                                 );
  byte g = libaroma_color_close_g((((sg + libaroma_dither_tresshold_g[dither_xy])<(0xff))?(sg + libaroma_dither_tresshold_g[dither_xy]):(0xff))
                                                                 );
  byte b = libaroma_color_close_r((((sb + libaroma_dither_tresshold_b[dither_xy])<(0xff))?(sb + libaroma_dither_tresshold_b[dither_xy]):(0xff))
                                                                 );
...
word libaroma_dither_mono_rgb(int x, int y, byte sr, byte sg, byte sb) {
  ...
  byte r = libaroma_color_close_r((((sr + dither_xyrb)<(0xff))?(sr + dither_xyrb):(0xff)));
  byte g = libaroma_color_close_g((((sg + dither_xy)<(0xff))?(sg + dither_xy):(0xff)));
  byte b = libaroma_color_close_r((((sb + dither_xyrb)<(0xff))?(sb + dither_xyrb):(0xff)));
  return libaroma_rgb(r, g, b);
}
word libaroma_dither_mono(int x, int y, dword col) {
...
# 151 "../../../src/aroma/graph/engine/dither.c"
void libaroma_dither_24to16(int y, int n, wordp dst, bytep src) {
  int x, z, m=0;
