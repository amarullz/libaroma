...
byte libaroma_control_draw_flush(
  ...
  if (win->handler!=((void *)0)){
    if (win->handler->control_draw_flush!=((void *)0)){
...
byte libaroma_control_erasebg(
  ...
  LIBAROMA_WINDOWP win = ctl->window;
  if (win->handler!=((void *)0)){
    if (win->handler->control_erasebg!=((void *)0)){
  ...
  libaroma_draw_ex2(canvas,win->bg,0,0,ctl->x,ctl->y,ctl->w,ctl->h,0,0xff,0,0)
...
byte libaroma_control_isvisible(LIBAROMA_CONTROLP ctl){
  ...
  LIBAROMA_WINDOWP win = ctl->window;
  if (win->handler!=((void *)0)){
    if (win->handler->control_isvisible!=((void *)0)){
...
LIBAROMA_CANVASP libaroma_control_draw_begin(
  ...
  LIBAROMA_WINDOWP win = ctl->window;
  if (win->handler!=((void *)0)){
    if (win->handler->control_draw_begin!=((void *)0)){
