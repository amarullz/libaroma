...
# 28 "../../../src/aroma/ui/window.c" 2
# 42 "../../../src/aroma/ui/window.c"
...
int libaroma_window_measure_calculate(
  ...
  if (is_size){
    if (pos<=0){
      switch (pos){
        case -4: return (max / 2)-x; break;
        case -5: return (max / 3)-x; break;
        case -6: return (max * 2 / 3)-x; break;
        case -7: return (max / 4)-x; break;
        case -8: return (max * 3 / 4)-x; break;
        case 0: return max; break;
        case -1: return max / 2; break;
        case -2: return max / 3; break;
        case -3: return max / 4; break;
    ...
    if (pos<0){
      switch (pos){
        case -4: return max / 2; break;
        case -5: return max / 3; break;
        case -6: return max * 2 / 3; break;
        case -7: return max / 4; break;
        case -8: return max * 3 / 4; break;
        default: return abs(pos);
      }
    }
  }
...
byte libaroma_window_measure_size(LIBAROMA_WINDOWP win){
  if (win){
    ...
    _libaroma_window_measure_save(win,((void *)0));
    LIBAROMA_MSG _msg;
    libaroma_window_process_event(win,libaroma_wm_compose(
      &_msg, (0x80|0x5), ((void *)0), 0, 0)
    );
    return 1;
  }
  return 0;
...
LIBAROMA_WINDOWP libaroma_window(
  ...
  if (libaroma_wm()==((void *)0)){ ; return ((void *)0); };
...
byte libaroma_window_free(
  ...
  if (libaroma_wm()==((void *)0)){ ; return 0; };
  if (win==((void *)0)){
    return 0;
  }
  ...
  if (win->parent==((void *)0)){
    if (libaroma_wm_get_active_window()==win){
      ...
      libaroma_wm_set_active_window(((void *)0));
    }

    LIBAROMA_MSG _msg;
    libaroma_window_process_event(win,
      libaroma_wm_compose(&_msg, (0x80|0x2), ((void *)0), 0, 0));
  }

  if (win->handler!=((void *)0)){
    if (win->handler->prefree!=((void *)0)){
...
# 301 "../../../src/aroma/ui/window.c"
  ...
  if (win->handler!=((void *)0)){
    if (win->handler->postfree!=((void *)0)){
...
byte _libaroma_window_updatebg(LIBAROMA_WINDOWP win){
  ...
  if (win->handler!=((void *)0)){
    if (win->handler->updatebg!=((void *)0)){
  ...
  libaroma_canvas_setcolor(
    win->bg,
    libaroma_colorget(((void *)0),win)->window_bg,
    0xff
  );
...
byte libaroma_window_measure(LIBAROMA_WINDOWP win, LIBAROMA_CONTROLP ctl){
  if (win&&ctl){
    ...
    _libaroma_window_measure_save(((void *)0),ctl);
...
LIBAROMA_CONTROLP libaroma_window_setfocus(
  ...
  if (ctl!=((void *)0)){
    ...
    int i;
    for (i=0;i<win->childn;i++){
      if (win->childs[i]->handler->focus!=((void *)0)){
...
byte libaroma_window_invalidate(LIBAROMA_WINDOWP win, byte sync){
  ...
  if (win->handler!=((void *)0)){
    if (win->handler->invalidate!=((void *)0)){
  ...
  if ((!win->lock_sync)||(sync==10)){
    ...
    libaroma_draw_ex2(win->dc,win->bg,0,0,0,0,win->bg->w,win->bg->h,1,0xff,0,0)
...
byte libaroma_window_anishow(
  ...
  if (libaroma_wm_set_active_window(win)){
    ...
    LIBAROMA_CANVASP tdc = libaroma_canvas_new_ex(wmc->w,wmc->h,0,0,((void *)0));
    libaroma_draw_ex2(tdc,wmc,0,0,0,0,wmc->w,wmc->h,0,0xff,0,0);
    win->dc=tdc;

    LIBAROMA_CANVASP back = libaroma_canvas_new_ex(wmc->w,wmc->h,0,0,((void *)0));
    libaroma_draw_ex2(back,wmc,0,0,0,0,wmc->w,wmc->h,0,0xff,0,0);
    ...
    while ((delta=libaroma_tick()-start)<duration){
      ...
      switch (animation){
        case 7:
          {
            float swift_out_state = libaroma_cubic_bezier(0.4027,0,0.2256,1,state);
            float bstate = 255.0 * swift_out_state;
            byte bbstate = (byte) round(bstate);
            libaroma_draw_ex2(wmc,win->dc,0,0,0,0,win->dc->w,win->dc->h,0,bbstate,0,0)
        ...
        case 9:
          {
            ...
            if (h>0){
              if (animation==8){
                if (h<win->h){
                  libaroma_draw_ex2(wmc,back,0,0,0,win->h - (win->h - h),win->w,win->h-h,0,0xff,0,0)
              ...
              libaroma_draw_ex2(wmc,win->dc,0,y,0,0,win->w,h,0,0xff,0,0)
        ...
        case 11:
          {
            ...
            if (h>0){
              if (animation==10){
                if (h<win->h){
                  libaroma_draw_ex2(wmc,back,0,h,0,0,win->w,win->h-h,0,0xff,0,0)
              ...
              libaroma_draw_ex2(wmc,win->dc,0,0,0,win->h-h,win->w,h,0,0xff,0,0)
        ...
        case 1:
          {
            ...
            if (w>0){
              if (animation==3){
                if (w<win->w){
                  libaroma_draw_ex2(wmc,back,0,0,win->w - (win->w - w),0,win->w - w,win->h,0,0xff,0,0)
              ...
              libaroma_draw_ex2(wmc,win->dc,x,0,0,0,w,win->h,0,0xff,0,0)
        ...
        case 2:
          {
            ...
            if (w>0){
              if (animation==4){
                if (w<win->w){
                  libaroma_draw_ex2(wmc,back,w,0,0,0,win->w - w,win->h,0,0xff,0,0)
              ...
              libaroma_draw_ex2(wmc,win->dc,0,0,win->w-w,0,w,win->h,0,0xff,0,0)
    ...
    retval = 1;
    libaroma_draw_ex2(wmc,win->dc,0,0,0,0,win->dc->w,win->dc->h,0,0xff,0,0);

    win->dc=wmc;


    libaroma_canvas_free_ex1(&(back), 0);
    libaroma_canvas_free_ex1(&(tdc), 0);
  }
...
void libaroma_window_calculate_pos(
  ...
  else if ((ctl!=((void *)0))&&(ctl->window!=((void *)0))){
    *x-=ctl->window->x;
    *y-=ctl->window->y;
  }
  if (ctl!=((void *)0)){
    ...
    case 0x06:
      {
        ...
        if (msg->state==0x01){
          ...
          int x = msg->x;
          int y = msg->y;
          libaroma_window_calculate_pos(win,((void *)0),&x,&y);
          int i;
          for (i=0;i<win->childn;i++){
...
dword libaroma_window_pool(
  ...
  LIBAROMA_MSG _msg;
  LIBAROMA_MSGP cmsg=(msg!=((void *)0))?msg:&_msg;
