...
# 27 "../../../src/aroma/controls/ctl_fragment.c" 2
...
# 28 "../../../src/aroma/controls/ctl_fragment.c" 2
...
static LIBAROMA_WINDOW_HANDLER _libaroma_ctl_fragment_win_handler={
  ...
  message_hooker:((void *)0),
  control_draw_flush:((void *)0),
  control_erasebg:((void *)0),
...
# 137 "../../../src/aroma/controls/ctl_fragment.c"
byte _libaroma_ctl_fragment_direct_canvas(LIBAROMA_CONTROLP ctl, byte state){
  if (ctl->handler!=&_libaroma_ctl_fragment_handler){ return 0; } _LIBAROMA_CTL_FRAGMENTP me = (_LIBAROMA_CTL_FRAGMENTP) ctl->internal

   ;
  omp_set_nest_lock(&(me->dmutex));
  if ((me->win_n<1)||(me->win_pos==-1)) {
    omp_unset_nest_lock(&(me->dmutex));
    return 0;
  }
  ...
  if (state){
    ...
    if (me->on_direct_canvas){
      ...
      if (ccv) {
        libaroma_draw_ex2(win->dc,ccv,0,0,0,0,ccv->w,ccv->h,0,0xff,0,0);
        libaroma_canvas_free_ex1(&(ccv), 0);
      }
    }
...
byte _libaroma_ctl_fragment_window_invalidate(LIBAROMA_WINDOWP win, byte sync){
  _LIBAROMA_CTL_FRAGMENT_WINP wind = (_LIBAROMA_CTL_FRAGMENT_WINP) win->client_data; if (!wind){ return 0; } LIBAROMA_CONTROLP ctl=wind->ctl; if (ctl->handler!=&_libaroma_ctl_fragment_handler){ return 0; } _LIBAROMA_CTL_FRAGMENTP me = (_LIBAROMA_CTL_FRAGMENTP) ctl->internal; int win_index = _libaroma_ctl_fragment_get_win_index(me,win); if (win_index==-1){ return 0; };
  if ((win->dc)&&(win->bg)){
    libaroma_draw_ex2(win->dc,win->bg,0,0,0,0,win->bg->w,win->bg->h,0,0xff,0,0);
    int i;

          
# 175 "../../../src/aroma/controls/ctl_fragment.c"
...
void _libaroma_ctl_fragment_measure(LIBAROMA_WINDOWP win){
  _LIBAROMA_CTL_FRAGMENT_WINP wind = (_LIBAROMA_CTL_FRAGMENT_WINP) win->client_data; if (!wind){ return ; } LIBAROMA_CONTROLP ctl=wind->ctl; if (ctl->handler!=&_libaroma_ctl_fragment_handler){ return ; } _LIBAROMA_CTL_FRAGMENTP me = (_LIBAROMA_CTL_FRAGMENTP) ctl->internal; int win_index = _libaroma_ctl_fragment_get_win_index(me,win); if (win_index==-1){ return ; };
  omp_set_nest_lock(&(me->dmutex));
  win->x = 0;
  win->y = 0;
  win->ax=ctl->x;
  ...
  if (win->dc){
    if ((win->dc->w!=win->w)||(win->dc->h!=win->h)){
      libaroma_canvas_free_ex1(&(win->dc), 0);
      win->dc=((void *)0);
    }
  }
  if (!win->dc){
    win->dc = libaroma_canvas_new_ex(win->w,win->h,0,0,((void *)0))
...
# 214 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 214 "../../../src/aroma/controls/ctl_fragment.c"
...
# 237 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 237 "../../../src/aroma/controls/ctl_fragment.c"
...
# 261 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 261 "../../../src/aroma/controls/ctl_fragment.c"
...
LIBAROMA_CANVASP _libaroma_ctl_fragment_window_control_draw_begin(
  ...
  _LIBAROMA_CTL_FRAGMENT_WINP wind = (_LIBAROMA_CTL_FRAGMENT_WINP) win->client_data; if (!wind){ return ((void *)0); } LIBAROMA_CONTROLP ctl=wind->ctl; if (ctl->handler!=&_libaroma_ctl_fragment_handler){ return ((void *)0); } _LIBAROMA_CTL_FRAGMENTP me = (_LIBAROMA_CTL_FRAGMENTP) ctl->internal; int win_index = _libaroma_ctl_fragment_get_win_index(me,win); if (win_index==-1){ return ((void *)0); };
  if (!wind->active_state){
    return ((void *)0);
  }
  LIBAROMA_CANVASP c=((void *)0);
  omp_set_nest_lock(&(me->dmutex));
  if (me->on_direct_canvas){
    int x = cctl->x;
    int y = cctl->y;
...
byte _libaroma_ctl_fragment_window_updatebg(LIBAROMA_WINDOWP win){
  ...
  if (win->bg!=((void *)0)){
    ...
    libaroma_canvas_free_ex1(&(win->bg), 0);
  }
  win->bg = libaroma_canvas_new_ex(w,h,0,0,((void *)0));
  libaroma_canvas_setcolor(
    win->bg,
    libaroma_colorget(ctl,((void *)0))->window_bg,
    0xff
  );
  omp_unset_nest_lock(&(me->dmutex));
  return 1;
...
void _libaroma_ctl_fragment_draw(
    LIBAROMA_CONTROLP ctl,
    LIBAROMA_CANVASP c){
  if (ctl->handler!=&_libaroma_ctl_fragment_handler){ return ; } _LIBAROMA_CTL_FRAGMENTP me = (_LIBAROMA_CTL_FRAGMENTP) ctl->internal
...
# 403 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 403 "../../../src/aroma/controls/ctl_fragment.c"
  ...
  if (!me->on_direct_canvas){
    if (me->win_pos_out==-1){
      ...
      if (awin->dc){
        libaroma_draw_ex2(c,awin->dc,0,0,0,0,awin->dc->w,awin->dc->h,0,0xff,0,0);
      }
      else{
        libaroma_control_erasebg(ctl,c);
      }
      ...
      if (me->transition_state==1){
        ...
        if (owin->dc){
          libaroma_draw_ex2(c,owin->dc,0,0,0,0,owin->dc->w,owin->dc->h,0,0xff,0,0);
        }
        else{
          libaroma_control_erasebg(ctl,c);
        }
        if (awin->dc){
          libaroma_draw_ex2(c,awin->dc,0,0,0,0,awin->dc->w,awin->dc->h,0,0xff*me->transition_state,0,0);
        }
      }
    }
  }
...
# 501 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 501 "../../../src/aroma/controls/ctl_fragment.c"
...
# 511 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 511 "../../../src/aroma/controls/ctl_fragment.c"
...
# 575 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 575 "../../../src/aroma/controls/ctl_fragment.c"
  ...
  omp_destroy_nest_lock(&(me->dmutex));
  free(me);
}
...
# 621 "../../../src/aroma/controls/ctl_fragment.c"
#pragma omp parallel for
# 621 "../../../src/aroma/controls/ctl_fragment.c"
    ...
    case 0x06:
      {
        ...
        if ((msg->state!=0x01)&&(me->win_cleanup)){
          omp_unset_nest_lock(&(me->mutex));
          return 0;
        }
        me->win_cleanup=0;
...
LIBAROMA_WINDOWP libaroma_ctl_fragment_new_window(
  LIBAROMA_CONTROLP ctl, int id){
  if (ctl->handler!=&_libaroma_ctl_fragment_handler){ return ((void *)0); } _LIBAROMA_CTL_FRAGMENTP me = (_LIBAROMA_CTL_FRAGMENTP) ctl->internal
