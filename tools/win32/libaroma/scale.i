...
# 27 "../../../src/aroma/graph/draw/scale.c" 2
        ...
        for (j = 0; j < dw; j++) {
          ...
          if (dst->alpha) {
            *t = libaroma_alpha(
            ...
            dst->alpha[v + j] = (((dst->alpha[v + j] + a[x2])<(0xff))?(dst->alpha[v + j] + a[x2]):(0xff));
          }
          else {
      ...
      if (src->alpha != ((void *)0)) {
        ...
        if (dst->alpha != ((void *)0)) {
          ...
          *dstp = libaroma_alpha(
          ...
          dst->alpha[dst_pos] = (((dst->alpha[dst_pos]+asz)<(0xff))?(dst->alpha[dst_pos]+asz):(0xff));
        }
        else {
