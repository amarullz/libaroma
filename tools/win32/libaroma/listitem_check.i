# 1 "../../../src/aroma/controls/listitem/listitem_check.c"
# 1 "<command-line>"
# 1 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "../../../src/aroma/controls/listitem/listitem_check.c"
# 26 "../../../src/aroma/controls/listitem/listitem_check.c"
...
# 27 "../../../src/aroma/controls/listitem/listitem_check.c" 2
# 1 "../../../src/aroma/controls/listitem/../../ui/ui_internal.h" 1
# 37 "../../../src/aroma/controls/listitem/../../ui/ui_internal.h"
...
# 28 "../../../src/aroma/controls/listitem/listitem_check.c" 2
...
byte libaroma_listitem_set_selected(
  ...
  if (!selected){
    if (mi->change_cb){
      if (mi->change_cb(
        ctl, item, item->id, mi->selected, mi->change_data, 0x0
      )){
        mi->selected=0;
        mi->onchangeani=1;
      }
    ...
    if (mi->change_cb){
      if (mi->change_cb(
        ctl, item, item->id, mi->selected, mi->change_data, 0x1
      )){
        mi->selected=1;
        mi->onchangeani=1;
      }
    ...
    case 0x5:
      {
        ...
        libaroma_window_post_command_ex(
          (((0x2&0xff) << 24) | ((0&0xff) << 16) | (ctl->id&0xffff)),
    ...
    case 0x2:
      {
        ...
        if (param!=0x10){
          ...
          libaroma_window_post_command_ex(
            (((0x1&0xff) << 24) | ((0&0xff) << 16) | (ctl->id&0xffff)),
            mi->selected, item->id, 0, (voidp) item
          );
        }
        return 0;
...
void _libaroma_listitem_check_draw(
  ...
  if (!(state&0x10)){
    int vpad = 8;
    int seph = (flags&0x0004)?1:0;
    byte small_icon = (flags&0x0200)?1:0;

    if (state&0x1){
      word selcolor = is_dark?libaroma_rgb_to16(0x444444):libaroma_rgb_to16(0xbbbbbb);
      libaroma_draw_rect(
        cv,
        0,0,
        cv->w,
      ...
      textcolor= is_dark?libaroma_rgb_to16(0xffffff):libaroma_rgb_to16(0x000000);
      graycolor= is_dark?libaroma_rgb_to16(0x888888):libaroma_rgb_to16(0x777777);
    }
    else{
      textcolor= is_dark?libaroma_rgb_to16(0xffffff):libaroma_rgb_to16(0x000000);
      graycolor= is_dark?libaroma_rgb_to16(0x888888):libaroma_rgb_to16(0x777777);
    ...
    if ((item->next)&&(flags&0x0004)){
      if (!libaroma_listitem_nonitem(item->next)){
        ...
        libaroma_draw_rect(
          ...
          cv->w-sepxp,
          libaroma_dp(1),
          is_dark?libaroma_rgb_to16(0x555555):libaroma_rgb_to16(0xdddddd),
          0xff
        );
      }
    }
    ...
    if ((mi->icon)||(item->flags&0x0100)){
      tw-=libaroma_dp(56);
      tx+=libaroma_dp(56);
    }

    int ty = libaroma_dp(vpad*2);
    LIBAROMA_TEXT mtextp=((void *)0);
    LIBAROMA_TEXT etextp=((void *)0);
    ...
    int my_h = (((icoh)>(ty))?(icoh):(ty));


    if (mi->icon){
      if ((flags&0x0800)||
        (!(flags&0x0400))){
        libaroma_draw_ex2(cv,mi->icon,libaroma_dp(16),(my_h>>1) - (dpsz>>1),0,0,mi->icon->w,mi->icon->h,1,0xff,0,0)
    ...
    if (mtextp){
      libaroma_text_draw_ex(cv,mtextp,tx,txt_sy,0,0,0,0,0,0,0,0,0);
      txt_sy+=m_h;
    ...
    if (etextp){
      libaroma_text_draw_ex(cv,etextp,tx,txt_sy,0,0,0,0,0,0,0,0,0);
  ...
  if (!(state&0x4)){
    byte is_switch = (flags&0x1000)?1:0;
    float relstate=1;
    if ((item->state!=((void *)0))&&(mi->onchangeani)){
      if (item->state->ripple.touched==2){
        relstate=0;
      }
      else if (((&item->state->ripple)->release_start[(&item->state->ripple)->p])){
        float curelstate=((&item->state->ripple)->release_state[(&item->state->ripple)->p])
        ...
        if (curelstate<0.25){
          ...
          relstate=(((((((curelstate-0.25) * 2)<(1))?((curelstate-0.25) * 2):(1)))>(0))?(((((curelstate-0.25) * 2)<(1))?((curelstate-0.25) * 2):(1))):(0));
          relstate=libaroma_cubic_bezier(0.4027,0,0.2256,1,relstate);
          relstate=((((((1)<(relstate))?(1):(relstate)))>(0))?((((1)<(relstate))?(1):(relstate))):(0));
        }
      }
    }
    ...
    int ypos = cv->h>>1;
    if (is_switch){
      word h_color_rest = libaroma_rgb_to16(0xECECEC);
      word h_color_active = libaroma_colorget(ctl,((void *)0))->primary;
      word b_color_rest = libaroma_rgb_to16(0xB2B2B2);
      word b_color_active = libaroma_colorget(ctl,((void *)0))->primary_light;
      ...
      if (item->state!=((void *)0)){
        if (item->state->cache_client!=((void *)0)){

          libaroma_draw_ex2(cv,item->state->cache_client,h_draw_x-rsz,h_draw_y,0,0,item->state->cache_client->w,item->state->cache_client->h,3,0x30,0,0)
      ...
      if (new_shadow){
        ...
        libaroma_draw_ex2(cv,scv,h_draw_x-rsz,h_draw_y,0,0,scv->w,scv->h,3,0x30,0,0);
        if (item->state!=((void *)0)){
      ...
      byte isoption=(0x4000&flags)?1:0;
      word cprimary=is_dark?
      libaroma_colorget(ctl,((void *)0))->primary_light:
      libaroma_colorget(ctl,((void *)0))->primary;
      word dprimary=libaroma_colorget(ctl,((void *)0))->control_secondary_text;
      int rsz = libaroma_dp(18);


      byte new_cache = 0;
      LIBAROMA_CANVASP checkcache = ((void *)0);
      if ((mi->selected)||(item->state!=((void *)0))){
        new_cache=1;
        if (item->state!=((void *)0)){
          if (item->state->cache_client!=((void *)0)){
        ...
        if (new_cache){
          checkcache = libaroma_canvas_new_ex(rsz,rsz,1,0,((void *)0));
      ...
      if (relstate<1){
        ...
        libaroma_draw_ex2(cv,checkcache,xpos-(rsz>>1),ypos-(rsz>>1),0,0,checkcache->w,checkcache->h,1,0xff,0,0)
      ...
      if (new_cache){
        libaroma_canvas_free_ex1(&(checkcache), 0);
      }
...
void _libaroma_listitem_check_release_internal(_LIBAROMA_LISTITEM_CHECKP mi,
  ...
  if (mi->icon){
    if ((flags&0x0800)||
      (!(flags&0x0400))){
      libaroma_canvas_free_ex1(&(mi->icon), 0);
    }
  }
  free(mi);
}
...
byte libaroma_listitem_check_set_cb(
  ...
  if (mi->change_cb){
    mi->change_cb(
      ctl, item, item->id, mi->selected, mi->change_data, 0x2
    );
    mi->change_cb=((void *)0);
    mi->change_data=((void *)0);
  }
  if (cb){
    mi->change_cb=cb;
    mi->change_data=data;
...
LIBAROMA_CTL_LIST_ITEMP libaroma_listitem_check(
  ...
  int h = 0;
  if (icon){
    int dpsz=libaroma_dp((flags&0x0200)?24:40);
    if ((flags&0x0800)||
      (!(flags&0x0400))){
      mi->icon=libaroma_canvas_new_ex(dpsz,dpsz,1,0,((void *)0));
      if (mi->icon){
        flags|=0x0100;
  ...
  mi->main_text=(main_text?(__extension__ (__builtin_constant_p (main_text) && ((size_t)(const void *)((main_text) + 1) - (size_t)(const void *)(main_text) == 1) ? (((const char *) (main_text))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (main_text) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, main_text, __len); __retval; })) : __strdup (main_text))):((void *)0));
  mi->extra_text=(extra_text?(__extension__ (__builtin_constant_p (extra_text) && ((size_t)(const void *)((extra_text) + 1) - (size_t)(const void *)(extra_text) == 1) ? (((const char *) (extra_text))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (extra_text) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, extra_text, __len); __retval; })) : __strdup (extra_text))):((void *)0));
  ...
  int tw = ctl->w-libaroma_dp((flags&0x2000)?52:88);
  if ((mi->icon)||(flags&0x0100)){
    tw-=libaroma_dp(56);
  }
  ...
  h = (((h)>(th))?(h):(th))+libaroma_dp(vpad*2+seph);
  mi->h=h;
