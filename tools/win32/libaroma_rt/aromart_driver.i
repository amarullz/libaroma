...
# 27 "../../../src/aromart/aromart_driver.c" 2
...
byte lart_fb_end_post(LIBAROMA_FBP me){
  return lart_app_command(0x01,0,((void *)0),0,((void *)0),((void *)0),((void *)0));
}
...
byte lart_libaroma_start(){
  ...
  if (!libaroma_fb_init()) {
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start framebuffer..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  if (!libaroma_font_init()) {
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start font engine..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  if (!libaroma_hid_init()) {
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start hid engine..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  if (!libaroma_msg_init()) {
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start message queue..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  if (!libaroma_lang_init()) {
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start language engine..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  if (!libaroma_timer_init()) {
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start timer engine..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  if (!libaroma_wm_init()){
    fprintf(libaroma_debug_output(), "E/%s: " "RUNTIME" ": ",libaroma_debug_tag()); fprintf(libaroma_debug_output(), "lart_libaroma_start cannot start window manager..."); fprintf(libaroma_debug_output(), "\n");;
    return 0;
  }
  return 1;
}
