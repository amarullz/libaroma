...
jpeg_read_coefficients (j_decompress_ptr cinfo)
{
  ...
  if ((cinfo->global_state == 210 ||
       cinfo->global_state == 207) && cinfo->buffered_image) {
