...
# 15 "../../../libs/jpeg/jcomapi.c" 2
# 28 "../../../libs/jpeg/jcomapi.c"
void
jpeg_abort (j_common_ptr cinfo)
{
  ...
  if (cinfo->is_decompressor) {
    ...
    ((j_decompress_ptr) cinfo)->marker_list = ((void *)0);
  } else {
    cinfo->global_state = 100;
  }
}
# 68 "../../../libs/jpeg/jcomapi.c"
void
...
jpeg_alloc_quant_table (j_common_ptr cinfo)
{
  ...
  tbl = (JQUANT_TBL *)
    (*cinfo->mem->alloc_small) (cinfo, 0, ((size_t) sizeof(JQUANT_TBL)));
  tbl->sent_table = 0;
  return tbl;
}
...
jpeg_alloc_huff_table (j_common_ptr cinfo)
{
  ...
  tbl = (JHUFF_TBL *)
    (*cinfo->mem->alloc_small) (cinfo, 0, ((size_t) sizeof(JHUFF_TBL)));
  tbl->sent_table = 0;
  return tbl;
}
