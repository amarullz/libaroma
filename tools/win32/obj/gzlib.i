...
# 1 "../../../libs/zlib/src/gzguts.h" 1
# 21 "../../../libs/zlib/src/gzguts.h"
...
# 26 "../../../libs/zlib/src/gzguts.h" 2
# 1 "d:\\devtools\\linaro\\lib\\gcc\\arm-linux-gnueabihf\\4.8.3\\include-fixed\\limits.h" 1 3 4
# 27 "../../../libs/zlib/src/gzguts.h" 2
...
# 29 "../../../libs/zlib/src/gzguts.h" 2
# 123 "../../../libs/zlib/src/gzguts.h"
...
# 124 "../../../libs/zlib/src/gzguts.h" 2
# 132 "../../../libs/zlib/src/gzguts.h"
...
off_t gzseek64(file, offset, whence)
    gzFile file;
    off_t offset;
    int whence;
{
    ...
    if (state->mode == 7247 && state->how == 1 &&
        ...
        ret = lseek(state->fd, offset - state->x.have, 1);
        if (ret == -1)
            return -1;
        state->x.have = 0;
        state->eof = 0;
    ...
    if (state->mode == 7247) {
        n = (sizeof(int) == sizeof(off_t) && (state->x.have) > 2147483647) || (off_t)state->x.have > offset ?
