...
# 32 "../../../libs/freetype/src/base/ftglyph.c" 2
...
# 33 "../../../libs/freetype/src/base/ftglyph.c" 2
...
# 35 "../../../libs/freetype/src/base/ftglyph.c" 2
...
# 36 "../../../libs/freetype/src/base/ftglyph.c" 2
...
# 37 "../../../libs/freetype/src/base/ftglyph.c" 2
...
# 38 "../../../libs/freetype/src/base/ftglyph.c" 2

# 1 "../../../libs/freetype/src/base/basepic.h" 1
# 40 "../../../libs/freetype/src/base/ftglyph.c" 2
# 59 "../../../libs/freetype/src/base/ftglyph.c"
  static FT_Error
  ...
  const FT_Glyph_Class ft_bitmap_glyph_class = { sizeof ( FT_BitmapGlyphRec ), FT_GLYPH_FORMAT_BITMAP, ft_bitmap_glyph_init, ft_bitmap_glyph_done, ft_bitmap_glyph_copy, 0, ft_bitmap_glyph_bbox, 0 };
# 157 "../../../libs/freetype/src/base/ftglyph.c"
  static FT_Error
                            ...
                            FT_GlyphSlot slot )
  {
    ...
    slot->outline.flags &= ~0x1;

    return FT_Err_Ok;
  }


  const FT_Glyph_Class ft_outline_glyph_class = { sizeof ( FT_OutlineGlyphRec ), FT_GLYPH_FORMAT_OUTLINE, ft_outline_glyph_init, ft_outline_glyph_done, ft_outline_glyph_copy, ft_outline_glyph_transform, ft_outline_glyph_bbox, ft_outline_glyph_prepare };
# 284 "../../../libs/freetype/src/base/ftglyph.c"
   static FT_Error
                 ...
                 FT_Glyph* aglyph )
   {
     ...
     *aglyph = ((void *)0);
     ...
     if ( !( ((glyph) = (ft_mem_alloc( memory, (FT_Long)(clazz->glyph_size), &error ))), error != 0 ) )
     {
                ...
                FT_Glyph *aglyph )
  {
    ...
    const FT_Glyph_Class* clazz = ((void *)0);
                     ...
                     FT_BBox *acbox )
  {
    ...
    {
      acbox->xMin = ( (acbox->xMin) & ~(__typeof__ (acbox->xMin))63 );
      acbox->yMin = ( (acbox->yMin) & ~(__typeof__ (acbox->yMin))63 );
      acbox->xMax = ( ((acbox->xMax) + 63) & ~(__typeof__ ((acbox->xMax) + 63))63 );
      acbox->yMax = ( ((acbox->yMax) + 63) & ~(__typeof__ ((acbox->yMax) + 63))63 );
    }
                      ...
                      FT_Bool destroy )
  {
    ...
    memset( &dummy_internal, 0, (FT_Offset)(sizeof ( dummy_internal )) );
  ...
  FT_Done_Glyph( FT_Glyph glyph )
  {
    if ( glyph )
    {
      ...
      do { ft_mem_free( memory, (glyph) ); (glyph) = ((void *)0); } while ( 0 );
    }
  }
