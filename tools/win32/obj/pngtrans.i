...
png_set_bgr(png_structrp png_ptr)
{
   ...
   png_ptr->transformations |= 0x0001;
}
...
png_set_swap(png_structrp png_ptr)
{
   ...
   if (png_ptr->bit_depth == 16)
      png_ptr->transformations |= 0x0010;
}
...
png_set_packing(png_structrp png_ptr)
{
   ...
   {
      png_ptr->transformations |= 0x0004;
...
png_set_packswap(png_structrp png_ptr)
{
   ...
   if (png_ptr->bit_depth < 8)
      png_ptr->transformations |= 0x10000;
}
...
png_set_add_alpha(png_structrp png_ptr, png_uint_32 filler, int filler_loc)
{
   ...
   if (png_ptr->transformations & 0x8000)
      png_ptr->transformations |= 0x1000000;
}
...
png_set_swap_alpha(png_structrp png_ptr)
{
   ...
   png_ptr->transformations |= 0x20000;
}
...
png_set_invert_alpha(png_structrp png_ptr)
{
   ...
   png_ptr->transformations |= 0x80000;
}
...
png_set_invert_mono(png_structrp png_ptr)
{
   ...
   png_ptr->transformations |= 0x0020;
}
