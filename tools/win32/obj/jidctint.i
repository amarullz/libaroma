...
# 31 "../../../libs/jpeg/jidctint.c" 2
# 1 "../../../libs/jpeg/jdct.h" 1
# 33 "../../../libs/jpeg/jdct.h"
typedef int DCTELEM;
...
extern void jpeg_idct_1x1
    (j_decompress_ptr cinfo, jpeg_component_info * compptr, JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
                                                                     ;
# 32 "../../../libs/jpeg/jidctint.c" 2
# 147 "../../../libs/jpeg/jidctint.c"
void
...
# 288 "../../../libs/jpeg/jidctint.c"
 ...
 wsptr[5] == 0 && wsptr[6] == 0 && wsptr[7] == 0) {
    ...
    outptr[0] = range_limit[(int) (((tmp10 + tmp3) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[7] = range_limit[(int) (((tmp10 - tmp3) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[1] = range_limit[(int) (((tmp11 + tmp2) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[6] = range_limit[(int) (((tmp11 - tmp2) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[2] = range_limit[(int) (((tmp12 + tmp1) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[5] = range_limit[(int) (((tmp12 - tmp1) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[3] = range_limit[(int) (((tmp13 + tmp0) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))

       & (255 * 4 + 3)];
    outptr[4] = range_limit[(int) (((tmp13 - tmp0) + (((INT32) 1) << ((13 +2 +3)-1))) >> (13 +2 +3))
