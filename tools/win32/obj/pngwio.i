...
# 22 "../../../libs/png/pngwio.c" 2
# 32 "../../../libs/png/pngwio.c"
void
png_write_data(png_structrp png_ptr, png_const_bytep data, png_size_t length)
{

   if (png_ptr->write_data_fn != ((void *)0) )
      (*(png_ptr->write_data_fn))(png_ptr, ((png_bytep)(data)),
         length);
    ...
    png_rw_ptr write_data_fn, png_flush_ptr output_flush_fn)
{
   ...
   if (output_flush_fn != ((void *)0))
      png_ptr->output_flush_fn = output_flush_fn;

   else
      png_ptr->output_flush_fn = png_default_flush;
# 158 "../../../libs/png/pngwio.c"
   if (png_ptr->read_data_fn != ((void *)0))
   {
      png_ptr->read_data_fn = ((void *)0);
