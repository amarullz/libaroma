...
# 51 "../../../libs/jpeg/jcsample.c" 2



typedef void (*downsample1_ptr) (j_compress_ptr cinfo, jpeg_component_info * compptr, JSAMPARRAY input_data, JSAMPARRAY output_data)
       ...
       JSAMPARRAY input_data, JSAMPARRAY output_data)
{
  ...
  expand_right_edge(output_data, cinfo->max_v_samp_factor,
      cinfo->image_width, compptr->width_in_blocks * 8);
}
# 211 "../../../libs/jpeg/jcsample.c"
static void
   ...
   JSAMPARRAY input_data, JSAMPARRAY output_data)
{
  ...
  for (outrow = 0; outrow < compptr->v_samp_factor; outrow++) {
    ...
    for (outcol = 0; outcol < output_cols; outcol++) {
      *outptr++ = (JSAMPLE) ((((int) (*inptr)) + ((int) (inptr[1]))
         + bias) >> 1);
      bias ^= 1;
      inptr += 2;
    }
   ...
   JSAMPARRAY input_data, JSAMPARRAY output_data)
{
  ...
  for (outrow = 0; outrow < compptr->v_samp_factor; outrow++) {
    ...
    bias = 1;
    for (outcol = 0; outcol < output_cols; outcol++) {
      *outptr++ = (JSAMPLE) ((((int) (*inptr0)) + ((int) (inptr0[1])) +
...
# 321 "../../../libs/jpeg/jcsample.c"
  ...
  for (outrow = 0; outrow < compptr->v_samp_factor; outrow++) {
    ...
    membersum = ((int) (*inptr0)) + ((int) (inptr0[1])) +
  ((int) (*inptr1)) + ((int) (inptr1[1]));
    neighsum = ((int) (*above_ptr)) + ((int) (above_ptr[1])) +
        ((int) (*below_ptr)) + ((int) (below_ptr[1])) +
        ((int) (*inptr0)) + ((int) (inptr0[2])) +
        ((int) (*inptr1)) + ((int) (inptr1[2]));
    neighsum += neighsum;
    neighsum += ((int) (*above_ptr)) + ((int) (above_ptr[2])) +
  ((int) (*below_ptr)) + ((int) (below_ptr[2]));
   ...
   ((int) (inptr1[-1])) + ((int) (inptr1[2]));
      ...
      neighsum += ((int) (above_ptr[-1])) + ((int) (above_ptr[2])) +
  ...
  ((int) (*inptr1)) + ((int) (inptr1[1]));
    ...
    neighsum += neighsum;
    neighsum += ((int) (above_ptr[-1])) + ((int) (above_ptr[1])) +
       ...
       JSAMPARRAY input_data, JSAMPARRAY output_data)
{
  ...
  for (outrow = 0; outrow < compptr->v_samp_factor; outrow++) {
    ...
    colsum = ((int) (*above_ptr++)) + ((int) (*below_ptr++)) +
      ((int) (*inptr));
    membersum = ((int) (*inptr++));
    nextcolsum = ((int) (*above_ptr)) + ((int) (*below_ptr)) +
   ((int) (*inptr));
