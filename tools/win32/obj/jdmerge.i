...
# 38 "../../../libs/jpeg/jdmerge.c" 2
# 51 "../../../libs/jpeg/jdmerge.c"
              ...
              JSAMPARRAY output_buf)
{
  ...
  for (col = cinfo->output_width >> 1; col > 0; col--) {
    ...
    do { ((INT16*)(outptr))[0] = (rgb); ((INT16*)(outptr))[1] = (rgb)>>16; } while(0);
    outptr += 4;
  }
              ...
              JSAMPARRAY output_buf)
{
  ...
  for (col = cinfo->output_width >> 1; col > 0; col--) {
    ...
    y = ((int) (*inptr0++));
    r = range_limit[((y + cred) + ((d0)&0xFF))];
    g = range_limit[((y + cgreen) + (((d0)&0xFF)>>1))];
    b = range_limit[((y + cblue) + ((d0)&0xFF))];
              ...
              JSAMPARRAY output_buf)
{
  ...
  for (col = cinfo->output_width >> 1; col > 0; col--) {
    ...
    b = range_limit[y + cblue];
    rgb = ((((((r)<<8)&0xf800)|(((g)<<3)&0x7E0)|((b)>>3))<<16) | rgb);
    do { ((INT16*)(outptr0))[0] = (rgb); ((INT16*)(outptr0))[1] = (rgb)>>16; } while(0);
    outptr0 += 4;
    y = ((int) (*inptr01++));
    r = range_limit[y + cred];
    g = range_limit[y + cgreen];
    ...
    b = range_limit[y + cblue];
    rgb = ((((((r)<<8)&0xf800)|(((g)<<3)&0x7E0)|((b)>>3))<<16) | rgb);
    do { ((INT16*)(outptr1))[0] = (rgb); ((INT16*)(outptr1))[1] = (rgb)>>16; } while(0);
    outptr1 += 4;
  }
              ...
              JSAMPARRAY output_buf)
{
  ...
  JDIMENSION col_index = 0;
  INT32 d0 = dither_matrix[cinfo->output_scanline & 0x3];
  INT32 d1 = dither_matrix[(cinfo->output_scanline+1) & 0x3];
  unsigned int r, g, b;
  INT32 rgb;
  ...
  for (col = cinfo->output_width >> 1; col > 0; col--) {
    ...
    rgb = ((((r)<<8)&0xf800)|(((g)<<3)&0x7E0)|((b)>>3));
    y = ((int) (*inptr00++));
    r = range_limit[((y + cred) + ((d1)&0xFF))];
    g = range_limit[((y + cgreen) + (((d1)&0xFF)>>1))];
    b = range_limit[((y + cblue) + ((d1)&0xFF))];
    d1 = (((d1)<<24) | (((d1)>>8)&0x00FFFFFF));
    rgb = ((((((r)<<8)&0xf800)|(((g)<<3)&0x7E0)|((b)>>3))<<16) | rgb);
    do { ((INT16*)(outptr0))[0] = (rgb); ((INT16*)(outptr0))[1] = (rgb)>>16; } while(0);
    outptr0 += 4;
    y = ((int) (*inptr01++));
...
jinit_merged_upsampler (j_decompress_ptr cinfo)
{
  ...
  (size_t) (upsample->out_row_width * ((size_t) sizeof(JSAMPLE))));
  } else {
