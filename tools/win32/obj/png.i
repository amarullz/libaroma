...
__attribute__((__malloc__)) voidpf png_zalloc (voidpf png_ptr, uInt items, uInt size)
...
png_user_version_check(png_structrp png_ptr, png_const_charp user_png_ver)
{
   ...
   if (png_ptr->flags & 0x20000)
   {
      ...
      if (user_png_ver == ((void *)0) || user_png_ver[0] != png_get_header_ver(((void *)0))[0] ||
          ...
          user_png_ver[3] != png_get_header_ver(((void *)0))[3])) ||
          (user_png_ver[0] == '0' && user_png_ver[2] < '9'))
      {
         ...
         pos = png_safecat(m, (sizeof m), pos, png_get_header_ver(((void *)0)));
         (void)pos;
...
__attribute__((__malloc__)) png_structp png_create_png_struct (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn, png_error_ptr warn_fn, png_voidp mem_ptr, png_malloc_ptr malloc_fn, png_free_ptr free_fn)
...

{
   ...
   memset(&create_struct, 0, (sizeof create_struct));
      ...
      create_struct.user_width_max = 0x7fffffff;
      create_struct.user_height_max = 0x7fffffff;



         create_struct.user_chunk_cache_max = 0;
         ...
         create_struct.user_chunk_malloc_max = 0;
...
__attribute__((__malloc__)) png_infop png_create_info_struct (png_const_structrp png_ptr)
   ...
   int num)
{
   ...
   if ((mask & 0x0080) & info_ptr->free_me)
   {
      ...
      info_ptr->pcal_purpose = ((void *)0);
      info_ptr->pcal_units = ((void *)0);
      if (info_ptr->pcal_params != ((void *)0))
         {
            ...
            for (i = 0; i < info_ptr->pcal_nparams; i++)
            {
               ...
               info_ptr->pcal_params[i] = ((void *)0);
            }
            png_free(png_ptr, info_ptr->pcal_params);
            info_ptr->pcal_params = ((void *)0);
         }
   ...
   if ((mask & 0x0010) & info_ptr->free_me)
   {
      ...
      info_ptr->iccp_name = ((void *)0);
      info_ptr->iccp_profile = ((void *)0);
   ...
   if ((mask & 0x0020) & info_ptr->free_me)
   {
      if (num != -1)
      {
         if (info_ptr->splt_palettes)
         {
            ...
            info_ptr->splt_palettes[num].name = ((void *)0);
            info_ptr->splt_palettes[num].entries = ((void *)0);
         }
      }
      ...
      else
      {
         if (info_ptr->splt_palettes_num)
         {
            ...
            for (i = 0; i < info_ptr->splt_palettes_num; i++)
               png_free_data(png_ptr, info_ptr, 0x0020, (int)i);

            png_free(png_ptr, info_ptr->splt_palettes);
            info_ptr->splt_palettes = ((void *)0);
   ...
   if ((mask & 0x0200) & info_ptr->free_me)
   {
      if (num != -1)
      {
          if (info_ptr->unknown_chunks)
          {
             ...
             info_ptr->unknown_chunks[num].data = ((void *)0);
          }
      }
      ...
      else
      {
         ...
         if (info_ptr->unknown_chunks_num)
         {
            for (i = 0; i < info_ptr->unknown_chunks_num; i++)
               png_free_data(png_ptr, info_ptr, 0x0200, (int)i);

            png_free(png_ptr, info_ptr->unknown_chunks);
            info_ptr->unknown_chunks = ((void *)0);
   ...
   if ((mask & 0x0040) & info_ptr->free_me)
   {
      if (info_ptr->row_pointers)
      {
         ...
         for (row = 0; row < info_ptr->height; row++)
         {
            ...
            info_ptr->row_pointers[row] = ((void *)0);
         }
         png_free(png_ptr, info_ptr->row_pointers);
         info_ptr->row_pointers = ((void *)0);
      }
...
png_convert_to_rfc1123_buffer(char out[29], png_const_timep ptime)
{
...

   {
      ...
      pos = png_safecat(out, 29, pos, (png_format_number(number_buf, number_buf + (sizeof number_buf), 1, ((unsigned)ptime->day))));
      if (pos < 28) out[pos++] = (' ');
      pos = png_safecat(out, 29, pos, (short_months[(ptime->month - 1)]));
      if (pos < 28) out[pos++] = (' ');
      pos = png_safecat(out, 29, pos, (png_format_number(number_buf, number_buf + (sizeof number_buf), 1, (ptime->year))));
      if (pos < 28) out[pos++] = (' ');
      pos = png_safecat(out, 29, pos, (png_format_number(number_buf, number_buf + (sizeof number_buf), 2, ((unsigned)ptime->hour))));
      if (pos < 28) out[pos++] = (':');
      pos = png_safecat(out, 29, pos, (png_format_number(number_buf, number_buf + (sizeof number_buf), 2, ((unsigned)ptime->minute))));
      if (pos < 28) out[pos++] = (':');
      pos = png_safecat(out, 29, pos, (png_format_number(number_buf, number_buf + (sizeof number_buf), 2, ((unsigned)ptime->second))));
      pos = png_safecat(out, 29, pos, (" +0000"));
...
png_handle_as_unknown(png_const_structrp png_ptr, png_const_bytep chunk_name)
{
   ...
   if (png_ptr == ((void *)0) || chunk_name == ((void *)0) || png_ptr->num_chunk_list == 0)
      return 0;
...
png_chunk_unknown_handling(png_const_structrp png_ptr, png_uint_32 chunk_name)
{
   ...
   (void)((void)(((char*)(chunk_string))[0]=(char)((chunk_name)>>24), ((char*)(chunk_string))[1]=(char)((chunk_name)>>16), ((char*)(chunk_string))[2]=(char)((chunk_name)>>8), ((char*)(chunk_string))[3]=(char)((chunk_name))), ((char*)(chunk_string))[4] = 0);
...
# 1045 "../../../libs/png/png.c"
{
   ...
   if ((colorspace->flags & 0x0001) != 0 &&
      (!png_muldiv(&gtest, colorspace->gamma, 100000, gAMA) ||
      png_gamma_significant(gtest)))
   {
      ...
      if ((colorspace->flags & 0x0020) != 0 || from == 2)
      {
...
# 1092 "../../../libs/png/png.c"
   ...
   if (gAMA < 16 || gAMA > 625000000)
      ...
      else if ((png_ptr->mode & 0x8000) != 0 &&
         (colorspace->flags & 0x0008) != 0)
         errmsg = "duplicate";



   else if (colorspace->flags & 0x8000)
      return;

   else
   {
      if (png_colorspace_check_gamma(png_ptr, colorspace, gAMA, 1 ))
      {
...
{
   if (info_ptr->colorspace.flags & 0x8000)
   {

      info_ptr->valid &= ~(0x0001|0x0004|0x0800|
         0x1000);



         png_free_data(png_ptr, info_ptr, 0x0010, -1 );
   ...
   else
   {
         ...
         if (info_ptr->colorspace.flags & 0x0080)
            info_ptr->valid |= 0x0800;

         else
            info_ptr->valid &= ~0x0800;

         if (info_ptr->colorspace.flags & 0x0002)
            info_ptr->valid |= 0x0004;

         else
            info_ptr->valid &= ~0x0004;


      if (info_ptr->colorspace.flags & 0x0001)
         info_ptr->valid |= 0x0001;
...
png_xy_from_XYZ(png_xy *xy, const png_XYZ *XYZ)
{
   ...
   if (!png_muldiv(&xy->redx, XYZ->red_X, 100000, d)) return 1;
   if (!png_muldiv(&xy->redy, XYZ->red_Y, 100000, d)) return 1;
   dwhite = d;
   whiteX = XYZ->red_X;
   whiteY = XYZ->red_Y;

   d = XYZ->green_X + XYZ->green_Y + XYZ->green_Z;
   if (!png_muldiv(&xy->greenx, XYZ->green_X, 100000, d)) return 1;
   if (!png_muldiv(&xy->greeny, XYZ->green_Y, 100000, d)) return 1;
   dwhite += d;
   whiteX += XYZ->green_X;
   whiteY += XYZ->green_Y;

   d = XYZ->blue_X + XYZ->blue_Y + XYZ->blue_Z;
   if (!png_muldiv(&xy->bluex, XYZ->blue_X, 100000, d)) return 1;
   if (!png_muldiv(&xy->bluey, XYZ->blue_Y, 100000, d)) return 1;
   dwhite += d;
   whiteX += XYZ->blue_X;
   whiteY += XYZ->blue_Y;
   ...
   if (!png_muldiv(&xy->whitex, whiteX, 100000, dwhite)) return 1;
   if (!png_muldiv(&xy->whitey, whiteY, 100000, dwhite)) return 1;
...
png_XYZ_from_xy(png_XYZ *XYZ, const png_xy *xy)
{
   ...
   if (xy->redx < 0 || xy->redx > 100000) return 1;
   if (xy->redy < 0 || xy->redy > 100000 -xy->redx) return 1;
   if (xy->greenx < 0 || xy->greenx > 100000) return 1;
   if (xy->greeny < 0 || xy->greeny > 100000 -xy->greenx) return 1;
   if (xy->bluex < 0 || xy->bluex > 100000) return 1;
   if (xy->bluey < 0 || xy->bluey > 100000 -xy->bluex) return 1;
   if (xy->whitex < 0 || xy->whitex > 100000) return 1;
   if (xy->whitey < 0 || xy->whitey > 100000 -xy->whitex) return 1;
# 1428 "../../../libs/png/png.c"
   ...
   if (!png_muldiv(&XYZ->red_X, xy->redx, 100000, red_inverse)) return 1;
   if (!png_muldiv(&XYZ->red_Y, xy->redy, 100000, red_inverse)) return 1;
   if (!png_muldiv(&XYZ->red_Z, 100000 - xy->redx - xy->redy, 100000,
      red_inverse))
      return 1;

   if (!png_muldiv(&XYZ->green_X, xy->greenx, 100000, green_inverse))
      return 1;
   if (!png_muldiv(&XYZ->green_Y, xy->greeny, 100000, green_inverse))
      return 1;
   if (!png_muldiv(&XYZ->green_Z, 100000 - xy->greenx - xy->greeny, 100000,
      green_inverse))
      return 1;

   if (!png_muldiv(&XYZ->blue_X, xy->bluex, blue_scale, 100000)) return 1;
   if (!png_muldiv(&XYZ->blue_Y, xy->bluey, blue_scale, 100000)) return 1;
   if (!png_muldiv(&XYZ->blue_Z, 100000 - xy->bluex - xy->bluey, blue_scale,
      100000))
      return 1;
...
png_XYZ_normalize(png_XYZ *XYZ)
{
   ...
   if (Y != 100000)
   {
      if (!png_muldiv(&XYZ->red_X, XYZ->red_X, 100000, Y)) return 1;
      if (!png_muldiv(&XYZ->red_Y, XYZ->red_Y, 100000, Y)) return 1;
      if (!png_muldiv(&XYZ->red_Z, XYZ->red_Z, 100000, Y)) return 1;

      if (!png_muldiv(&XYZ->green_X, XYZ->green_X, 100000, Y)) return 1;
      if (!png_muldiv(&XYZ->green_Y, XYZ->green_Y, 100000, Y)) return 1;
      if (!png_muldiv(&XYZ->green_Z, XYZ->green_Z, 100000, Y)) return 1;

      if (!png_muldiv(&XYZ->blue_X, XYZ->blue_X, 100000, Y)) return 1;
      if (!png_muldiv(&XYZ->blue_Y, XYZ->blue_Y, 100000, Y)) return 1;
      if (!png_muldiv(&XYZ->blue_Z, XYZ->blue_Z, 100000, Y)) return 1;
   }
...
png_colorspace_endpoints_match(const png_xy *xy1, const png_xy *xy2, int delta)
{
   ...
   return !(( (xy1->whitex) < (xy2->whitex)-(delta) || (xy1->whitex) > (xy2->whitex)+(delta) ) ||
      ( (xy1->whitey) < (xy2->whitey)-(delta) || (xy1->whitey) > (xy2->whitey)+(delta) ) ||
      ( (xy1->redx) < (xy2->redx)-(delta) || (xy1->redx) > (xy2->redx)+(delta) ) ||
      ( (xy1->redy) < (xy2->redy)-(delta) || (xy1->redy) > (xy2->redy)+(delta) ) ||
      ( (xy1->greenx) < (xy2->greenx)-(delta) || (xy1->greenx) > (xy2->greenx)+(delta) ) ||
      ( (xy1->greeny) < (xy2->greeny)-(delta) || (xy1->greeny) > (xy2->greeny)+(delta) ) ||
      ( (xy1->bluex) < (xy2->bluex)-(delta) || (xy1->bluex) > (xy2->bluex)+(delta) ) ||
      ( (xy1->bluey) < (xy2->bluey)-(delta) || (xy1->bluey) > (xy2->bluey)+(delta) ));
}
# 1553 "../../../libs/png/png.c"
static int
   ...
   int preferred)
{
   ...
   if (preferred < 2 && (colorspace->flags & 0x0002))
   {
   ...
   colorspace->flags |= 0x0002;




   if (png_colorspace_endpoints_match(xy, &sRGB_xy, 1000))
      colorspace->flags |= 0x0040;

   else
      colorspace->flags &= (0xffff ^ (0x0040))
                                             ;
...
# 1840 "../../../libs/png/png.c"
   ...
   if ((colorspace->flags & 0x0004) != 0 &&
      colorspace->rendering_intent != intent)
      return png_icc_profile_error(png_ptr, colorspace, "sRGB",
         (unsigned)intent, "inconsistent rendering intents");

   if ((colorspace->flags & 0x0020) != 0)
   {
   ...
   (void)png_colorspace_check_gamma(png_ptr, colorspace, 45455,
      2 );


   colorspace->rendering_intent = (png_uint_16)intent;
   colorspace->flags |= 0x0004;
...
{
   png_uint_32 tag_count = (((png_uint_32)(*(profile+128)) << 24) + ((png_uint_32)(*((profile+128) + 1)) << 16) + ((png_uint_32)(*((profile+128) + 2)) << 8) + ((png_uint_32)(*((profile+128) + 3))));
   png_uint_32 itag;
   ...
   {
      png_uint_32 tag_id = (((png_uint_32)(*(tag+0)) << 24) + ((png_uint_32)(*((tag+0) + 1)) << 16) + ((png_uint_32)(*((tag+0) + 2)) << 8) + ((png_uint_32)(*((tag+0) + 3))));
      png_uint_32 tag_start = (((png_uint_32)(*(tag+4)) << 24) + ((png_uint_32)(*((tag+4) + 1)) << 16) + ((png_uint_32)(*((tag+4) + 2)) << 8) + ((png_uint_32)(*((tag+4) + 3))));
      png_uint_32 tag_length = (((png_uint_32)(*(tag+8)) << 24) + ((png_uint_32)(*((tag+8) + 1)) << 16) + ((png_uint_32)(*((tag+8) + 2)) << 8) + ((png_uint_32)(*((tag+8) + 3))));
...
} png_sRGB_checks[] =
{
   ...
   { 0x0a3fd9f6, 0x3b8772b9, 3048, { 0x29f83dde, 0xaff255ae, 0x7842fae4, 0xca83390d }, (0x29f83dde!=0)||(0xaff255ae!=0)||(0x7842fae4!=0)||(0xca83390d!=0), 0, 0 },




   { 0x4909e5e1, 0x427ebb21, 3052, { 0xc95bd637, 0xe95d8a3b, 0x0df38f99, 0xc1320389 }, (0xc95bd637!=0)||(0xe95d8a3b!=0)||(0x0df38f99!=0)||(0xc1320389!=0), 0, 1 },



   { 0xfd2144a1, 0x306fd8ae, 60988, { 0xfc663378, 0x37e2886b, 0xfd72e983, 0x8228f1b8 }, (0xfc663378!=0)||(0x37e2886b!=0)||(0xfd72e983!=0)||(0x8228f1b8!=0), 0, 0 },




   { 0x209c35d2, 0xbbef7812, 60960, { 0x34562abf, 0x994ccd06, 0x6d2c5721, 0xd0d68c5d }, (0x34562abf!=0)||(0x994ccd06!=0)||(0x6d2c5721!=0)||(0xd0d68c5d!=0), 0, 0 },
# 2182 "../../../libs/png/png.c"
   { 0xa054d762, 0x5d5129ce, 3024, { 0x00000000, 0x00000000, 0x00000000, 0x00000000 }, (0x00000000!=0)||(0x00000000!=0)||(0x00000000!=0)||(0x00000000!=0), 0, 1 },
# 2193 "../../../libs/png/png.c"
   { 0xf784f3fb, 0x182ea552, 3144, { 0x00000000, 0x00000000, 0x00000000, 0x00000000 }, (0x00000000!=0)||(0x00000000!=0)||(0x00000000!=0)||(0x00000000!=0), 1, 0 },



   { 0x0398f3fc, 0xf29e526d, 3144, { 0x00000000, 0x00000000, 0x00000000, 0x00000000 }, (0x00000000!=0)||(0x00000000!=0)||(0x00000000!=0)||(0x00000000!=0), 1, 1 },
   ...
   png_const_bytep profile, uLong adler)
{
   ...
   for (i=0; i < (sizeof png_sRGB_checks) / (sizeof png_sRGB_checks[0]); ++i)
   {
      if ((((png_uint_32)(*(profile+84)) << 24) + ((png_uint_32)(*((profile+84) + 1)) << 16) + ((png_uint_32)(*((profile+84) + 2)) << 8) + ((png_uint_32)(*((profile+84) + 3)))) == png_sRGB_checks[i].md5[0] &&
         (((png_uint_32)(*(profile+88)) << 24) + ((png_uint_32)(*((profile+88) + 1)) << 16) + ((png_uint_32)(*((profile+88) + 2)) << 8) + ((png_uint_32)(*((profile+88) + 3)))) == png_sRGB_checks[i].md5[1] &&
         (((png_uint_32)(*(profile+92)) << 24) + ((png_uint_32)(*((profile+92) + 1)) << 16) + ((png_uint_32)(*((profile+92) + 2)) << 8) + ((png_uint_32)(*((profile+92) + 3)))) == png_sRGB_checks[i].md5[2] &&
         (((png_uint_32)(*(profile+96)) << 24) + ((png_uint_32)(*((profile+96) + 1)) << 16) + ((png_uint_32)(*((profile+96) + 2)) << 8) + ((png_uint_32)(*((profile+96) + 3)))) == png_sRGB_checks[i].md5[3])
      {
# 2237 "../../../libs/png/png.c"
         if (length == 0)
         {
   ...
   png_colorspacerp colorspace, png_const_bytep profile, uLong adler)
{
   ...
   if (png_compare_ICC_profile_with_sRGB(png_ptr, profile, adler))
      (void)png_colorspace_set_sRGB(png_ptr, colorspace,
         (int) (((png_uint_32)(*(profile+64)) << 24) + ((png_uint_32)(*((profile+64) + 1)) << 16) + ((png_uint_32)(*((profile+64) + 2)) << 8) + ((png_uint_32)(*((profile+64) + 3)))));
}
...
png_colorspace_set_rgb_coefficients(png_structrp png_ptr)
{
   ...
   if (!png_ptr->rgb_to_gray_coefficients_set &&
      (png_ptr->colorspace.flags & 0x0002) != 0)
   {
   ...
   int filter_type)
{
   ...
   if (((color_type == (2 | 1)) && bit_depth > 8) ||
       ((color_type == (2) ||
         color_type == (4) ||
         color_type == (2 | 4)) && bit_depth < 8))
   {
   ...
   png_size_tp whereami)
{
   ...
   while (i < size)
   {
      ...
      switch (string[i])
      {
      case 43: type = 4; break;
      case 45: type = 4 + 128; break;
      case 46: type = 16; break;
      case 48: type = 8; break;
      case 49: case 50: case 51: case 52:
      case 53: case 54: case 55: case 56:
      case 57: type = 8 + 256; break;
      case 69:
      case 101: type = 32; break;
    ...
    double fp, unsigned int precision)
{
   ...
   if (size >= precision+5)
   {
      ...
      if (fp >= ((double)2.2250738585072014e-308L) && fp <= ((double)1.7976931348623157e+308L))
      {
         int exp_b10;
         double base;
# 2791 "../../../libs/png/png.c"
         ...
         while (base < ((double)2.2250738585072014e-308L) || base < fp)
         {

            double test = png_pow10(exp_b10+1);

            if (test <= ((double)1.7976931348623157e+308L))
               ++exp_b10, base = test;
...
# 2817 "../../../libs/png/png.c"
...

         {
            ...
            while (cdigits+czero-clead < (int)precision && fp > ((double)2.2250738585072014e-308L));
# 2973 "../../../libs/png/png.c"
      ...
      else if (!(fp >= ((double)2.2250738585072014e-308L)))
      {
         *ascii++ = 48;
         *ascii = 0;
         return;
...
{
   return gamma_val < 100000 - 5000 ||
       gamma_val > 100000 + 5000;
}
...
png_destroy_gamma_table(png_structrp png_ptr)
{
   ...
   png_ptr->gamma_from_1 = ((void *)0);
   png_free(png_ptr, png_ptr->gamma_to_1);
   png_ptr->gamma_to_1 = ((void *)0);
   ...
   png_ptr->gamma_16_from_1 = ((void *)0);
   }
...
png_build_gamma_table(png_structrp png_ptr, int bit_depth)
{
  ...
  if (bit_depth <= 8)
  {
     ...
     if (png_ptr->transformations & (0x0080 | 0x600000))
     {
...
{
   if (png_ptr != ((void *)0) && option >= 0 && option < 4 &&
      (option & 1) == 0)
   {
      int mask = 3 << option;
...
png_image_free_function(png_voidp argument)
{
   ...
   else
   {
         ...
         png_destroy_read_struct(&c.png_ptr, &c.info_ptr, ((void *)0));
...
png_image_free(png_imagep image)
{
   ...
   if (image != ((void *)0) && image->opaque != ((void *)0) &&
      image->opaque->error_buf == ((void *)0))
   {
