   ...
   info_ptr)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0080))
      {
         ((void)0)
                                          ;
    ...
    png_const_inforp info_ptr)
{
       ...
       && info_ptr->y_pixels_per_unit <= ((png_uint_32)0x7fffffffL))
   {
      ...
      if (png_muldiv(&res, (png_int_32)info_ptr->y_pixels_per_unit, 100000,
...
png_get_x_offset_microns(png_const_structrp png_ptr, png_const_inforp info_ptr)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0100))
   {
      ((void)0);
...
{
# 308 "../../../libs/png/pngget.c"
   png_fixed_point result;
   if (ppm <= ((png_uint_32)0x7fffffffL) && png_muldiv(&result, (png_int_32)ppm, 127,
       5000))
      return result;
...
{
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0020)
       && background != ((void *)0))
   {
      ((void)0);
    ...
    double *green_x, double *green_y, double *blue_x, double *blue_y)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) &&
      (info_ptr->colorspace.flags & 0x0002))
   {
      ((void)0);
    ...
    png_fixed_point *file_gamma)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) &&
      (info_ptr->colorspace.flags & 0x0001) &&
      file_gamma != ((void *)0))
   {
    ...
    int *file_srgb_intent)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0800)
       && file_srgb_intent != ((void *)0))
   {
    ...
    png_bytepp profile, png_uint_32 *proflen)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x1000)
       && name != ((void *)0) && compression_type != ((void *)0) && profile != ((void *)0) &&
   proflen != ((void *)0))
   {
    ...
    png_uint_16p *hist)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0040)
       && hist != ((void *)0))
   {
      *hist = info_ptr->hist;
      return (0x0040);
    ...
    int *filter_type)
{
   ...
   if (png_ptr == ((void *)0) || info_ptr == ((void *)0) || width == ((void *)0) ||
       height == ((void *)0) || bit_depth == ((void *)0) || color_type == ((void *)0))
      return (0);
    ...
    png_charp *units, png_charpp *params)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0400)
    ...
    png_colorp *palette, int *num_palette)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0008)
       && palette != ((void *)0))
   {
    ...
    png_color_8p *sig_bit)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0002)
       && sig_bit != ((void *)0))
   {
    ...
    png_timep *mod_time)
{
   ...
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0200)
       && mod_time != ((void *)0))
   {
...
{
   png_uint_32 retval = 0;
   if (png_ptr != ((void *)0) && info_ptr != ((void *)0) && (info_ptr->valid & 0x0010))
   {
      ((void)0);
