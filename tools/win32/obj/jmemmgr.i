...
# 32 "../../../libs/jpeg/jmemmgr.c" 2
# 89 "../../../libs/jpeg/jmemmgr.c"
...

{
  ...
  result = (JBLOCKARRAY) alloc_small(cinfo, pool_id,
         (size_t) (numrows * ((size_t) sizeof(JBLOCKROW))));
...
# 522 "../../../libs/jpeg/jmemmgr.c"
static jvirt_sarray_ptr
...

{
  ...
  result = (jvirt_sarray_ptr) alloc_small(cinfo, pool_id,
       ((size_t) sizeof(struct jvirt_sarray_control)));
...

{
  ...
  result = (jvirt_barray_ptr) alloc_small(cinfo, pool_id,
       ((size_t) sizeof(struct jvirt_barray_control)));
...

{
 ...
 sptr->b_s_open = 1;
      ...
      sptr->mem_buffer = alloc_sarray(cinfo, 1,
 ...
 bptr->b_s_open = 1;
      ...
      bptr->mem_buffer = alloc_barray(cinfo, 1,
...
# 1044 "../../../libs/jpeg/jmemmgr.c"
  ...
  if ((long) test_mac != 1000000000L ||
      (1000000000L % ((size_t) sizeof(double))) != 0)
