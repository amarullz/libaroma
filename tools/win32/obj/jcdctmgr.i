...
start_pass_fdctmgr (j_compress_ptr cinfo)
{
 ...
 cinfo->quant_tbl_ptrs[qtblno] == ((void *)0))
 ...
 for (i = 0; i < 64; i++) {
   dtbl[i] = (DCTELEM)
     ((((((INT32) qtbl->quantval[i]) * ((INT32) aanscales[i]))) + (((INT32) 1) << ((14 -3)-1))) >> (14 -3))
