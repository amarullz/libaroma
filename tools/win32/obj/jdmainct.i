...
# 19 "../../../libs/jpeg/jdmainct.c" 2
# 114 "../../../libs/jpeg/jdmainct.c"
typedef struct {
...
# 143 "../../../libs/jpeg/jdmainct.c"
static void process_data_simple_main
 (j_decompress_ptr cinfo, JSAMPARRAY output_buf, JDIMENSION *out_row_ctr, JDIMENSION out_rows_avail)
                                                          ;
static void process_data_context_main
 (j_decompress_ptr cinfo, JSAMPARRAY output_buf, JDIMENSION *out_row_ctr, JDIMENSION out_rows_avail)
                                                          ;

static void process_data_crank_post
 (j_decompress_ptr cinfo, JSAMPARRAY output_buf, JDIMENSION *out_row_ctr, JDIMENSION out_rows_avail)
                                                          ;
...

{
  ...
  main->xbuffer[0] = (JSAMPIMAGE)
    ...
    cinfo->num_components * 2 * ((size_t) sizeof(JSAMPARRAY)));
  ...
  for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
    ...
    xbuf = (JSAMPARRAY)
      (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
      2 * (rgroup * (M + 4)) * ((size_t) sizeof(JSAMPROW)));
    xbuf += rgroup;
