...
# 16 "../../../libs/jpeg/jccoefct.c" 2
# 34 "../../../libs/jpeg/jccoefct.c"
typedef struct {
...
static boolean compress_data
    (j_compress_ptr cinfo, JSAMPIMAGE input_buf);

static boolean compress_first_pass
    (j_compress_ptr cinfo, JSAMPIMAGE input_buf);
static boolean compress_output
    (j_compress_ptr cinfo, JSAMPIMAGE input_buf);
 ...
 for (yindex = 0; yindex < compptr->MCU_height; yindex++) {
  ...
  coef->MCU_buffer[blkn+bi][0][0] = coef->MCU_buffer[blkn+bi-1][0][0];
     ...
     jzero_far((void *) coef->MCU_buffer[blkn],
        compptr->MCU_width * ((size_t) sizeof(JBLOCK)));
...
compress_first_pass (j_compress_ptr cinfo, JSAMPIMAGE input_buf)
{
 ...
 jzero_far((void *) thisblockrow,
    (size_t) (blocks_across * ((size_t) sizeof(JBLOCK))));
