...
# 25 "../../../libs/freetype/src/lzw/ftlzw.c" 2
# 1 "../../../libs/freetype/include/freetype/internal/ftmemory.h" 1
# 24 "../../../libs/freetype/include/freetype/internal/ftmemory.h"
...
# 25 "../../../libs/freetype/include/freetype/internal/ftmemory.h" 2
...
# 26 "../../../libs/freetype/include/freetype/internal/ftmemory.h" 2
...
# 26 "../../../libs/freetype/src/lzw/ftlzw.c" 2
...
# 24 "../../../libs/freetype/include/freetype/ftmodapi.h"
# 1 "../../../libs/freetype/include/freetype/freetype.h" 1
# 35 "../../../libs/freetype/include/freetype/freetype.h"
...
# 25 "../../../libs/freetype/include/freetype/ftmodapi.h" 2
...
# 27 "../../../libs/freetype/src/lzw/ftlzw.c" 2
...
# 28 "../../../libs/freetype/src/lzw/ftlzw.c" 2
# 1 "../../../libs/freetype/include/freetype/ftlzw.h" 1
# 32 "../../../libs/freetype/include/freetype/ftlzw.h"

# 87 "../../../libs/freetype/include/freetype/ftlzw.h"
  extern FT_Error
...
# 29 "../../../libs/freetype/src/lzw/ftlzw.c" 2
# 40 "../../../libs/freetype/src/lzw/ftlzw.c"
# 1 "../../../libs/freetype/include/freetype/fterrors.h" 1
# 173 "../../../libs/freetype/include/freetype/fterrors.h"
  enum {
...
# 59 "../../../libs/freetype/include/freetype/fterrdef.h"
  ...
  LZW_Err_Cannot_Open_Resource = 0x01 + 0,

  LZW_Err_Unknown_File_Format = 0x02 + 0,

  LZW_Err_Invalid_File_Format = 0x03 + 0,

  LZW_Err_Invalid_Version = 0x04 + 0,

  LZW_Err_Lower_Module_Version = 0x05 + 0,

  LZW_Err_Invalid_Argument = 0x06 + 0,

  LZW_Err_Unimplemented_Feature = 0x07 + 0,

  LZW_Err_Invalid_Table = 0x08 + 0,

  LZW_Err_Invalid_Offset = 0x09 + 0,

  LZW_Err_Array_Too_Large = 0x0A + 0,

  LZW_Err_Missing_Module = 0x0B + 0,

  LZW_Err_Missing_Property = 0x0C + 0,




  LZW_Err_Invalid_Glyph_Index = 0x10 + 0,

  LZW_Err_Invalid_Character_Code = 0x11 + 0,

  LZW_Err_Invalid_Glyph_Format = 0x12 + 0,

  LZW_Err_Cannot_Render_Glyph = 0x13 + 0,

  LZW_Err_Invalid_Outline = 0x14 + 0,

  LZW_Err_Invalid_Composite = 0x15 + 0,

  LZW_Err_Too_Many_Hints = 0x16 + 0,

  LZW_Err_Invalid_Pixel_Size = 0x17 + 0,




  LZW_Err_Invalid_Handle = 0x20 + 0,

  LZW_Err_Invalid_Library_Handle = 0x21 + 0,

  LZW_Err_Invalid_Driver_Handle = 0x22 + 0,

  LZW_Err_Invalid_Face_Handle = 0x23 + 0,

  LZW_Err_Invalid_Size_Handle = 0x24 + 0,

  LZW_Err_Invalid_Slot_Handle = 0x25 + 0,

  LZW_Err_Invalid_CharMap_Handle = 0x26 + 0,

  LZW_Err_Invalid_Cache_Handle = 0x27 + 0,

  LZW_Err_Invalid_Stream_Handle = 0x28 + 0,




  LZW_Err_Too_Many_Drivers = 0x30 + 0,

  LZW_Err_Too_Many_Extensions = 0x31 + 0,




  LZW_Err_Out_Of_Memory = 0x40 + 0,

  LZW_Err_Unlisted_Object = 0x41 + 0,




  LZW_Err_Cannot_Open_Stream = 0x51 + 0,

  LZW_Err_Invalid_Stream_Seek = 0x52 + 0,

  LZW_Err_Invalid_Stream_Skip = 0x53 + 0,

  LZW_Err_Invalid_Stream_Read = 0x54 + 0,

  LZW_Err_Invalid_Stream_Operation = 0x55 + 0,

  LZW_Err_Invalid_Frame_Operation = 0x56 + 0,

  LZW_Err_Nested_Frame_Access = 0x57 + 0,

  LZW_Err_Invalid_Frame_Read = 0x58 + 0,




  LZW_Err_Raster_Uninitialized = 0x60 + 0,

  LZW_Err_Raster_Corrupted = 0x61 + 0,

  LZW_Err_Raster_Overflow = 0x62 + 0,

  LZW_Err_Raster_Negative_Height = 0x63 + 0,




  LZW_Err_Too_Many_Caches = 0x70 + 0,




  LZW_Err_Invalid_Opcode = 0x80 + 0,

  LZW_Err_Too_Few_Arguments = 0x81 + 0,

  LZW_Err_Stack_Overflow = 0x82 + 0,

  LZW_Err_Code_Overflow = 0x83 + 0,

  LZW_Err_Bad_Argument = 0x84 + 0,

  LZW_Err_Divide_By_Zero = 0x85 + 0,

  LZW_Err_Invalid_Reference = 0x86 + 0,

  LZW_Err_Debug_OpCode = 0x87 + 0,

  LZW_Err_ENDF_In_Exec_Stream = 0x88 + 0,

  LZW_Err_Nested_DEFS = 0x89 + 0,

  LZW_Err_Invalid_CodeRange = 0x8A + 0,

  LZW_Err_Execution_Too_Long = 0x8B + 0,

  LZW_Err_Too_Many_Function_Defs = 0x8C + 0,

  LZW_Err_Too_Many_Instruction_Defs = 0x8D + 0,

  LZW_Err_Table_Missing = 0x8E + 0,

  LZW_Err_Horiz_Header_Missing = 0x8F + 0,

  LZW_Err_Locations_Missing = 0x90 + 0,

  LZW_Err_Name_Table_Missing = 0x91 + 0,

  LZW_Err_CMap_Table_Missing = 0x92 + 0,

  LZW_Err_Hmtx_Table_Missing = 0x93 + 0,

  LZW_Err_Post_Table_Missing = 0x94 + 0,

  LZW_Err_Invalid_Horiz_Metrics = 0x95 + 0,

  LZW_Err_Invalid_CharMap_Format = 0x96 + 0,

  LZW_Err_Invalid_PPem = 0x97 + 0,

  LZW_Err_Invalid_Vert_Metrics = 0x98 + 0,

  LZW_Err_Could_Not_Find_Context = 0x99 + 0,

  LZW_Err_Invalid_Post_Table_Format = 0x9A + 0,

  LZW_Err_Invalid_Post_Table = 0x9B + 0,




  LZW_Err_Syntax_Error = 0xA0 + 0,

  LZW_Err_Stack_Underflow = 0xA1 + 0,

  LZW_Err_Ignore = 0xA2 + 0,

  LZW_Err_No_Unicode_Glyph_Name = 0xA3 + 0,

  LZW_Err_Glyph_Too_Big = 0xA4 + 0,




  LZW_Err_Missing_Startfont_Field = 0xB0 + 0,

  LZW_Err_Missing_Font_Field = 0xB1 + 0,

  LZW_Err_Missing_Size_Field = 0xB2 + 0,

  LZW_Err_Missing_Fontboundingbox_Field = 0xB3 + 0,

  LZW_Err_Missing_Chars_Field = 0xB4 + 0,

  LZW_Err_Missing_Startchar_Field = 0xB5 + 0,

  LZW_Err_Missing_Encoding_Field = 0xB6 + 0,

  LZW_Err_Missing_Bbx_Field = 0xB7 + 0,

  LZW_Err_Bbx_Too_Big = 0xB8 + 0,

  LZW_Err_Corrupted_Font_Header = 0xB9 + 0,

  LZW_Err_Corrupted_Font_Glyphs = 0xBA + 0,
# 179 "../../../libs/freetype/include/freetype/fterrors.h" 2



  LZW_Err_Max };
# 41 "../../../libs/freetype/src/lzw/ftlzw.c" 2
# 49 "../../../libs/freetype/src/lzw/ftlzw.c"
# 1 "../../../libs/freetype/src/lzw/ftzopen.h" 1
# 50 "../../../libs/freetype/src/lzw/ftzopen.h"
...
# 113 "../../../libs/freetype/src/lzw/ftzopen.h"
  ...
  ft_lzwstate_io( FT_LzwState state,
                  FT_Byte* buffer,
                  FT_ULong out_size );
# 50 "../../../libs/freetype/src/lzw/ftlzw.c" 2
# 70 "../../../libs/freetype/src/lzw/ftlzw.c"
  ...
  ft_lzw_check_header( FT_Stream stream )
  {
    ...
    if ( ( ( error = (FT_Stream_Seek( stream, (FT_ULong)(0) )) ) != 0 ) ||
         ( ( error = (FT_Stream_Read( stream, (FT_Byte*)(head), (FT_ULong)(2) )) ) != 0 ) )
      goto Exit;
  ...
  ft_lzw_file_fill_output( FT_LZWFile zip )
  {
    ...
    count = ft_lzwstate_io( lzw, zip->buffer, 4096 );
                           ...
                           FT_ULong count )
  {
    ...
    while ( count > 0 )
    {
      ...
      numread = ft_lzwstate_io( &zip->lzw, ((void *)0), delta );
      if ( numread < delta )
      {
                  ...
                  FT_ULong count )
  {
    ...
    for (;;)
    {
      ...
      memcpy( buffer + result, zip->cursor, (FT_Offset)(delta) );
      result += delta;
      zip->cursor += delta;
      zip->pos += delta;
...
# 314 "../../../libs/freetype/src/lzw/ftlzw.c"
  static void
  ft_lzw_stream_close( FT_Stream stream )
  {
    ...
    if ( zip )
    {
      ...
      do { ft_mem_free( memory, (zip) ); (zip) = ((void *)0); } while ( 0 );

      stream->descriptor.pointer = ((void *)0);
    }
  }
                     ...
                     FT_Stream source )
  {
    FT_Error error;
    FT_Memory memory;
    FT_LZWFile zip = ((void *)0);


    if ( !stream || !source )
    {
      error = LZW_Err_Invalid_Stream_Handle;
      goto Exit;
    }

    memory = source->memory;
# 370 "../../../libs/freetype/src/lzw/ftlzw.c"
    error = ft_lzw_check_header( source );
    if ( error )
      goto Exit;

    memset( stream, 0, (FT_Offset)(sizeof ( *(stream) )) );
    stream->memory = memory;

    if ( !( ((zip) = (ft_mem_alloc( memory, (FT_Long)(sizeof ( *(zip) )), &error ))), error != 0 ) )
    {
...
# 1 "../../../libs/freetype/src/lzw/ftzopen.c" 1
# 28 "../../../libs/freetype/src/lzw/ftzopen.c"
  static int
  ...
  ft_lzwstate_get_code( FT_LzwState state )
  {
    ...
    if ( num_bits > 0 )
      result |= ( *p & ( ( 1U << (num_bits) ) - 1U ) ) << offset;
  ...
  ft_lzwstate_stack_grow( FT_LzwState state )
  {
    if ( state->stack_top >= state->stack_size )
    {
      ...
      if ( ( ((state->stack) = (ft_mem_realloc( memory, sizeof ( *(state->stack) ), (FT_Long)(old_size), (FT_Long)(new_size), (state->stack), &error ))), error != 0 ) )
        return -1;
  ...
  ft_lzwstate_prefix_grow( FT_LzwState state )
  {
    ...
    if ( new_size == 0 )
      ...
      new_size += new_size >> 2;
# 169 "../../../libs/freetype/src/lzw/ftzopen.c"
    if ( ( ((state->prefix) = (ft_mem_realloc( memory, (FT_Long)(sizeof ( FT_UShort ) + sizeof ( FT_Byte )), (FT_Long)(old_size), (FT_Long)(new_size), (state->prefix), &error ))), error != 0 )
                                                                      )
      return -1;
    ...
    memmove( state->suffix, state->prefix + old_size, (FT_Offset)(old_size * sizeof ( FT_Byte )) )
  ...
  ft_lzwstate_init( FT_LzwState state,
                    FT_Stream source )
  {
    memset( state, 0, (FT_Offset)(sizeof ( *(state) )) );
  ...
  ft_lzwstate_done( FT_LzwState state )
  {
    ...
    if ( state->stack != state->stack_0 )
      do { ft_mem_free( memory, (state->stack) ); (state->stack) = ((void *)0); } while ( 0 );

    do { ft_mem_free( memory, (state->prefix) ); (state->prefix) = ((void *)0); } while ( 0 );
    state->suffix = ((void *)0);

    memset( state, 0, (FT_Offset)(sizeof ( *(state) )) );
  }
# 247 "../../../libs/freetype/src/lzw/ftzopen.c"
  FT_ULong
  ft_lzwstate_io( FT_LzwState state,
                  FT_Byte* buffer,
                  FT_ULong out_size )
  {
    ...
    case FT_LZW_PHASE_START:
      {
        ...
        state->max_bits = max_bits & 0x1F;
        state->block_mode = max_bits & 0x80;
        state->max_free = (FT_UInt)( ( 1UL << state->max_bits ) - 256 );

        if ( state->max_bits > 16 )
          goto Eof;

        state->num_bits = 9;
        state->free_ent = ( state->block_mode ? 257
                                              : 256 ) - 256;
        in_code = 0;
    ...
    case FT_LZW_PHASE_CODE:
      ...
      NextCode:
        ...
        if ( code == 256 && state->block_mode )
        {

          state->free_ent = ( 257 - 1 ) - 256;
          state->buf_clear = 1;
        ...
        if ( code >= 256U )
        {
          ...
          if ( code - 256U >= state->free_ent )
          {
            ...
            do { if ( state->stack_top >= state->stack_size && ft_lzwstate_stack_grow( state ) < 0 ) goto Eof; state->stack[state->stack_top++] = (FT_Byte)(old_char); } while ( 0 );
            code = old_code;
          }
          ...
          while ( code >= 256U )
          {
            ...
            do { if ( state->stack_top >= state->stack_size && ft_lzwstate_stack_grow( state ) < 0 ) goto Eof; state->stack[state->stack_top++] = (FT_Byte)(state->suffix[code - 256]); } while ( 0 );
...
# 401 "../../../libs/freetype/src/lzw/ftlzw.c" 2
