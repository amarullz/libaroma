...
# 20 "../../../libs/png/pngerror.c" 2



static __attribute__((__noreturn__)) void png_default_error (png_const_structrp png_ptr, png_const_charp error_message)
                                                 ;
   ...
   png_alloc_size_t number)
{
   ...
   *--end = '\0';
   ...
   while (end > start && (number != 0 || count < mincount))
   {
      ...
      if (format == 5) if (count == 5) if (end > start)
      {
...
png_warning(png_const_structrp png_ptr, png_const_charp warning_message)
{
   ...
   if (png_ptr != ((void *)0) && png_ptr->warning_fn != ((void *)0))
      (*(png_ptr->warning_fn))(((png_structrp)(png_ptr)),
...
__attribute__((__noreturn__)) void png_fixed_error (png_const_structrp png_ptr, png_const_charp name)

{


   int iin;
   char msg[((sizeof "fixed point overflow in ")-1)+196];
   memcpy(msg, "fixed point overflow in ", ((sizeof "fixed point overflow in ")-1));
   iin = 0;
   if (name != ((void *)0)) while (iin < (196 -1) && name[iin] != 0)
   {
      msg[((sizeof "fixed point overflow in ")-1) + iin] = name[iin];
      ++iin;
   }
   msg[((sizeof "fixed point overflow in ")-1) + iin] = 0;
   png_error(png_ptr, msg);
}
...
png_free_jmpbuf(png_structrp png_ptr)
{
   if (png_ptr != ((void *)0))
   {
      ...
      if (jb != ((void *)0) && png_ptr->jmp_buf_size > 0)
      {
...
# 879 "../../../libs/png/pngerror.c"
__attribute__((__noreturn__)) void ( png_safe_error) (png_structp png_nonconst_ptr, png_const_charp error_message)
...

{
   ...
   if (image != ((void *)0))
   {
      ...
      if (image->opaque != ((void *)0) && image->opaque->error_buf != ((void *)0))
