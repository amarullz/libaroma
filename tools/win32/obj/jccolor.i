   ...
   JDIMENSION output_row, int num_rows)
{
  ...
  while (--num_rows >= 0) {
    ...
    for (col = 0; col < num_cols; col++) {
      ...
      outptr0[col] = (JSAMPLE)
  ((ctab[r+0] + ctab[g+(1*(255 +1))] + ctab[b+(2*(255 +1))])
   >> 16);

      outptr1[col] = (JSAMPLE)
  ((ctab[r+(3*(255 +1))] + ctab[g+(4*(255 +1))] + ctab[b+(5*(255 +1))])
   >> 16);

      outptr2[col] = (JSAMPLE)
  ((ctab[r+(5*(255 +1))] + ctab[g+(6*(255 +1))] + ctab[b+(7*(255 +1))])
   >> 16);
    }
  }
}
# 187 "../../../libs/jpeg/jccolor.c"
static void
...
static void copyquads(const UINT32 in[], UINT32 out0[], UINT32 out1[], UINT32 out2[], int col4)
{
    do {
        ...
        *out0++ = ((((src0) & 0xFF)) | ((((src0) >> 24)) << 8) | (((((src1) >> 16) & 0xFF)) << 16) | (((((src2) >> 8) & 0xFF)) << 24));
        *out1++ = (((((src0) >> 8) & 0xFF)) | ((((src1) & 0xFF)) << 8) | ((((src1) >> 24)) << 16) | (((((src2) >> 16) & 0xFF)) << 24));
        *out2++ = (((((src0) >> 16) & 0xFF)) | (((((src1) >> 8) & 0xFF)) << 8) | ((((src2) & 0xFF)) << 16) | ((((src2) >> 24)) << 24));
    } while (--col4 != 0);
}
# 340 "../../../libs/jpeg/jccolor.c"
static void
...
jinit_color_converter (j_compress_ptr cinfo)
{
  ...
  cconvert = (my_cconvert_ptr)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
    ((size_t) sizeof(my_color_converter)));
