...

{
  ...
  if (which_tbl < 0 || which_tbl >= 4)
    ((cinfo)->err->msg_code = (JERR_DQT_INDEX), (cinfo)->err->msg_parm.i[0] = (which_tbl), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
...
# 566 "../../../libs/jpeg/jcparam.c"
  if (cinfo->script_space == ((void *)0) || cinfo->script_space_size < nscans) {
