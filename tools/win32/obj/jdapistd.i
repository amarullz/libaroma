...
# 211 "../../../libs/jpeg/jdapistd.c"
void
jpeg_init_read_tile_scanline(j_decompress_ptr cinfo, huffman_index *index,
       int *start_x, int *start_y, int *width, int *height)
{

  int lines_per_iMCU_row = cinfo->max_v_samp_factor * 8;
  int lines_per_iMCU_col = cinfo->max_h_samp_factor * 8;
  ...
  *start_y = row_offset * lines_per_iMCU_row;
  ...
  int sample_size = 8 / cinfo->min_DCT_scaled_size;
