...
static int consume_markers_with_huffman_index (j_decompress_ptr cinfo, huffman_index *index, int current_scan)
                                                            ;
...

{
  ...
  if ((long) cinfo->image_height > (long) 65500L ||
      (long) cinfo->image_width > (long) 65500L)
