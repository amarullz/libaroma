...
# 23 "../../../libs/jpeg/jmem-android.c" 2
# 39 "../../../libs/jpeg/jmem-android.c"
void *
...
# 100 "../../../libs/jpeg/jmem-android.c"
static void
read_backing_store (j_common_ptr cinfo, backing_store_ptr info,
      void * buffer_address,
      long file_offset, long byte_count)
{
  if (fseek(info->temp_file, file_offset, 0))
    ((cinfo)->err->msg_code = (JERR_TFILE_SEEK), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
  if (((size_t) fread((void *) (buffer_address), (size_t) 1, (size_t) (byte_count), (info->temp_file)))
      != (size_t) byte_count)
    ((cinfo)->err->msg_code = (JERR_TFILE_READ), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
}
       ...
       long file_offset, long byte_count)
{
  ...
  if (((size_t) fwrite((const void *) (buffer_address), (size_t) 1, (size_t) (byte_count), (info->temp_file)))
      != (size_t) byte_count)
    ((cinfo)->err->msg_code = (JERR_TFILE_WRITE), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
}
...
# 161 "../../../libs/jpeg/jmem-android.c"
void
jpeg_open_backing_store (j_common_ptr cinfo, backing_store_ptr info,
    long total_bytes_needed)
{
  if ((info->temp_file = getTempFile()) == ((void *)0))
    ((cinfo)->err->msg_code = (JERR_TFILE_CREATE), __builtin_strncpy ((cinfo)->err->msg_parm.s, (""), 80), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
