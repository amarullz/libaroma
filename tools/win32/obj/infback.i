# 1 "../../../libs/zlib/src/infback.c"
# 1 "<command-line>"
# 1 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "../../../libs/zlib/src/infback.c"
# 13 "../../../libs/zlib/src/infback.c"
# 1 "../../../libs/zlib/src/zutil.h" 1
# 22 "../../../libs/zlib/src/zutil.h"
...
# 1273 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\bits\\string2.h" 3 4
...
# 1274 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\bits\\string2.h" 2 3 4
...
extern int lcong48_r (unsigned short int __param[7],
     ...
     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
# 474 "d:\\devtools\\linaro\\arm-linux-gnueabihf\\libc\\usr\\include\\stdlib.h" 3 4
...
# 30 "../../../libs/zlib/src/zutil.h" 2
# 41 "../../../libs/zlib/src/zutil.h"
...
# 173 "../../../libs/zlib/src/zutil.h"
    extern uLong adler32_combine64 (uLong, uLong, off_t);
    extern uLong crc32_combine64 (uLong, uLong, off_t);
# 239 "../../../libs/zlib/src/zutil.h"
   voidpf zcalloc (voidpf opaque, unsigned items, unsigned size)
                                                   ;
   void zcfree (voidpf opaque, voidpf ptr);
# 14 "../../../libs/zlib/src/infback.c" 2
# 1 "../../../libs/zlib/src/inftrees.h" 1
# 24 "../../../libs/zlib/src/inftrees.h"
typedef struct {
    unsigned char op;
    unsigned char bits;
    unsigned short val;
} code;
# 54 "../../../libs/zlib/src/inftrees.h"
typedef enum {
    CODES,
    LENS,
    DISTS
...
int inflate_table (codetype type, unsigned short *lens, unsigned codes, code * *table, unsigned *bits, unsigned short *work)
                                                                           ...
                                                                           ;
# 15 "../../../libs/zlib/src/infback.c" 2
# 1 "../../../libs/zlib/src/inflate.h" 1
# 20 "../../../libs/zlib/src/inflate.h"
typedef enum {
    HEAD,
    FLAGS,
    TIME,
...
# 16 "../../../libs/zlib/src/infback.c" 2
# 1 "../../../libs/zlib/src/inffast.h" 1
# 11 "../../../libs/zlib/src/inffast.h"
void inflate_fast (z_streamp strm, unsigned start);
# 17 "../../../libs/zlib/src/infback.c" 2


static void fixedtables (struct inflate_state *state);
# 28 "../../../libs/zlib/src/infback.c"
...
# 82 "../../../libs/zlib/src/infback.c"
static void fixedtables(state)
struct inflate_state *state;
{
# 117 "../../../libs/zlib/src/infback.c"
# 1 "../../../libs/zlib/src/inffixed.h" 1
# 10 "../../../libs/zlib/src/inffixed.h"
