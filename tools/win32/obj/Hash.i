...
# 13 "../../../libs/minzip/Hash.c" 2
# 1 "../../../libs/minzip/Hash.h" 1
# 12 "../../../libs/minzip/Hash.h"
# 1 "../../../libs/minzip/inline_magic.h" 1
# 13 "../../../libs/minzip/Hash.h" 2
...
# 14 "../../../libs/minzip/Hash.c" 2
# 26 "../../../libs/minzip/Hash.c"
size_t mzHashSize(size_t size) {
  return (size * 8) / 5 + 1;
}
...
void mzHashTableClear(HashTable * pHashTable) {
  ...
  for (i = 0; i < pHashTable->tableSize; i++, pEnt++) {
    if (pEnt->data == ((void*) 0xcbcacccd)) {

      pEnt->data = ((void *)0);
    }
    else if (pEnt->data != ((void *)0)) {

      if (pHashTable->freeFunc != ((void *)0)) {
...
# 139 "../../../libs/minzip/Hash.c"
static _Bool resizeHash(HashTable * pHashTable, int newSize) {
  ...
  for (i = 0; i < pHashTable->tableSize; i++) {
    ...
    if (data != ((void *)0) && data != ((void*) 0xcbcacccd)) {
      ...
      while (pNewEntries[newIdx].data != ((void *)0)) {
...
void * mzHashTableLookup(HashTable * pHashTable, unsigned int itemHash, void * item,
  ...
  while (pEntry->data != ((void *)0)) {
    if (pEntry->data != ((void*) 0xcbcacccd) &&
  ...
  if (pEntry->data == ((void *)0)) {
    if (doAdd) {
      ...
      if ((pHashTable->numEntries + pHashTable->numDeadEntries) * 8
          > pHashTable->tableSize * 5) {
        if (!resizeHash(pHashTable, pHashTable->tableSize * 2)) {

          ((void)printf("minzip" ": " "Dalvik hash resize failure\n"));
          abort();
        }
...
_Bool mzHashTableRemove(HashTable * pHashTable, unsigned int itemHash, void * item) {
  HashEntry * pEntry;
  HashEntry * pEnd;
  ((void) (0));
...
int mzHashForeach(HashTable * pHashTable, HashForeachFunc func, void * arg) {
  ...
  for (i = 0; i < pHashTable->tableSize; i++) {
    ...
    if (pEnt->data != ((void *)0) && pEnt->data != ((void*) 0xcbcacccd)) {
