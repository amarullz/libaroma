...
# 80 "../../../libs/jpeg/jdatadst.c"
static boolean
empty_output_buffer (j_compress_ptr cinfo)
{
  my_dest_ptr dest = (my_dest_ptr) cinfo->dest;

  if (((size_t) fwrite((const void *) (dest->buffer), (size_t) 1, (size_t) (4096), (dest->outfile))) !=
      (size_t) 4096)
...
term_destination (j_compress_ptr cinfo)
{
  ...
  if (datacount > 0) {
    if (((size_t) fwrite((const void *) (dest->buffer), (size_t) 1, (size_t) (datacount), (dest->outfile))) != datacount)
      ((cinfo)->err->msg_code = (JERR_FILE_WRITE), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
  }
  fflush(dest->outfile);
