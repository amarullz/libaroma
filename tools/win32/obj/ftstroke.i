...
# 20 "../../../libs/freetype/src/base/ftstroke.c" 2
# 1 "../../../libs/freetype/include/freetype/ftstroke.h" 1
# 23 "../../../libs/freetype/include/freetype/ftstroke.h"
# 1 "../../../libs/freetype/include/freetype/ftoutln.h" 1
# 25 "../../../libs/freetype/include/freetype/ftoutln.h"
...
# 26 "../../../libs/freetype/include/freetype/ftoutln.h" 2
...
# 24 "../../../libs/freetype/include/freetype/ftstroke.h" 2
...
# 25 "../../../libs/freetype/include/freetype/ftstroke.h" 2



# 92 "../../../libs/freetype/include/freetype/ftstroke.h"
  typedef struct FT_StrokerRec_* FT_Stroker;
# 141 "../../../libs/freetype/include/freetype/ftstroke.h"
...
# 174 "../../../libs/freetype/include/freetype/ftstroke.h"
...
# 208 "../../../libs/freetype/include/freetype/ftstroke.h"
...
# 233 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_StrokerBorder
  FT_Outline_GetInsideBorder( FT_Outline* outline );
# 254 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_StrokerBorder
  FT_Outline_GetOutsideBorder( FT_Outline* outline );
# 277 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_New( FT_Library library,
                  FT_Stroker *astroker );
# 314 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern void
...
# 337 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern void
  FT_Stroker_Rewind( FT_Stroker stroker );
# 374 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_ParseOutline( FT_Stroker stroker,
                           FT_Outline* outline,
                           FT_Bool opened );
# 405 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_BeginSubPath( FT_Stroker stroker,
                           FT_Vector* to,
                           FT_Bool open );
# 431 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_EndSubPath( FT_Stroker stroker );
# 458 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_LineTo( FT_Stroker stroker,
                     FT_Vector* to );
# 489 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_ConicTo( FT_Stroker stroker,
                      FT_Vector* control,
                      FT_Vector* to );
# 524 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_CubicTo( FT_Stroker stroker,
                      FT_Vector* control1,
                      FT_Vector* control2,
                      FT_Vector* to );
# 570 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_GetBorderCounts( FT_Stroker stroker,
                              FT_StrokerBorder border,
                              FT_UInt *anum_points,
                              FT_UInt *anum_contours );
# 616 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern void
  FT_Stroker_ExportBorder( FT_Stroker stroker,
                           FT_StrokerBorder border,
                           FT_Outline* outline );
# 647 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Stroker_GetCounts( FT_Stroker stroker,
                        FT_UInt *anum_points,
                        FT_UInt *anum_contours );
# 673 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern void
  FT_Stroker_Export( FT_Stroker stroker,
                     FT_Outline* outline );
# 690 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern void
  FT_Stroker_Done( FT_Stroker stroker );
# 725 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
  FT_Glyph_Stroke( FT_Glyph *pglyph,
                   FT_Stroker stroker,
                   FT_Bool destroy );
# 767 "../../../libs/freetype/include/freetype/ftstroke.h"
  extern FT_Error
...
# 21 "../../../libs/freetype/src/base/ftstroke.c" 2
...
# 22 "../../../libs/freetype/src/base/ftstroke.c" 2
...
# 24 "../../../libs/freetype/src/base/ftstroke.c" 2
...
# 25 "../../../libs/freetype/src/base/ftstroke.c" 2
...
# 26 "../../../libs/freetype/src/base/ftstroke.c" 2

# 1 "../../../libs/freetype/src/base/basepic.h" 1
# 28 "../../../libs/freetype/src/base/ftstroke.c" 2
...
# 80 "../../../libs/freetype/src/base/ftstroke.c"
  static FT_Pos
  ft_pos_abs( FT_Pos x )
  {
    return x >= 0 ? x : -x;
                            ...
                            FT_Angle *angle_out )
  {
    ...
    close1 = ( (d1.x) > -2 && (d1.x) < 2 ) && ( (d1.y) > -2 && (d1.y) < 2 );
    close2 = ( (d2.x) > -2 && (d2.x) < 2 ) && ( (d2.y) > -2 && (d2.y) < 2 );
    ...
    return ( (FT_Bool)( theta < ( ( 180L << 16 ) / 6 ) ) );
  }
                            ...
                            FT_Angle *angle_out )
  {
    ...
    close1 = ( (d1.x) > -2 && (d1.x) < 2 ) && ( (d1.y) > -2 && (d1.y) < 2 );
    close2 = ( (d2.x) > -2 && (d2.x) < 2 ) && ( (d2.y) > -2 && (d2.y) < 2 );
    close3 = ( (d3.x) > -2 && (d3.x) < 2 ) && ( (d3.y) > -2 && (d3.y) < 2 );
    ...
    return ( (FT_Bool)( theta1 < ( ( 180L << 16 ) / 8 ) && theta2 < ( ( 180L << 16 ) / 8 ) ) )
                                                       ;
  }
# 301 "../../../libs/freetype/src/base/ftstroke.c"
                         ...
                         FT_UInt new_points )
  {
    ...
    if ( new_max > old_max )
    {
      ...
      if ( ( ((border->points) = (ft_mem_realloc( memory, sizeof ( *(border->points) ), (FT_Long)(old_max), (FT_Long)(cur_max), (border->points), &error ))), error != 0 ) ||
           ( ((border->tags) = (ft_mem_realloc( memory, sizeof ( *(border->tags) ), (FT_Long)(old_max), (FT_Long)(cur_max), (border->tags), &error ))), error != 0 ) )
        goto Exit;
                           ...
                           FT_Bool movable )
  {
    ...
    else
    {
      ...
      if ( border->num_points > 0 &&
           ( (border->points[border->num_points - 1].x - to->x) > -2 && (border->points[border->num_points - 1].x - to->x) < 2 ) &&
           ( (border->points[border->num_points - 1].y - to->y) > -2 && (border->points[border->num_points - 1].y - to->y) < 2 ) )
        return error;
                          ...
                          FT_Angle angle_diff )
  {
    ...
    total = angle_diff;
    angle = angle_start;
    rotate = ( angle_diff >= 0 ) ? ( ( 180L << 16 ) / 2 ) : -( ( 180L << 16 ) / 2 );
  ...
  ft_stroke_border_done( FT_StrokeBorder border )
  {
    ...
    do { ft_mem_free( memory, (border->points) ); (border->points) = ((void *)0); } while ( 0 );
    do { ft_mem_free( memory, (border->tags) ); (border->tags) = ((void *)0); } while ( 0 );
                           ...
                           FT_Outline* outline )
  {
    ...
    memcpy( outline->points + outline->n_points, border->points, (FT_Offset)((FT_Offset)(border->num_points) * sizeof ( *(outline->points + outline->n_points) )) )
...
# 771 "../../../libs/freetype/src/base/ftstroke.c"
                  ...
                  FT_Stroker *astroker )
  {
    ...
    if ( !( ((stroker) = (ft_mem_alloc( memory, (FT_Long)(sizeof ( *(stroker) )), &error ))), error != 0 ) )
    {
  ...
  FT_Stroker_Done( FT_Stroker stroker )
  {
    if ( stroker )
    {
      ...
      stroker->library = ((void *)0);
      do { ft_mem_free( memory, (stroker) ); (stroker) = ((void *)0); } while ( 0 );
    }
  }
                  ...
                  FT_Int side )
  {
    ...
    if ( stroker->line_cap == FT_STROKER_LINECAP_ROUND )
    {
      ...
      stroker->angle_out = angle + ( 180L << 16 );
    ...
    else if ( stroker->line_cap == FT_STROKER_LINECAP_SQUARE )
    {
      ...
      FT_Angle rotate = ( ( ( 180L << 16 ) / 2 ) - (side) * ( 180L << 16 ) );
      FT_Fixed radius = stroker->radius;
      FT_StrokeBorder border = stroker->borders + side;
                     ...
                     FT_Vector* to )
  {
    ...
    FT_Vector_From_Polar( &delta, stroker->radius, angle + ( ( 180L << 16 ) / 2 ) );
                      ...
                      FT_Vector* to )
  {
    ...
    if ( ( (stroker->center.x - control->x) > -2 && (stroker->center.x - control->x) < 2 ) &&
         ( (stroker->center.y - control->y) > -2 && (stroker->center.y - control->y) < 2 ) &&
         ( (control->x - to->x) > -2 && (control->x - to->x) < 2 ) &&
         ( (control->y - to->y) > -2 && (control->y - to->y) < 2 ) )
    {
       stroker->center = *to;
       goto Exit;
    }
              ...
              side++, border++ )
        {
          ...
          if ( stroker->handle_wide_strokes )
          {
                   ...
                   ( 180L << 16 ) / 2 )
            {
              ...
              if ( error )
                goto Exit;
              error = ft_stroke_border_lineto( border, &end, 0 );
              if ( error )
                goto Exit;
                      ...
                      FT_Vector* to )
  {
    ...
    if ( ( (stroker->center.x - control1->x) > -2 && (stroker->center.x - control1->x) < 2 ) &&
         ( (stroker->center.y - control1->y) > -2 && (stroker->center.y - control1->y) < 2 ) &&
         ( (control1->x - control2->x) > -2 && (control1->x - control2->x) < 2 ) &&
         ( (control1->y - control2->y) > -2 && (control1->y - control2->y) < 2 ) &&
         ( (control2->x - to->x) > -2 && (control2->x - to->x) < 2 ) &&
         ( (control2->y - to->y) > -2 && (control2->y - to->y) < 2 ) )
    {
       stroker->center = *to;
       goto Exit;
    }
                           ...
                           FT_Bool open )
  {
    ...
    stroker->handle_wide_strokes =
      ( (FT_Bool)( stroker->line_join != FT_STROKER_LINEJOIN_ROUND || ( stroker->subpath_open && stroker->line_cap == FT_STROKER_LINECAP_BUTT ) ) )
...

      {
        ...
        while ( src_point >= left->points + left->start )
        {
          ...
          *dst_tag = *src_tag;
          ...
          {
            FT_Byte ttag =
                       (FT_Byte)( dst_tag[0] & ( FT_STROKE_TAG_BEGIN | FT_STROKE_TAG_END ) );
  ...
  FT_Stroker_EndSubPath( FT_Stroker stroker )
  {
    ...
    if ( stroker->subpath_open )
    {
      ...
      error = ft_stroker_cap( stroker,
                              stroker->subpath_angle + ( 180L << 16 ), 0 );
      if ( error )
        goto Exit;
    ...
    else
    {
      ...
      ft_stroke_border_close( stroker->borders + 0, 0 );
      ft_stroke_border_close( stroker->borders + 1, 1 );
    }
...
# 2092 "../../../libs/freetype/src/base/ftstroke.c"
  extern FT_Error
  FT_Stroker_ParseOutline( FT_Stroker stroker,
                           FT_Outline* outline,
                           FT_Bool opened )
