...
# 22 "../../../libs/freetype/src/smooth/smooth.c" 2
# 1 "../../../libs/freetype/src/smooth/ftspic.c" 1
# 20 "../../../libs/freetype/src/smooth/ftspic.c"
...
# 21 "../../../libs/freetype/src/smooth/ftspic.c" 2
...
# 22 "../../../libs/freetype/src/smooth/ftspic.c" 2
# 1 "../../../libs/freetype/src/smooth/ftspic.h" 1
# 26 "../../../libs/freetype/src/smooth/ftspic.h"

# 70 "../../../libs/freetype/src/smooth/ftspic.h"

# 23 "../../../libs/freetype/src/smooth/ftspic.c" 2
# 1 "../../../libs/freetype/src/smooth/ftsmerrs.h" 1
# 37 "../../../libs/freetype/src/smooth/ftsmerrs.h"
# 1 "../../../libs/freetype/include/freetype/fterrors.h" 1
# 173 "../../../libs/freetype/include/freetype/fterrors.h"
  enum {
...
# 59 "../../../libs/freetype/include/freetype/fterrdef.h"
  ...
  Smooth_Err_Missing_Module = 0x0B + 0,

  Smooth_Err_Missing_Property = 0x0C + 0,
  ...
  Smooth_Err_No_Unicode_Glyph_Name = 0xA3 + 0,

  Smooth_Err_Glyph_Too_Big = 0xA4 + 0,
  ...
  Smooth_Err_Missing_Fontboundingbox_Field = 0xB3 + 0,

  Smooth_Err_Missing_Chars_Field = 0xB4 + 0,

  Smooth_Err_Missing_Startchar_Field = 0xB5 + 0,

  Smooth_Err_Missing_Encoding_Field = 0xB6 + 0,

  Smooth_Err_Missing_Bbx_Field = 0xB7 + 0,

  Smooth_Err_Bbx_Too_Big = 0xB8 + 0,

  Smooth_Err_Corrupted_Font_Header = 0xB9 + 0,

  Smooth_Err_Corrupted_Font_Glyphs = 0xBA + 0,
# 179 "../../../libs/freetype/include/freetype/fterrors.h" 2



  Smooth_Err_Max };
# 38 "../../../libs/freetype/src/smooth/ftsmerrs.h" 2
# 24 "../../../libs/freetype/src/smooth/ftspic.c" 2
# 23 "../../../libs/freetype/src/smooth/smooth.c" 2
# 1 "../../../libs/freetype/src/smooth/ftgrays.c" 1
# 263 "../../../libs/freetype/src/smooth/ftgrays.c"
# 1 "../../../libs/freetype/src/smooth/ftgrays.h" 1
# 48 "../../../libs/freetype/src/smooth/ftgrays.h"
  extern const FT_Raster_Funcs ft_grays_raster;
# 264 "../../../libs/freetype/src/smooth/ftgrays.c" 2
...
# 266 "../../../libs/freetype/src/smooth/ftgrays.c" 2
...
# 267 "../../../libs/freetype/src/smooth/ftgrays.c" 2
# 389 "../../../libs/freetype/src/smooth/ftgrays.c"
  typedef long TCoord;
  typedef long TPos;
# 406 "../../../libs/freetype/src/smooth/ftgrays.c"
  typedef int TArea;
# 416 "../../../libs/freetype/src/smooth/ftgrays.c"
...
# 436 "../../../libs/freetype/src/smooth/ftgrays.c"
...
# 492 "../../../libs/freetype/src/smooth/ftgrays.c"
  ...
  static void
  gray_init_cells( gray_PWorker worker, void* buffer,
                            long byte_size )
  {
  ...
  static void
  gray_compute_cbox( gray_PWorker worker )
  {
  ...
  static PCell
  gray_find_cell( gray_PWorker worker )
  {
    PCell *pcell, cell;
    TPos x = (*worker).ex;
  ...
  static void
  gray_record_cell( gray_PWorker worker )
  {
    if ( (*worker).area | (*worker).cover )
    {
      PCell cell = gray_find_cell( worker );
  ...
  static void
  gray_set_cell( gray_PWorker worker, TCoord ex,
                          TCoord ey )
  {
# 642 "../../../libs/freetype/src/smooth/ftgrays.c"
    ey -= (*worker).min_ey;
    ...
    (*worker).invalid = ( (unsigned int)ey >= (unsigned int)(*worker).count_ey ||
                                  ex >= (*worker).count_ex );
  }
  ...
  static void
  gray_start_cell( gray_PWorker worker, TCoord ex,
                            TCoord ey )
  {
    if ( ex > (*worker).max_ex )
...
# 931 "../../../libs/freetype/src/smooth/ftgrays.c"
  static void
  gray_render_line( gray_PWorker worker, TPos to_x,
                             TPos to_y )
  {
    ...
    ex1 = ( (TCoord)( ((*worker).x) >> 8 ) );
    ex2 = ( (TCoord)( (to_x) >> 8 ) );
    ey1 = ( (TCoord)( ((*worker).y) >> 8 ) );
    ey2 = ( (TCoord)( (to_y) >> 8 ) );


    if ( ( ey1 >= (*worker).max_ey && ey2 >= (*worker).max_ey ) ||
         ( ey1 < (*worker).min_ey && ey2 < (*worker).min_ey ) )
      goto End;

    dx = to_x - (*worker).x;
    dy = to_y - (*worker).y;

    fx1 = (*worker).x - ( (TPos)(ex1) << 8 );
    fy1 = (*worker).y - ( (TPos)(ey1) << 8 );
    ...
    else if ( dx == 0 )
    {
      if ( dy > 0 )
        ...
        {
          fy2 = ( 1L << 8 );
          (*worker).cover += ( fy2 - fy1 );
          (*worker).area += ( fy2 - fy1 ) * fx1 * 2;
          fy1 = 0;
          ey1++;
          gray_set_cell( worker, ex1, ey1 );
        } while ( ey1 != ey2 );
    ...
    else
    {
      ...
      long dx_r = (long)( (2147483647L * 2UL + 1UL) >> 8 ) / ( dx );
      long dy_r = (long)( (2147483647L * 2UL + 1UL) >> 8 ) / ( dy );
      ...
      do
      {
        ...
        {
          fx2 = 0;
          fy2 = (TPos)( ( (unsigned long)( -prod ) * (unsigned long)( -dx_r ) ) >> ( sizeof( long ) * 8 - 8 ) );
          prod -= dy * ( 1L << 8 );
          (*worker).cover += ( fy2 - fy1 );
          (*worker).area += ( fy2 - fy1 ) * ( fx1 + fx2 );
          fx1 = ( 1L << 8 );
          fy1 = fy2;
          ex1--;
        }
        else if ( prod - dx * ( 1L << 8 ) <= 0 &&
                  prod - dx * ( 1L << 8 ) + dy * ( 1L << 8 ) > 0 )
        {
          prod -= dx * ( 1L << 8 );
          fx2 = (TPos)( ( (unsigned long)( -prod ) * (unsigned long)( dy_r ) ) >> ( sizeof( long ) * 8 - 8 ) );
          fy2 = ( 1L << 8 );
          (*worker).cover += ( fy2 - fy1 );
          (*worker).area += ( fy2 - fy1 ) * ( fx1 + fx2 );
          fx1 = fx2;
        ...
        else if ( prod - dx * ( 1L << 8 ) + dy * ( 1L << 8 ) <= 0 &&
                  prod + dy * ( 1L << 8 ) >= 0 )
        {
          prod += dy * ( 1L << 8 );
          fx2 = ( 1L << 8 );
  ...
  static void
  gray_render_conic( gray_PWorker worker, const FT_Vector* control,
                              const FT_Vector* to )
  {
    TPos dx, dy;
    TPos min, max, y;
    ...
    arc[0].x = ( (to->x) << ( 8 - 6 ) );
    arc[0].y = ( (to->y) << ( 8 - 6 ) );
    arc[1].x = ( (control->x) << ( 8 - 6 ) );
    arc[1].y = ( (control->y) << ( 8 - 6 ) );
    arc[2].x = (*worker).x;
    arc[2].y = (*worker).y;
    top = 0;

    dx = ( (arc[2].x + arc[0].x - 2 * arc[1].x) < 0 ? -(arc[2].x + arc[0].x - 2 * arc[1].x) : (arc[2].x + arc[0].x - 2 * arc[1].x) );
    dy = ( (arc[2].y + arc[0].y - 2 * arc[1].y) < 0 ? -(arc[2].y + arc[0].y - 2 * arc[1].y) : (arc[2].y + arc[0].y - 2 * arc[1].y) );
    if ( dx < dy )
      dx = dy;
    ...
    if ( ( (TCoord)( (min) >> 8 ) ) >= (*worker).max_ey || ( (TCoord)( (max) >> 8 ) ) < (*worker).min_ey )
      goto Draw;
    ...
    Draw:
      gray_render_line( worker, arc[0].x, arc[0].y );
      top--;
      arc -= 2;
  ...
  static void
  gray_render_cubic( gray_PWorker worker, const FT_Vector* control1,
                              const FT_Vector* control2,
                              const FT_Vector* to )
  {
    FT_Vector* arc;
    ...
    arc[0].x = ( (to->x) << ( 8 - 6 ) );
    arc[0].y = ( (to->y) << ( 8 - 6 ) );
    arc[1].x = ( (control2->x) << ( 8 - 6 ) );
    arc[1].y = ( (control2->y) << ( 8 - 6 ) );
    arc[2].x = ( (control1->x) << ( 8 - 6 ) );
    arc[2].y = ( (control1->y) << ( 8 - 6 ) );
    arc[3].x = (*worker).x;
    arc[3].y = (*worker).y;
    ...
    for (;;)
    {
...

      {
        ...
        L = ( dx_ = ( (dx_) < 0 ? -(dx_) : (dx_) ), dy_ = ( (dy_) < 0 ? -(dy_) : (dy_) ), dx_ > dy_ ? dx_ + ( 3 * dy_ >> 3 ) : dy_ + ( 3 * dx_ >> 3 ) );
        ...
        s_limit = L * (TPos)( ( 1L << 8 ) / 6 );


        dx1 = arc[1].x - arc[0].x;
        dy1 = arc[1].y - arc[0].y;
        s = ( (dy * dx1 - dx * dy1) < 0 ? -(dy * dx1 - dx * dy1) : (dy * dx1 - dx * dy1) );
        ...
        dx2 = arc[2].x - arc[0].x;
        dy2 = arc[2].y - arc[0].y;
        s = ( (dy * dx2 - dx * dy2) < 0 ? -(dy * dx2 - dx * dy2) : (dy * dx2 - dx * dy2) );
                ...
                gray_PWorker worker )
  {
    ...
    gray_start_cell( worker, ( (TCoord)( (x) >> 8 ) ), ( (TCoord)( (y) >> 8 ) ) );
  ...
  gray_line_to( const FT_Vector* to,
                gray_PWorker worker )
  {
    gray_render_line( worker, ( (to->x) << ( 8 - 6 ) ), ( (to->y) << ( 8 - 6 ) ) );
    return 0;
  }
                    ...
                    gray_PWorker worker )
  {
    ...
    for ( ; count > 0; count--, spans++ )
    {
      ...
      if ( coverage )
      {
        ...
        if ( spans->len >= 8 )
          memset( p + spans->x, (unsigned char)coverage, (FT_Offset)(spans->len) );
        else
        {
  ...
  static void
  gray_hline( gray_PWorker worker, TCoord x,
                       TCoord y,
                       TPos area,
                       TCoord acount )
  {
...
# 1532 "../../../libs/freetype/src/smooth/ftgrays.c"
  static void
  gray_sweep( gray_PWorker worker, const FT_Bitmap* target )
  {
    int yindex;
    ...
    for ( yindex = 0; yindex < (*worker).ycount; yindex++ )
    {
      ...
      for ( ; cell != ((void *)0); cell = cell->next )
      {
        TPos area;


        if ( cell->x > x && cover != 0 )
          gray_hline( worker, x, yindex, cover * ( ( 1L << 8 ) * 2 ),
                      cell->x - x );

        cover += cell->cover;
        area = cover * ( ( 1L << 8 ) * 2 ) - cell->area;
...
# 1601 "../../../libs/freetype/src/smooth/ftgrays.c"
  }
# 1889 "../../../libs/freetype/src/smooth/ftgrays.c"
  ...
  static const FT_Outline_Funcs func_interface = { (FT_Outline_MoveToFunc) gray_move_to, (FT_Outline_LineToFunc) gray_line_to, (FT_Outline_ConicToFunc)gray_conic_to, (FT_Outline_CubicToFunc)gray_cubic_to, 0, 0 };
# 1907 "../../../libs/freetype/src/smooth/ftgrays.c"
  static int
  gray_convert_glyph_inner( gray_PWorker worker )
  {
    ...
    if ( _setjmp (*(jmp_buf*) &((*worker).jump_buffer)) == 0 )
    {
      error = FT_Outline_Decompose( &(*worker).outline, &func_interface, &(*worker) );
      if ( !(*worker).invalid )
        gray_record_cell( worker );
    }
    else
      error = Smooth_Err_Out_Of_Memory;
  ...
  static int
  gray_convert_glyph( gray_PWorker worker )
  {
    gray_TBand bands[40];
    ...
    for ( n = 0; n < num_bands; n++, min = max )
    {
      ...
      do
      {
...

        {
          ...
          cell_start = (long)sizeof ( PCell ) * (*worker).ycount;
                      ...
                      const FT_Raster_Params* params )
  {
    ...
    TCell buffer[( (16384L) > (2048) ? (16384L) : (2048) ) / sizeof ( TCell )];
    ...
    if ( !raster )
      return Smooth_Err_Invalid_Argument;

    if ( !outline )
      return Smooth_Err_Invalid_Outline;
    ...
    if ( !( params->flags & 0x2 ) )
    {
      ...
      (*worker).clip_box.xMax = (FT_Pos)target_map->width;
      (*worker).clip_box.yMax = (FT_Pos)target_map->rows;
    }
    else if ( params->flags & 0x4 )
    ...
    (*worker).num_cells = 0;
    (*worker).invalid = 1;
    (*worker).band_size = band_size;
    (*worker).num_gray_spans = 0;
    (*worker).span_y = 0;

    if ( params->flags & 0x2 )
    {
      (*worker).render_span = (FT_SpanFunc)params->gray_spans;
...
# 2192 "../../../libs/freetype/src/smooth/ftgrays.c"
  static int
                   ...
                   FT_Raster* araster )
  {
    ...
    *araster = 0;
    if ( !( ((raster) = (ft_mem_alloc( memory, (FT_Long)(sizeof ( gray_TRaster )), &error ))), error != 0 ) )
    {
  ...
  gray_raster_done( FT_Raster raster )
  {
    ...
    do { ft_mem_free( memory, (raster) ); (raster) = ((void *)0); } while ( 0 );
  }
  ...
  const FT_Raster_Funcs ft_grays_raster = { FT_GLYPH_FORMAT_OUTLINE, (FT_Raster_NewFunc) gray_raster_new, (FT_Raster_ResetFunc) gray_raster_reset, (FT_Raster_SetModeFunc)gray_raster_set_mode, (FT_Raster_RenderFunc) gray_raster_render, (FT_Raster_DoneFunc) gray_raster_done };
# 24 "../../../libs/freetype/src/smooth/smooth.c" 2
# 1 "../../../libs/freetype/src/smooth/ftsmooth.c" 1
# 23 "../../../libs/freetype/src/smooth/ftsmooth.c"
# 1 "../../../libs/freetype/src/smooth/ftsmooth.h" 1
# 27 "../../../libs/freetype/src/smooth/ftsmooth.h"




  extern const FT_Renderer_Class ft_std_renderer_class;



  extern const FT_Renderer_Class ft_smooth_renderer_class;

  extern const FT_Renderer_Class ft_smooth_lcd_renderer_class;

  extern const FT_Renderer_Class ft_smooth_lcd_v_renderer_class;





# 24 "../../../libs/freetype/src/smooth/ftsmooth.c" 2
  ...
  {
    FT_Library library = ((FT_Module)( render ))->library;
  ...
  ft_smooth_get_cbox( FT_Renderer render,
                      ...
                      FT_BBox* cbox )
  {
    memset( cbox, 0, (FT_Offset)(sizeof ( *cbox )) );
                            ...
                            FT_Render_Mode required_mode )
  {
    ...
    FT_Bool have_outline_shifted = 0;
    FT_Bool have_buffer = 0;
    ...
    cbox.xMin = ( (cbox.xMin + x_shift) & ~(__typeof__ (cbox.xMin + x_shift))63 );
    cbox.yMin = ( (cbox.yMin + y_shift) & ~(__typeof__ (cbox.yMin + y_shift))63 );
    cbox.xMax = ( ((cbox.xMax + x_shift) + 63) & ~(__typeof__ ((cbox.xMax + x_shift) + 63))63 );
    cbox.yMax = ( ((cbox.yMax + y_shift) + 63) & ~(__typeof__ ((cbox.yMax + y_shift) + 63))63 );
    ...
    {
      width *= 3;
      pitch = ( ((width) + ((4)-1)) & ~(__typeof__ ((width) + ((4)-1)))( (4)-1 ) );
    }
    ...
    if ( x_left > 2147483647 || y_top > 2147483647 ||
         x_left < (-2147483647 - 1) || y_top < (-2147483647 - 1) )
    {
    ...
    if ( slot->internal->flags & 0x1U )
    {
      do { ft_mem_free( memory, (bitmap->buffer) ); (bitmap->buffer) = ((void *)0); } while ( 0 );
      slot->internal->flags &= ~0x1U;
    }


    if ( ( ((bitmap->buffer) = (ft_mem_alloc( memory, (FT_Long)((FT_ULong)( pitch * height )), &error ))), error != 0 ) )
      goto Exit;
    else
      have_buffer = 1;
...
# 363 "../../../libs/freetype/src/smooth/ftsmooth.c"
    have_buffer = 0;
  ...
  const FT_Renderer_Class ft_smooth_renderer_class = { { 2, sizeof ( FT_RendererRec ), "smooth", 0x10000L, 0x20000L, 0, (FT_Module_Constructor)ft_smooth_init, (FT_Module_Destructor) 0, (FT_Module_Requester) 0, }, FT_GLYPH_FORMAT_OUTLINE, (FT_Renderer_RenderFunc) ft_smooth_render, (FT_Renderer_TransformFunc)ft_smooth_transform, (FT_Renderer_GetCBoxFunc) ft_smooth_get_cbox, (FT_Renderer_SetModeFunc) ft_smooth_set_mode, (FT_Raster_Funcs*) &ft_grays_raster };
# 458 "../../../libs/freetype/src/smooth/ftsmooth.c"
  const FT_Renderer_Class ft_smooth_lcd_renderer_class = { { 2, sizeof ( FT_RendererRec ), "smooth-lcd", 0x10000L, 0x20000L, 0, (FT_Module_Constructor)ft_smooth_init, (FT_Module_Destructor) 0, (FT_Module_Requester) 0, }, FT_GLYPH_FORMAT_OUTLINE, (FT_Renderer_RenderFunc) ft_smooth_render_lcd, (FT_Renderer_TransformFunc)ft_smooth_transform, (FT_Renderer_GetCBoxFunc) ft_smooth_get_cbox, (FT_Renderer_SetModeFunc) ft_smooth_set_mode, (FT_Raster_Funcs*) &ft_grays_raster };
# 484 "../../../libs/freetype/src/smooth/ftsmooth.c"
  const FT_Renderer_Class ft_smooth_lcdv_renderer_class = { { 2, sizeof ( FT_RendererRec ), "smooth-lcdv", 0x10000L, 0x20000L, 0, (FT_Module_Constructor)ft_smooth_init, (FT_Module_Destructor) 0, (FT_Module_Requester) 0, }, FT_GLYPH_FORMAT_OUTLINE, (FT_Renderer_RenderFunc) ft_smooth_render_lcd_v, (FT_Renderer_TransformFunc)ft_smooth_transform, (FT_Renderer_GetCBoxFunc) ft_smooth_get_cbox, (FT_Renderer_SetModeFunc) ft_smooth_set_mode, (FT_Raster_Funcs*) &ft_grays_raster };
# 25 "../../../libs/freetype/src/smooth/smooth.c" 2
