...

{
  ...
  while (length > 16) {
    ...
    memset((void *)(&huffval[count]), 0, (size_t)((256 - count) * ((size_t) sizeof(UINT8))));
...

{
 ...
 (*cinfo->mem->alloc_large) ((j_common_ptr) cinfo, 1,
  ...
  while (bytes_read < data_length) {
    ...
    if (bytes_in_buffer == 0) { if (! (*datasrc->fill_input_buffer) (cinfo)) { return 0; } ( next_input_byte = datasrc->next_input_byte, bytes_in_buffer = datasrc->bytes_in_buffer ); };
