...
# 15 "../../../libs/png/pngwtran.c" 2
# 24 "../../../libs/png/pngwtran.c"
static void
...
png_do_write_transformations(png_structrp png_ptr, png_row_infop row_info)
{
   ...
   if (png_ptr->transformations & 0x100000)
      if (png_ptr->write_user_transform_fn != ((void *)0))
