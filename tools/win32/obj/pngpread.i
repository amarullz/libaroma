...
# 15 "../../../libs/png/pngpread.c" 2
# 29 "../../../libs/png/pngpread.c"
void
...
png_process_data_skip(png_structrp png_ptr)
{
   ...
   if (png_ptr != ((void *)0) && png_ptr->process_mode == 3 &&
...
# 198 "../../../libs/png/pngpread.c"
   if (!(png_ptr->mode & 0x100))
   {
      ...
      png_ptr->chunk_name = (((png_uint_32)(0xff&(chunk_tag)[0]) << (24)) | ((png_uint_32)(0xff&(chunk_tag)[1]) << (16)) | ((png_uint_32)(0xff&(chunk_tag)[2]) << (8)) | ((png_uint_32)(0xff&(chunk_tag)[3]) << (0)));
   ...
   else if (chunk_name == (((png_uint_32)(73) << (24)) | ((png_uint_32)(68) << (16)) | ((png_uint_32)(65) << (8)) | ((png_uint_32)(84) << (0))))
   {
      ...
      png_ptr->zstream.avail_out =
          (uInt) ((png_ptr->pixel_depth) >= 8 ? ((png_size_t)(png_ptr->iwidth) * (((png_size_t)(png_ptr->pixel_depth)) >> 3)) : (( ((png_size_t)(png_ptr->iwidth) * ((png_size_t)(png_ptr->pixel_depth))) + 7) >> 3) )
                           + 1;
   ...
   else if (png_ptr->chunk_name == (((png_uint_32)(103) << (24)) | ((png_uint_32)(65) << (16)) | ((png_uint_32)(77) << (8)) | ((png_uint_32)(65) << (0))))
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size)
      {
         png_push_save_buffer(png_ptr);
   ...
   else if (png_ptr->chunk_name == (((png_uint_32)(115) << (24)) | ((png_uint_32)(66) << (16)) | ((png_uint_32)(73) << (8)) | ((png_uint_32)(84) << (0))))
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size)
      {
         png_push_save_buffer(png_ptr);
   ...
   else if (png_ptr->chunk_name == (((png_uint_32)(99) << (24)) | ((png_uint_32)(72) << (16)) | ((png_uint_32)(82) << (8)) | ((png_uint_32)(77) << (0))))
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size)
      {
         png_push_save_buffer(png_ptr);
   ...
   else if (png_ptr->chunk_name == (((png_uint_32)(105) << (24)) | ((png_uint_32)(67) << (16)) | ((png_uint_32)(67) << (8)) | ((png_uint_32)(80) << (0))))
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size)
      {
         png_push_save_buffer(png_ptr);
...
png_push_save_buffer(png_structrp png_ptr)
{
       ...
       png_ptr->save_buffer_max)
   {
      ...
      if (png_ptr->save_buffer_size > ((png_size_t)(-1)) -
   ...
   png_size_t buffer_length)
{
      ...
      !(png_ptr->flags & 0x0008))
   {
      ...
      if (!(png_ptr->zstream.avail_out > 0))
      {
         ...
         png_ptr->zstream.avail_out = (uInt)(((png_ptr->pixel_depth) >= 8 ? ((png_size_t)(png_ptr->iwidth) * (((png_size_t)(png_ptr->pixel_depth)) >> 3)) : (( ((png_size_t)(png_ptr->iwidth) * ((png_size_t)(png_ptr->pixel_depth))) + 7) >> 3) )
                              + 1);

         png_ptr->zstream.next_out = png_ptr->row_buf;
      }
# 873 "../../../libs/png/pngpread.c"
      ret = inflate(&png_ptr->zstream, 2);
    ...
    switch (png_ptr->pass)
    {
         case 0:
         {
            ...
            if (png_ptr->pass == 2)
            {
               ...
               {
                  png_push_have_row(png_ptr, ((void *)0));
                  png_read_push_finish_row(png_ptr);
               }
            }
