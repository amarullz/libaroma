...
__attribute__((__malloc__)) png_voidp png_calloc (png_const_structrp png_ptr, png_alloc_size_t size)
...
__attribute__((__malloc__)) png_voidp png_malloc_base (png_const_structrp png_ptr, png_alloc_size_t size)


{
# 80 "../../../libs/png/pngmem.c"
   if (size > 0 && size <= ((png_size_t)(-1))
      ...
      )
   {
      ...
      if (png_ptr != ((void *)0) && png_ptr->malloc_fn != ((void *)0))
         return png_ptr->malloc_fn(((png_structrp)(png_ptr)), size);
   ...
   size_t element_size)
{
   ...
   if (req <= ((png_size_t)(-1))/element_size)
...
__attribute__((__malloc__)) png_voidp png_malloc_array (png_const_structrp png_ptr, int nelements, size_t element_size)
...
__attribute__((__malloc__)) png_voidp png_realloc_array (png_const_structrp png_ptr, png_const_voidp old_array, int old_elements, int add_elements, size_t element_size)


{

   if (add_elements <= 0 || element_size == 0 || old_elements < 0 ||
      (old_array == ((void *)0) && old_elements > 0))
...
__attribute__((__malloc__)) png_voidp png_malloc (png_const_structrp png_ptr, png_alloc_size_t size)
...
__attribute__((__malloc__)) png_voidp png_malloc_default (png_const_structrp png_ptr, png_alloc_size_t size)
...

{
   ...
   ret = png_malloc_base(((void *)0) , size);
...
__attribute__((__malloc__)) png_voidp png_malloc_warn (png_const_structrp png_ptr, png_alloc_size_t size)
