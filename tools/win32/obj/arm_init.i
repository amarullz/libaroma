...
# 18 "../../../libs/png/arm/arm_init.c" 2
# 55 "../../../libs/png/arm/arm_init.c"
void
png_init_filter_functions_neon(png_structp pp, unsigned int bpp)
{
# 114 "../../../libs/png/arm/arm_init.c"
   pp->read_filter[2 -1] = png_read_filter_row_up_neon;

   if (bpp == 3)
   {
      pp->read_filter[1 -1] = png_read_filter_row_sub3_neon;
      pp->read_filter[3 -1] = png_read_filter_row_avg3_neon;
      pp->read_filter[4 -1] =
   ...
   {
      pp->read_filter[1 -1] = png_read_filter_row_sub4_neon;
      pp->read_filter[3 -1] = png_read_filter_row_avg4_neon;
      pp->read_filter[4 -1] =
