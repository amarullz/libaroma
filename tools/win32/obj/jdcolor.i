...
# 14 "../../../libs/jpeg/jdcolor.c" 2

# 1 "../../../libs/jpeg/jsimd_neon.h" 1
# 30 "../../../libs/jpeg/jsimd_neon.h"
# 1 "../../../libs/jpeg/jinclude.h" 1
# 20 "../../../libs/jpeg/jinclude.h"
# 1 "../../../libs/jpeg/jconfig.h" 1
# 21 "../../../libs/jpeg/jinclude.h" 2
...
# 1 "d:\\devtools\\linaro\\lib\\gcc\\arm-linux-gnueabihf\\4.8.3\\include\\stddef.h" 1 3 4
# 36 "../../../libs/jpeg/jinclude.h" 2
# 31 "../../../libs/jpeg/jsimd_neon.h" 2
# 39 "../../../libs/jpeg/jsimd_neon.h"
void
         ...
         JSAMPARRAY output_buf, int num_rows)
{
  ...
  register INT32 * Crgtab = cconvert->Cr_g_tab;
  register INT32 * Cbgtab = cconvert->Cb_g_tab;
  INT32 d0 = dither_matrix[cinfo->output_scanline & 0x3];
  ...
  while (--num_rows >= 0) {
    ...
    if ((((uintptr_t)(outptr))&3)) {
        ...
        cb = ((int) (*inptr1++));
        cr = ((int) (*inptr2++));
        r = range_limit[((y + Crrtab[cr]) + ((d0)&0xFF))];
        g = range_limit[((y + ((int)((Cbgtab[cb]+Crgtab[cr]) >> (16)))) + (((d0)&0xFF)>>1))];
        b = range_limit[((y + Cbbtab[cb]) + ((d0)&0xFF))];
        rgb = ((((r)<<8)&0xf800)|(((g)<<3)&0x7E0)|((b)>>3));
        *(INT16*)outptr = rgb;
        outptr += 2;
        num_cols--;
         ...
         JSAMPARRAY output_buf, int num_rows)
{
  ...
  while (--num_rows >= 0) {
    ...
    outptr = *output_buf++;
    if ((((uintptr_t)(outptr))&3)) {
        r = range_limit[((((int) (*inptr0++))) + ((d0)&0xFF))];
        g = range_limit[((((int) (*inptr1++))) + (((d0)&0xFF)>>1))];
        b = range_limit[((((int) (*inptr2++))) + ((d0)&0xFF))];
        rgb = ((((r)<<8)&0xf800)|(((g)<<3)&0x7E0)|((b)>>3));
        *(INT16*)outptr = rgb;
        outptr += 2;
        num_cols--;
          ...
          JSAMPARRAY output_buf, int num_rows)
{
  ...
  while (--num_rows >= 0) {
    ...
    for (col = 0; col < (num_cols>>1); col++) {
      ...
      rgb = ((((g)<<8)&0xf800)|(((g)<<3)&0x7E0)|((g)>>3));
      g = *inptr++;
      rgb = ((((((g)<<8)&0xf800)|(((g)<<3)&0x7E0)|((g)>>3))<<16) | rgb);
      ((*(INT32*)(outptr)) = rgb);
      outptr += 4;
    }
    if (num_cols&1) {
...
jinit_color_deconverter (j_decompress_ptr cinfo)
{
  ...
  cconvert = (my_cconvert_ptr)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
    ((size_t) sizeof(my_color_deconverter)));
