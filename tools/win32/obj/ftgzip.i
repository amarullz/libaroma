...
# 24 "../../../libs/freetype/src/gzip/ftgzip.c" 2
...
# 25 "../../../libs/freetype/src/gzip/ftgzip.c" 2
...
# 26 "../../../libs/freetype/src/gzip/ftgzip.c" 2
...
# 27 "../../../libs/freetype/src/gzip/ftgzip.c" 2
# 1 "../../../libs/freetype/include/freetype/ftgzip.h" 1
# 32 "../../../libs/freetype/include/freetype/ftgzip.h"

# 90 "../../../libs/freetype/include/freetype/ftgzip.h"
  extern FT_Error
  FT_Stream_OpenGzip( FT_Stream stream,
                      FT_Stream source );
# 133 "../../../libs/freetype/include/freetype/ftgzip.h"
  extern FT_Error
...
# 28 "../../../libs/freetype/src/gzip/ftgzip.c" 2
# 39 "../../../libs/freetype/src/gzip/ftgzip.c"
# 1 "../../../libs/freetype/include/freetype/fterrors.h" 1
# 173 "../../../libs/freetype/include/freetype/fterrors.h"
  enum {
...
# 59 "../../../libs/freetype/include/freetype/fterrdef.h"
  ...
  Gzip_Err_Cannot_Open_Resource = 0x01 + 0,

  Gzip_Err_Unknown_File_Format = 0x02 + 0,

  Gzip_Err_Invalid_File_Format = 0x03 + 0,

  Gzip_Err_Invalid_Version = 0x04 + 0,

  Gzip_Err_Lower_Module_Version = 0x05 + 0,

  Gzip_Err_Invalid_Argument = 0x06 + 0,

  Gzip_Err_Unimplemented_Feature = 0x07 + 0,

  Gzip_Err_Invalid_Table = 0x08 + 0,

  Gzip_Err_Invalid_Offset = 0x09 + 0,

  Gzip_Err_Array_Too_Large = 0x0A + 0,

  Gzip_Err_Missing_Module = 0x0B + 0,

  Gzip_Err_Missing_Property = 0x0C + 0,




  Gzip_Err_Invalid_Glyph_Index = 0x10 + 0,

  Gzip_Err_Invalid_Character_Code = 0x11 + 0,

  Gzip_Err_Invalid_Glyph_Format = 0x12 + 0,

  Gzip_Err_Cannot_Render_Glyph = 0x13 + 0,

  Gzip_Err_Invalid_Outline = 0x14 + 0,

  Gzip_Err_Invalid_Composite = 0x15 + 0,

  Gzip_Err_Too_Many_Hints = 0x16 + 0,

  Gzip_Err_Invalid_Pixel_Size = 0x17 + 0,




  Gzip_Err_Invalid_Handle = 0x20 + 0,

  Gzip_Err_Invalid_Library_Handle = 0x21 + 0,

  Gzip_Err_Invalid_Driver_Handle = 0x22 + 0,

  Gzip_Err_Invalid_Face_Handle = 0x23 + 0,

  Gzip_Err_Invalid_Size_Handle = 0x24 + 0,

  Gzip_Err_Invalid_Slot_Handle = 0x25 + 0,

  Gzip_Err_Invalid_CharMap_Handle = 0x26 + 0,

  Gzip_Err_Invalid_Cache_Handle = 0x27 + 0,

  Gzip_Err_Invalid_Stream_Handle = 0x28 + 0,




  Gzip_Err_Too_Many_Drivers = 0x30 + 0,

  Gzip_Err_Too_Many_Extensions = 0x31 + 0,




  Gzip_Err_Out_Of_Memory = 0x40 + 0,

  Gzip_Err_Unlisted_Object = 0x41 + 0,




  Gzip_Err_Cannot_Open_Stream = 0x51 + 0,

  Gzip_Err_Invalid_Stream_Seek = 0x52 + 0,

  Gzip_Err_Invalid_Stream_Skip = 0x53 + 0,

  Gzip_Err_Invalid_Stream_Read = 0x54 + 0,

  Gzip_Err_Invalid_Stream_Operation = 0x55 + 0,

  Gzip_Err_Invalid_Frame_Operation = 0x56 + 0,

  Gzip_Err_Nested_Frame_Access = 0x57 + 0,

  Gzip_Err_Invalid_Frame_Read = 0x58 + 0,




  Gzip_Err_Raster_Uninitialized = 0x60 + 0,

  Gzip_Err_Raster_Corrupted = 0x61 + 0,

  Gzip_Err_Raster_Overflow = 0x62 + 0,

  Gzip_Err_Raster_Negative_Height = 0x63 + 0,




  Gzip_Err_Too_Many_Caches = 0x70 + 0,




  Gzip_Err_Invalid_Opcode = 0x80 + 0,

  Gzip_Err_Too_Few_Arguments = 0x81 + 0,

  Gzip_Err_Stack_Overflow = 0x82 + 0,

  Gzip_Err_Code_Overflow = 0x83 + 0,

  Gzip_Err_Bad_Argument = 0x84 + 0,

  Gzip_Err_Divide_By_Zero = 0x85 + 0,

  Gzip_Err_Invalid_Reference = 0x86 + 0,

  Gzip_Err_Debug_OpCode = 0x87 + 0,

  Gzip_Err_ENDF_In_Exec_Stream = 0x88 + 0,

  Gzip_Err_Nested_DEFS = 0x89 + 0,

  Gzip_Err_Invalid_CodeRange = 0x8A + 0,

  Gzip_Err_Execution_Too_Long = 0x8B + 0,

  Gzip_Err_Too_Many_Function_Defs = 0x8C + 0,

  Gzip_Err_Too_Many_Instruction_Defs = 0x8D + 0,

  Gzip_Err_Table_Missing = 0x8E + 0,

  Gzip_Err_Horiz_Header_Missing = 0x8F + 0,

  Gzip_Err_Locations_Missing = 0x90 + 0,

  Gzip_Err_Name_Table_Missing = 0x91 + 0,

  Gzip_Err_CMap_Table_Missing = 0x92 + 0,

  Gzip_Err_Hmtx_Table_Missing = 0x93 + 0,

  Gzip_Err_Post_Table_Missing = 0x94 + 0,

  Gzip_Err_Invalid_Horiz_Metrics = 0x95 + 0,

  Gzip_Err_Invalid_CharMap_Format = 0x96 + 0,

  Gzip_Err_Invalid_PPem = 0x97 + 0,

  Gzip_Err_Invalid_Vert_Metrics = 0x98 + 0,

  Gzip_Err_Could_Not_Find_Context = 0x99 + 0,

  Gzip_Err_Invalid_Post_Table_Format = 0x9A + 0,

  Gzip_Err_Invalid_Post_Table = 0x9B + 0,




  Gzip_Err_Syntax_Error = 0xA0 + 0,

  Gzip_Err_Stack_Underflow = 0xA1 + 0,

  Gzip_Err_Ignore = 0xA2 + 0,

  Gzip_Err_No_Unicode_Glyph_Name = 0xA3 + 0,

  Gzip_Err_Glyph_Too_Big = 0xA4 + 0,




  Gzip_Err_Missing_Startfont_Field = 0xB0 + 0,

  Gzip_Err_Missing_Font_Field = 0xB1 + 0,

  Gzip_Err_Missing_Size_Field = 0xB2 + 0,

  Gzip_Err_Missing_Fontboundingbox_Field = 0xB3 + 0,

  Gzip_Err_Missing_Chars_Field = 0xB4 + 0,

  Gzip_Err_Missing_Startchar_Field = 0xB5 + 0,

  Gzip_Err_Missing_Encoding_Field = 0xB6 + 0,

  Gzip_Err_Missing_Bbx_Field = 0xB7 + 0,

  Gzip_Err_Bbx_Too_Big = 0xB8 + 0,

  Gzip_Err_Corrupted_Font_Header = 0xB9 + 0,

  Gzip_Err_Corrupted_Font_Glyphs = 0xBA + 0,
# 179 "../../../libs/freetype/include/freetype/fterrors.h" 2



  Gzip_Err_Max };
# 40 "../../../libs/freetype/src/gzip/ftgzip.c" 2
# 50 "../../../libs/freetype/src/gzip/ftgzip.c"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 51 "../../../libs/freetype/src/gzip/ftgzip.c" 2
# 116 "../../../libs/freetype/src/gzip/ftgzip.c"
  static voidpf
                 ...
                 uInt size )
  {
    ...
    (void)( ((p) = (ft_mem_alloc( memory, (FT_Long)(sz), &error ))), error != 0 );
    return p;
  }
  ...
  ft_gzip_free( FT_Memory memory,
                voidpf address )
  {
    do { ft_mem_free( memory, (address) ); (address) = ((void *)0); } while ( 0 );
  }
# 169 "../../../libs/freetype/src/gzip/ftgzip.c"
...
# 197 "../../../libs/freetype/src/gzip/ftgzip.c"
  static FT_Error
  ft_gzip_check_header( FT_Stream stream )
  {
    ...
    if ( ( ( error = (FT_Stream_Seek( stream, (FT_ULong)(0) )) ) != 0 ) ||
         ( ( error = (FT_Stream_Read( stream, (FT_Byte*)(head), (FT_ULong)(4) )) ) != 0 ) )
      goto Exit;
    ...
    (void)( ( error = (FT_Stream_Skip( stream, (FT_Long)(6) )) ) != 0 );
    ...
    if ( head[3] & 0x04 )
    {
      ...
      if ( ( len = (FT_UShort)FT_Stream_ReadUShortLE( stream, &error ), error != FT_Err_Ok ) ||
           ( ( error = (FT_Stream_Skip( stream, (FT_Long)(len) )) ) != 0 ) )
        goto Exit;
    }
    ...
    if ( head[3] & 0x08 )
      for (;;)
      {
        ...
        if ( ( c = (FT_Byte)FT_Stream_ReadChar( stream, &error ), error != FT_Err_Ok ) )
          goto Exit;
    ...
    if ( head[3] & 0x02 )
      if ( ( ( error = (FT_Stream_Skip( stream, (FT_Long)(2) )) ) != 0 ) )
        goto Exit;
                     ...
                     FT_Stream source )
  {
...

    {
      ...
      zip->start = FT_Stream_Pos( stream );
    }
    ...
    if ( inflateInit2_((zstream), (-15), "1.2.8", (int)sizeof(z_stream)) != 0 ||
  ...
  ft_gzip_file_done( FT_GZipFile zip )
  {
    ...
    zstream->zalloc = ((void *)0);
    zstream->zfree = ((void *)0);
    zstream->opaque = ((void *)0);
    zstream->next_in = ((void *)0);
    zstream->next_out = ((void *)0);
    zstream->avail_in = 0;
    zstream->avail_out = 0;
  ...
  ft_gzip_file_reset( FT_GZipFile zip )
  {
    ...
    if ( !( ( error = (FT_Stream_Seek( stream, (FT_ULong)(zip->start) )) ) != 0 ) )
    {
      z_stream* zstream = &zip->zstream;
  ...
  ft_gzip_file_fill_input( FT_GZipFile zip )
  {
    ...
    else
    {
      ...
      memcpy( zip->input, stream->base + stream->pos, (FT_Offset)(size) );
    }
    stream->pos += size;
                   ...
                   FT_ULong count )
  {
    ...
    for (;;)
    {
      ...
      memcpy( buffer, zip->cursor, (FT_Offset)(delta) );
      buffer += delta;
      result += delta;
      zip->cursor += delta;
      zip->pos += delta;
...
# 551 "../../../libs/freetype/src/gzip/ftgzip.c"
  static void
  ft_gzip_stream_close( FT_Stream stream )
  {
    ...
    if ( !stream->read )
      do { ft_mem_free( memory, (stream->base) ); (stream->base) = ((void *)0); } while ( 0 );
  }
                      ...
                      FT_Stream source )
  {
    FT_Error error;
    FT_Memory memory;
    FT_GZipFile zip = ((void *)0);


    if ( !stream || !source )
    {
      error = Gzip_Err_Invalid_Stream_Handle;
      goto Exit;
    }
    ...
    if ( !( ((zip) = (ft_mem_qalloc( memory, (FT_Long)(sizeof ( *(zip) )), &error ))), error != 0 ) )
    {
...
# 658 "../../../libs/freetype/src/gzip/ftgzip.c"
    {
      ...
      {
        FT_Byte* zip_buff = ((void *)0);


        if ( !( ((zip_buff) = (ft_mem_alloc( memory, (FT_Long)(zip_size), &error ))), error != 0 ) )
        {
          FT_ULong count;
          ...
          ft_gzip_file_io( zip, 0, ((void *)0), 0 );
          do { ft_mem_free( memory, (zip_buff) ); (zip_buff) = ((void *)0); } while ( 0 );
        }
        error = FT_Err_Ok;
      }
                      ...
                      FT_ULong input_len )
  {
    ...
    if ( !memory || ! output_len || !output )
      return Gzip_Err_Invalid_Argument;
    ...
    err = inflateInit2_((&stream), (15), "1.2.8", (int)sizeof(z_stream));
    if ( err != 0 )
      return Gzip_Err_Invalid_Argument;
    ...
    if ( err == (-4) )
      return Gzip_Err_Out_Of_Memory;

    if ( err == (-5) )
      return Gzip_Err_Array_Too_Large;

    if ( err == (-3) )
      return Gzip_Err_Invalid_Table;
