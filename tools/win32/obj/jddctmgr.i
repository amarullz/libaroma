...
jsimd_ycc_rgba8888_convert (j_decompress_ptr cinfo,
                       JSAMPIMAGE input_buf, JDIMENSION input_row,
                       JSAMPARRAY output_buf, int num_rows);
# 25 "../../../libs/jpeg/jddctmgr.c" 2
# 75 "../../../libs/jpeg/jddctmgr.c"
typedef struct {
...
# 286 "../../../libs/jpeg/jddctmgr.c"
 ...
 for (i = 0; i < 64; i++) {
   ifmtbl[i] = (IFAST_MULT_TYPE)
     ((((((INT32) qtbl->quantval[i]) * ((INT32) aanscales[i]))) + (((INT32) 1) << ((14 -2)-1))) >> (14 -2))
