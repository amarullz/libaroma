...
# 28 "../../../libs/freetype/src/base/ftbbox.c" 2
# 1 "../../../libs/freetype/include/freetype/internal/ftdebug.h" 1
# 29 "../../../libs/freetype/include/freetype/internal/ftdebug.h"
...
# 30 "../../../libs/freetype/include/freetype/internal/ftdebug.h" 2
# 1 "../../../libs/freetype/include/freetype/freetype.h" 1
# 34 "../../../libs/freetype/include/freetype/freetype.h"
...
# 31 "../../../libs/freetype/include/freetype/internal/ftdebug.h" 2
...
# 29 "../../../libs/freetype/src/base/ftbbox.c" 2

# 1 "../../../libs/freetype/include/freetype/ftbbox.h" 1
# 44 "../../../libs/freetype/include/freetype/ftbbox.h"

# 84 "../../../libs/freetype/include/freetype/ftbbox.h"
  extern FT_Error
...
# 31 "../../../libs/freetype/src/base/ftbbox.c" 2
...
# 33 "../../../libs/freetype/src/base/ftbbox.c" 2
...
# 34 "../../../libs/freetype/src/base/ftbbox.c" 2
...
# 35 "../../../libs/freetype/src/base/ftbbox.c" 2
...
# 84 "../../../libs/freetype/src/base/ftbbox.c"
  static int
  BBox_Move_To( FT_Vector* to,
                TBBox_Rec* user )
  {
    do { if ( to->x < user->bbox.xMin ) user->bbox.xMin = to->x; if ( to->x > user->bbox.xMax ) user->bbox.xMax = to->x; if ( to->y < user->bbox.yMin ) user->bbox.yMin = to->y; if ( to->y > user->bbox.yMax ) user->bbox.yMax = to->y; } while ( 0 );

    user->last = *to;

    return 0;
  }
# 116 "../../../libs/freetype/src/base/ftbbox.c"
  static int
...
# 148 "../../../libs/freetype/src/base/ftbbox.c"
  static void
...
# 197 "../../../libs/freetype/src/base/ftbbox.c"
  static int
                 ...
                 TBBox_Rec* user )
  {
    ...
    if ( ( control->x < user->bbox.xMin || control->x > user->bbox.xMax ) )
    ...
    if ( ( control->y < user->bbox.yMin || control->y > user->bbox.yMax ) )
...
# 249 "../../../libs/freetype/src/base/ftbbox.c"
  static FT_Pos
              ...
              FT_Pos q4 )
  {
    FT_Pos peak = 0;
    FT_Int shift;
# 268 "../../../libs/freetype/src/base/ftbbox.c"
    shift = 27 - ( 31 - __builtin_clz( (FT_UInt32)( ( (q1) < 0 ? -(q1) : (q1) ) | ( (q2) < 0 ? -(q2) : (q2) ) | ( (q3) < 0 ? -(q3) : (q3) ) | ( (q4) < 0 ? -(q4) : (q4) ) ) ) )
...
# 392 "../../../libs/freetype/src/base/ftbbox.c"
  static int
                 ...
                 TBBox_Rec* user )
  {
    ...
    if ( ( control1->x < user->bbox.xMin || control1->x > user->bbox.xMax ) ||
         ( control2->x < user->bbox.xMin || control2->x > user->bbox.xMax ) )
    ...
    if ( ( control1->y < user->bbox.yMin || control1->y > user->bbox.yMax ) ||
         ( control2->y < user->bbox.yMin || control2->y > user->bbox.yMax ) )
  ...
  static const FT_Outline_Funcs bbox_interface = { (FT_Outline_MoveToFunc) BBox_Move_To, (FT_Outline_LineToFunc) BBox_Line_To, (FT_Outline_ConicToFunc)BBox_Conic_To, (FT_Outline_CubicToFunc)BBox_Cubic_To, 0, 0 };
# 437 "../../../libs/freetype/src/base/ftbbox.c"
  extern FT_Error
  FT_Outline_Get_BBox( FT_Outline* outline,
                       FT_BBox *abbox )
  {
    ...
    {
      do { if ( vec->x < cbox.xMin ) cbox.xMin = vec->x; if ( vec->x > cbox.xMax ) cbox.xMax = vec->x; if ( vec->y < cbox.yMin ) cbox.yMin = vec->y; if ( vec->y > cbox.yMax ) cbox.yMax = vec->y; } while ( 0 );

      if ( ( outline->tags[n] & 3 ) == 1 )
        do { if ( vec->x < bbox.xMin ) bbox.xMin = vec->x; if ( vec->x > bbox.xMax ) bbox.xMax = vec->x; if ( vec->y < bbox.yMin ) bbox.yMin = vec->y; if ( vec->y > bbox.yMax ) bbox.yMax = vec->y; } while ( 0 );
