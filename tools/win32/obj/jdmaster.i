...

{
  ...
  (5 * (255 +1) + 128) * ((size_t) sizeof(JSAMPLE)));
  table += (255 +1);
  ...
  memset((void *)(table + (2 * (255 +1))), 0, (size_t)((2 * (255 +1) - 128) * ((size_t) sizeof(JSAMPLE))))
                                                          ;
  memcpy((void *)(table + (4 * (255 +1) - 128)), (const void *)(cinfo->sample_range_limit), (size_t)(128 * ((size_t) sizeof(JSAMPLE))))
                                                              ;
}
# 310 "../../../libs/jpeg/jdmaster.c"
static void
master_selection (j_decompress_ptr cinfo)
{
  ...
  if (cinfo->progress != ((void *)0) && ! cinfo->buffered_image &&
