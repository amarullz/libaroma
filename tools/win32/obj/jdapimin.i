...
jpeg_CreateDecompress (j_decompress_ptr cinfo, int version, size_t structsize)
{
  ...
  cinfo->mem = ((void *)0);
  if (version != 62)
    ((cinfo)->err->msg_code = (JERR_BAD_LIB_VERSION), (cinfo)->err->msg_parm.i[0] = (62), (cinfo)->err->msg_parm.i[1] = (version), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
...
default_decompress_parms (j_decompress_ptr cinfo)
{
 ...
 do { int * _mp = (cinfo)->err->msg_parm.i; _mp[0] = (cid0); _mp[1] = (cid1); _mp[2] = (cid2); (cinfo)->err->msg_code = (JTRC_UNKNOWN_IDS); (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)); } while (0);
 cinfo->jpeg_color_space = JCS_YCbCr;
      }
    }
...
# 369 "../../../libs/jpeg/jdapimin.c"
boolean
jpeg_finish_decompress (j_decompress_ptr cinfo)
{
  if ((cinfo->global_state == 205 ||
       cinfo->global_state == 206) && ! cinfo->buffered_image) {
