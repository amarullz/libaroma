 ...
 *
 */
#ifndef __libaroma_sdl_fb32bit_driver_c__
#define __libaroma_sdl_fb32bit_driver_c__
 ...
 */
void SDLFBDR_setrgbpos(LIBAROMA_FBP me, byte r, byte g, byte b) {
  if (me == NULL) {
    return;
  }
 ...
 */
byte SDLFBDR_snapshoot_32bit(LIBAROMA_FBP me, wordp dst) {
  if (me == NULL) {
    return 0;
  }
  SDLFBDR_INTERNALP mi = (SDLFBDR_INTERNALP) me->internal;
 ...
 */
void SDLFBDR_init_32bit(LIBAROMA_FBP me) {
  if (me == NULL) {
    return;
  }
  ALOGS("SDLFBDR Init 32bit Colorspace");
  SDLFBDR_INTERNALP mi = (SDLFBDR_INTERNALP) me->internal;
  ...
  SDLFBDR_setrgbpos(me,0,8,16);
  
  /* set sync callbacks */
  me->start_post  = &SDLFBDR_start_post;
  me->end_post    = &SDLFBDR_end_post;
  me->post        = &SDLFBDR_post_32bit;
  me->snapshoot   = &SDLFBDR_snapshoot_32bit;
}

#endif /* __libaroma_sdl_fb32bit_driver_c__ */ 
