 ...
 * Description : QNX Framebuffer driver - Screen API
 *
 * + This is part of libaroma, an embedded ui toolkit.
 * + 21/01/15 - Author(s): Ahmad Amarullah
 *
 */
#ifndef __libaroma_qnxnto_fb_driver_screen_api_c__
#define __libaroma_qnxnto_fb_driver_screen_api_c__
...
/*
  gf_display_set_mode(&mi->display,
                         1280,
                         1024,
                         16,
...
#endif /* __libaroma_qnxnto_fb_driver_screen_api_c__ */
