...
#endif
#ifndef __libaroma_sse_neon_alpha_h__
#define __libaroma_sse_neon_alpha_h__
...
static inline void libaroma_alpha_px_line(
  ...
  if (n>=8){
    ...
    for (i=0;i<n-left;i+=8){
      uint8x8_t t = vld1_u8(alpha+i);
      uint16x8_t op = vmovl_u8(t);
      ...
      /* bottom blend */
      uint16x8_t u = vandq_u16(pxb,c_msk_r);
      u=vrshrq_n_u16(u,8);
      uint16x8_t rbl = vmulq_u16(u,ro);
      u=vandq_u16(pxb,c_msk_g);
      u=vrshrq_n_u16(u,3);
      uint16x8_t gbl = vmulq_u16(u,ro);
      u=vandq_u16(pxb,c_msk_b);
      u=vshlq_n_u16(u,3);
      uint16x8_t bbl = vmulq_u16(u,ro);
      
      /* top blend */
      u=vandq_u16(pxt,c_msk_r);
      u=vrshrq_n_u16(u,8);
      uint16x8_t rtl = vmulq_u16(u,op);
      u=vandq_u16(pxt,c_msk_g);
      u=vrshrq_n_u16(u,3);
      uint16x8_t gtl = vmulq_u16(u,op);
      u=vandq_u16(pxt,c_msk_b);
      u=vshlq_n_u16(u,3);
      uint16x8_t btl = vmulq_u16(u,op);
      ...
      /* dithering */
      u=vaddq_u16(rbl,table_r16);
      rbl = vminq_u16(u,c_xalph);
      u=vaddq_u16(gbl,table_g16);
      gbl = vminq_u16(u,c_xalph);
      u=vaddq_u16(bbl,table_b16);
      bbl = vminq_u16(u,c_xalph);
      u=vshrq_n_u16(rbl,3);
      rbl = vqshlq_n_u16(u,11);
      u=vshrq_n_u16(gbl,2);
      gbl = vqshlq_n_u16(u,5);
      bbl = vshrq_n_u16(bbl,3);
      
      /* out value */
      u=vorrq_u16(rbl,gbl);
      uint16x8_t o = vorrq_u16(u,bbl);
      
      /* comparison opaque/transparent */
      u = vceqq_u16(op,c_xalph);
      o = vbslq_u16(u,pxt,o); /*opacity*/
      u = vceqq_u16(op,c_zalph);
      o = vbslq_u16(u,pxb,o); /*transparent*/
...
static inline void libaroma_alpha_px(
  ...
  if (n>=8){
    ...
    for (i=0;i<n-left;i+=8){
      ...
      u=vaddq_u16(rbl, rtl);
      rbl  = vshrq_n_u16(u, 11);
      u=vaddq_u16(gbl, gtl);
      gbl  = vshrq_n_u16(u, 10);
      u=vaddq_u16(bbl, btl);
      bbl  = vshrq_n_u16(u, 11);
...
static inline void libaroma_alpha_black(
  ...
  if (n>=8){
    ...
    for (i=0;i<n-left;i+=8){
      uint16x8_t pxt = vld1q_u16(top+i); /* top */
      /* top blend */
      uint16x8_t u = vandq_u16(pxt,c_msk_r);
      u=vrshrq_n_u16(u,8);
      uint16x8_t rtl = vmulq_u16(u,op);
      u=vandq_u16(pxt,c_msk_g);
      u=vrshrq_n_u16(u,3);
...
static inline void libaroma_alpha_mono(
  ...
  if (n>=8){
    ...
    for (i=0;i<n-left;i+=8){
      uint8x8_t uu = vld1_u8(alpha+i);
      uint16x8_t op = vmovl_u8(uu);
      uint16x8_t ro = vsubq_u16(c_falph, op);
...
static inline void libaroma_alpha_multi_line(
  ...
  if (n>=8){
    ...
    for (i=0;i<n-left;i+=8){
      ...
      uint16x8_t u = vandq_u16(pxb,c_msk_r);
      u=vrshrq_n_u16(u,8);
      uint16x8_t rbl = vmulq_u16(u,ro_r);
      u=vandq_u16(pxb,c_msk_g);
      u=vrshrq_n_u16(u,3);
      uint16x8_t gbl = vmulq_u16(u,ro_g);
      u=vandq_u16(pxb,c_msk_b);
      u=vshlq_n_u16(u,3);
      uint16x8_t bbl = vmulq_u16(u,ro_b);
...
#endif /* __libaroma_sse_neon_alpha_h__ */
