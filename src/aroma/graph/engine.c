...
/* graph engine source */
#include "engine/color.c"    /* Color Bitwise Engine Module */
#include "engine/blt.c"      /* BitBlt Engine Module */
#include "engine/dither.c"   /* Dithering Engine Module */
#include "engine/alpha.c"    /* Alphablending Engine Module */
#include "engine/alignblt.c" /* Alignment Blt Engine Module */
